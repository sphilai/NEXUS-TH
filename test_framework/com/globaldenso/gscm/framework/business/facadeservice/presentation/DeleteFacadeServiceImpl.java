 ...
 *
 * $Id: DeleteFacadeServiceImpl.java 5759 2014-06-27 08:14:53Z 10088DS01586 $
 *
...
/**
 * DeleteFacadeServiceのテスト実装
 * Testing class for DeleteFacadeService
 * <p>
 * DeleteFacadeServiceのテスト実装
 * Testing class for DeleteFacadeService
 * </p>
 ...
 */
public class DeleteFacadeServiceImpl extends AbstractDeleteFacadeService<Integer, TestArgDomain> {
     ...
     * Default constructor
     */
    public DeleteFacadeServiceImpl() {
    }
    ...
    protected Integer callServices(TestArgDomain filterDomain) throws ApplicationException {
        ...
        for (TestFacadeTableDomain tableDomain : tableDomainList) {
            count = count + testFacadeTableDao.delete(tableDomain);
        }
        return count;
    }
