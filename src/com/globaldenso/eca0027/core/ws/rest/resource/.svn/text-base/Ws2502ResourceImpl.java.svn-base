 ...
 * <br />ws2502のリソース実装クラスです。
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7966 $
 */
public class Ws2502ResourceImpl extends AbstractResourceImpl implements Ws2502Resource  {
    ...
    /**
     * {@inheritDoc}
     * @see com.globaldenso.eca0027.core.ws.rest.resource.Ws2502Resource#createInstrPltz(String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String)
     */
    public Ws2502ResultDomain createInstrPltz(String dscId,
        ...
        List<Ws2502ItemNoCriteriaDomain> itemNoCriteriaList = new ArrayList<Ws2502ItemNoCriteriaDomain>();
        for (int i = 0; i < itemNos.length; i++) {
            Ws2502ItemNoCriteriaDomain criteria = new Ws2502ItemNoCriteriaDomain();
