...
import com.globaldenso.eca0027.core.business.facadeservice.presentation.W7007CoUploadFacadeServiceImpl;
import com.globaldenso.gscm.framework.business.facadeservice.presentation.CreateFacadeService;
import com.globaldenso.gscm.framework.util.ActionUtil;

/**
 * The class of action  C / O Upload for B / L upload screen.
 * <br />B/Lアップロード画面のC/O Uploadアクションクラスです。
 * <pre>
 ...
 */
public class W7007CoUploadAction extends W7007AbstractAction {

    /**
     * C / O Upload Facade Service
     * <br />C/O Upload Facadeサービス
     */
    protected CreateFacadeService<W7007UpdateDomain, W7007UpdateDomain> w7007CoUploadFacadeService;
    
    /**
     * Default constructor.
     * <br />デフォルトコンストラクタです。
     */
    public W7007CoUploadAction() {
        super();
    }
    
    /**
     * Setter method for w7007CoUploadFacadeService.
     *
     * @param coUploadFacadeService Set for w7007CoUploadFacadeService
     */
    public void setW7007CoUploadFacadeService(CreateFacadeService<W7007UpdateDomain, W7007UpdateDomain> coUploadFacadeService) {
        w7007CoUploadFacadeService = coUploadFacadeService;
    }
     ...
     * 
     * ‐File upload, search
     *     Call {@link W7007CoUploadFacadeServiceImpl}.
     * 
     ...
     * 
     * ‐ファイルのアップロード、再検索
     *     {@link W7007CoUploadFacadeServiceImpl}を呼び出します。
     * 
     * ‐検索結果の設定
     * </pre>
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        W7007UpdateDomain resultDomain = w7007CoUploadFacadeService.create(updateDomain);
    ...
    protected W7007UpdateDomain prepareUpdateDomain(W7007ActionForm form) {
        ...
        try {
            if (null != form.getCoFileData()) {
                updateDomain.getCriteriaDomain().setUploadCoFileData(form.getCoFileData().getInputStream());
                updateDomain.getCriteriaDomain().setUploadCoFileName(form.getCoFileData().getFileName());
                updateDomain.getCriteriaDomain().setUploadCoFileSize(form.getCoFileData().getFileSize());
            }
