...
import com.globaldenso.eca0027.core.business.facadeservice.presentation.W7006CoCancelFacadeServiceImpl;
import com.globaldenso.gscm.framework.business.facadeservice.presentation.DeleteFacadeService;
import com.globaldenso.gscm.framework.util.ActionUtil;

/**
 * The class of C / O Cancel action for Shipping Document Upload screen.
 * <br />船積書類アップロード画面のC/O Cancelアクションクラスです。
 * <pre>
 ...
 */
public class W7006CoCancelAction extends W7006AbstractAction {

    /**
     * C / O Cancel Facade Service
     * <br />C/O Cancel Facadeサービス
     */
    protected DeleteFacadeService<W7006UpdateDomain, W7006UpdateDomain> w7006CoCancelFacadeService;
    
    /**
     * Default constructor.
     * <br />デフォルトコンストラクタです。
     */
    public W7006CoCancelAction() {
        super();
    }

    /**
     * Setter method for w7006CoCancelFacadeService.
     *
     * @param coCancelFacadeService Set for w7006CoCancelFacadeService
     */
    public void setW7006CoCancelFacadeService(DeleteFacadeService<W7006UpdateDomain, W7006UpdateDomain> coCancelFacadeService) {
        w7006CoCancelFacadeService = coCancelFacadeService;
    }
     ...
     *     Call the {@link W7006CoCancelFacadeServiceImpl}.
     * 
     ...
     *     {@link W7006CoCancelFacadeServiceImpl}を呼出します。
     * 
     * ‐検索結果の設定
     * 
     * </pre>
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        W7006UpdateDomain resultDomain = w7006CoCancelFacadeService.delete(updateDomain);
