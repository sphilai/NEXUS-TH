...
import com.globaldenso.eca0027.core.business.facadeservice.presentation.W7006CoViewFacadeServiceImpl;
import com.globaldenso.gscm.framework.business.facadeservice.presentation.ProcessFacadeService;
import com.globaldenso.gscm.framework.util.ActionUtil;

/**
 * The class of C / O Upload for Shipping Document Upload screen.
 ...
 */
public class W7006CoViewAction extends W7006AbstractAction {

    /**
     * C / O View Facade Service
     * <br />C/O View Facadeサービス
     */
    protected ProcessFacadeService<OutputStream, W7006CriteriaDomain> w7006CoViewFacadeService;
    
    /**
     * Default constructor.
     * <br />デフォルトコンストラクタです。
     */
    public W7006CoViewAction() {
        super();
    }

    /**
     * Setter method for w7006CoViewFacadeService.
     *
     * @param coViewFacadeService Set for w7006CoViewFacadeService
     */
    public void setW7006CoViewFacadeService(ProcessFacadeService<OutputStream, W7006CriteriaDomain> coViewFacadeService) {
        w7006CoViewFacadeService = coViewFacadeService;
    }
     ...
     * 
     * ‐Getting FILE DATA
     *     Call the {@link W7006CoViewFacadeServiceImpl}.
     * 
     ...
     * 
     * ‐ファイルデータの取得
     *     {@link W7006CoViewFacadeServiceImpl}を呼出します。
     * 
     * ‐取得したファイルの表示
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        // Get file data.
        // ファイルデータの取得
        w7006CoViewFacadeService.process(criteriaDomain);
        // Download binary file.
        // 取得したファイルの表示
        ActionUtil.downloadBinary(byteOutStrm.toByteArray(), criteriaDomain.getCoFileName(), response);
