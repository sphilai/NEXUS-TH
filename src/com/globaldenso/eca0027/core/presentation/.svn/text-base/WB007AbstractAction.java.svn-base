 ...
 */
public abstract class WB007AbstractAction extends AbstractAction {

    /**
     * constructor.
     * <br />デフォルトコンストラクタ。
     */
    public WB007AbstractAction() {
        super();
    }
    ...
    protected void postInvokeExecute(ActionMapping mapping, ActionForm form,
        ...
        wB007Form.setCallScreenId(SCREEN_ID_WB007);
    }
     ...
     */
    protected void setCommonInfo(WB007ActionForm form) {
