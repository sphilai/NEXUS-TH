...
import com.globaldenso.eca0027.core.business.facadeservice.presentation.W7006ChangeStatusFacadeServiceImpl;
import com.globaldenso.gscm.framework.business.facadeservice.presentation.UpdateFacadeService;
import com.globaldenso.gscm.framework.util.ActionUtil;

/**
 * The class of Change Status action for Shipping Document Upload screen.
 * <br />船積書類アップロード画面のChange Statusアクションクラスです。
 * <pre>
 ...
 */
public class W7006ChangeStatusAction extends W7006AbstractAction {

    /**
     * Change Status Facade Service
     * <br />Change Status Facadeサービス
     */
    protected UpdateFacadeService<W7006UpdateDomain, W7006UpdateDomain> w7006ChangeStatusFacadeService;
    
    /**
     * Default constructor.
     * <br />デフォルトコンストラクタです。
     */
    public W7006ChangeStatusAction() {
        super();
    }

    /**
     * Setter method for w7006ChangeStatusFacadeService.
     *
     * @param changeStatusFacadeService Set for w7006ChangeStatusFacadeService
     */
    public void setW7006ChangeStatusFacadeService(UpdateFacadeService<W7006UpdateDomain, W7006UpdateDomain> changeStatusFacadeService) {
        w7006ChangeStatusFacadeService = changeStatusFacadeService;
    }
     ...
     * 
     * ‐Update Invoice STATUS, search
     *     Call the {@link W7006ChangeStatusFacadeServiceImpl}.
     * 
     ...
     * 
     * ‐インボイスステータスの更新、再検索
     *     {@link W7006ChangeStatusFacadeServiceImpl}を呼出します。
     * 
     * ‐検索結果の設定
     * 
     * </pre>
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response)
        ...
        W7006UpdateDomain resultDomain = w7006ChangeStatusFacadeService.update(udpateDomain);
