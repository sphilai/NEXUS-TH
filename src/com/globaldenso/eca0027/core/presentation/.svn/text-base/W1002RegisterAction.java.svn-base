 ...
 */
public class W1002RegisterAction extends W1002AbstractAction {

    /**
     * RegisterFacade service
     * <br />RegisterFacadeサービス
     */
    protected TransactFacadeService<W1002UpdateDomain, W1002UpdateDomain> w1002RegisterFacadeService;
    
    /**
     * constructor.
     */
    public W1002RegisterAction() {
        super();
    }

    /**
     * Setter method for w1002RegisterFacadeService.
     *
     * @param registerFacadeService Set for registerFacadeService
     */
    public void setW1002RegisterFacadeService(
        TransactFacadeService<W1002UpdateDomain, W1002UpdateDomain> registerFacadeService) {
        w1002RegisterFacadeService = registerFacadeService;
    }
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form,
        ...
        W1002UpdateDomain resultDomain = w1002RegisterFacadeService.transact(updateDomain);
        
        w1002Form.setW1002CriteriaDomain(resultDomain.getCriteriaDomain());
        ...
        } else if (MODE_EDIT.equals(procMode) || MODE_REF.equals(procMode)) {
            addGlobalMessage(request, GSCM_I0_0006, 1);
        }
