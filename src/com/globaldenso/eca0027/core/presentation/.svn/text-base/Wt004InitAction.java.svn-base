...
/**
 * The initial action class of Package Search Sub Screen.
 * <br />包装材選択子画面の初期表示アクションクラスです。
 * <pre>
...
public class Wt004InitAction extends Wt004AbstractAction {

    /**
     * Default constructor.
     */
    public Wt004InitAction() {
        super();
    }
