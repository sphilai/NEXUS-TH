...
/**
 * The class of action for Init Documentation Invoice Detail of (Full Returnable) screen.
 * <br />通関書類作成業務 Invoice Detail(Full Returnable)画面のInitアクションクラスです。
 * 
 * @author $Author: 10088DS50908 $
 * @version $Revision: 13589 $
 */
public class W6008InitAction extends W6008AbstractAction {
    /**
     * W6008InitFacadeService
     */
    protected SearchFacadeService<W6008UpdateDomain, W6008CriteriaDomain> w6008InitFacadeService;
    
    /**
     * Default constructor.
     * <br />デフォルトコンストラクタです。
     */
    public W6008InitAction() {
        super();
    }
    
    /**
     * Setter method for w6008InitFacadeService.
     *
     * @param initFacadeService Set for w6008InitFacadeService
     */
    public void setW6008InitFacadeService(
        SearchFacadeService<W6008UpdateDomain, W6008CriteriaDomain> initFacadeService) {
        w6008InitFacadeService = initFacadeService;
    }
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form,
        ...
        // 親画面からの引継値の設定
        WindowInfoDomain windowInfo = (WindowInfoDomain) DensoContext.get().getGeneralArea(w6008Form.getWindowId());
        ...
        W6008UpdateDomain updateDomain = w6008InitFacadeService.search(criteriaDomain);
        ...
        updateDomain.getCriteriaDomain().setCmlTyp(updateDomain.getCriteriaDomain().getCmlTyp());
        
        w6008Form.setW6008CriteriaDomain(updateDomain.getCriteriaDomain());
        w6008Form.setListDomainList(updateDomain.getListDomainList());
        
        // ST959 UNIT CONVERSION MOD START
        //if (FLAG_Y.equals(updateDomain.getCriteriaDomain().getUnitPriceError())) {
        //    throw new GscmApplicationException(NXS_E1_0052);
        //}
        ActionMessages messages = new ActionMessages();
        if (FLAG_Y.equals(updateDomain.getCriteriaDomain().getTotalNetWeightOverflowFlg())) {
