 ...
 * @version $Revision$
 */
public interface W1007ExpRequestDtlKitDao {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria W1007ExpRequestDtlKitの CriteriaDomain クラス
     * @return W1007ExpRequestDtlKitのDomainクラス
     ...
     * 
     * @param criteria W1007ExpRequestDtlKitの CriteriaDomain クラス
     * @return W1007ExpRequestDtlKitのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 主キーを条件に、データを更新します。
     * 
     * @param domain W1007ExpRequestDtlKitのDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
