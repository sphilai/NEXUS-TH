 ...
 * @version $Revision$
 */
public interface W1006ExpRequestDao {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria W1006ExpRequestの CriteriaDomain クラス
     * @return W1006ExpRequestのDomainクラス
     ...
     * 主キーを条件に、データを更新します。
     * 
     * @param domain W1006ExpRequestのDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
