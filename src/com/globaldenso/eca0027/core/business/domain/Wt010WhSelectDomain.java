...
/**
 * The BL layer domain class that holds the detail information of Warehouse Search Sub
 * Screen List section. <br />
 * 倉庫選択子画面一覧部の明細情報を保持するBL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Wt010WhSelectDomain extends AbstractDomain {
