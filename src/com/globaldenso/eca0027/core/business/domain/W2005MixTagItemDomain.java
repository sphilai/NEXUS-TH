...
/**
 * This is a domain class holding a MIXED ITEM NO.
 * <br />MIXED品目番号を保持するドメインクラスです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class W2005MixTagItemDomain extends AbstractDomain {
    ...
    /**
     * MixTagOdrDomain LIST
     * <br />MIXED品目番号受注情報リスト
     */
    private List<W2005MixTagOdrDomain> mixTagOdrDomainList;
     ...
     * <br />製造部工場区分(hidden)
     */
    private String hiddenPlntCd;
    
    /**
     * constructor.
     * <br />デフォルトコンストラクタです。
     */
    public W2005MixTagItemDomain() {
    }
    ...
    /**
     * Getter method for mixTagOdrDomainList.
     *
     * @return the mixTagOdrDomainList
     */
    public List<W2005MixTagOdrDomain> getMixTagOdrDomainList() {
        return mixTagOdrDomainList;
    }

    /**
     * Setter method for mixTagOdrDomainList.
     *
     * @param mixTagOdrDomainList Set for mixTagOdrDomainList
     */
    public void setMixTagOdrDomainList(
        List<W2005MixTagOdrDomain> mixTagOdrDomainList) {
        this.mixTagOdrDomainList = mixTagOdrDomainList;
    }
    ...
    /**
     * Setter method for odr.
     *
     * @param odr Set for odr
     */
    ...
    /**
     * Setter method for stockQty.
     *
     * @param stockQty Set for stockQty
     */
    ...
    /**
     * Getter method for maxRev.
     *
     * @return the maxRev
     */
    public BigDecimal getMaxRev() {
        return maxRev;
    }

    /**
     * Setter method for maxRev.
     *
     * @param maxRev Set for maxRev
     */
    public void setMaxRev(BigDecimal maxRev) {
        this.maxRev = maxRev;
    }
    ...
    /**
     * Getter method for hiddenPlntCd.
     *
     * @return the hiddenPlntCd
     */
    public String getHiddenPlntCd() {
        return hiddenPlntCd;
    }

    /**
     * Setter method for hiddenPlntCd.
     *
     * @param hiddenPlntCd Set for hiddenPlntCd
     */
    public void setHiddenPlntCd(String hiddenPlntCd) {
        this.hiddenPlntCd = hiddenPlntCd;
    }
