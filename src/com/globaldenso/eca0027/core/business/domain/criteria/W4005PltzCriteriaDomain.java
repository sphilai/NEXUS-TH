...
/**
 * The domain class that holds the palletize search criteria Staging Actuality for
 * <br />山作り実績用のパレタイズ検索条件を保持するドメインクラスです。
 *
 * @author $Author: masaki_awata@dnitsol.com $
 * @version $Revision: 4746 $
 */
public class W4005PltzCriteriaDomain extends AbstractDomain {
     ...
     */
    private Date lastTrRcvDtFrom;

    /**
     * Last TR receive date to.
     */
    private Date lastTrRcvDtTo;
     ...
     * Constructor.
     */
    public W4005PltzCriteriaDomain() {
    }
     ...
     */
    public Date getLastTrRcvDtFrom() {
     ...
     */
    public void setLastTrRcvDtFrom(Date lastTrRcvDtFrom) {
     ...
     */
    public void setLastTrRcvDtTo(Date lastTrRcvDtTo) {
