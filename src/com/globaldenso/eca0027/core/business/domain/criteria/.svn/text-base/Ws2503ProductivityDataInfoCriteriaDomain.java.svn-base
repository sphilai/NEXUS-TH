...
/**
 * The parameter domain of ECA0027_WS_2503.
 * <br />ECA0027_WS_2503のパラメータドメインです。
 *
 * @author $Author: 810833843 $
 * @version $Revision: 7707 $
 */
public class Ws2503ProductivityDataInfoCriteriaDomain extends AbstractDomain{
     ...
     * <br />デフォルトコンストラクタです。
     */
    public Ws2503ProductivityDataInfoCriteriaDomain() {
    }
