...
/**
 * The BL layer domain class that holds the criteria information of Company
 * Search Sub Screen. <br/>会社選択子画面の検索条件を保持するBL層用ドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Wt001CompSelectCriteriaDomain extends AbstractDomain {
     ...
     * Default constructor.
     */
    public Wt001CompSelectCriteriaDomain() {
    }
