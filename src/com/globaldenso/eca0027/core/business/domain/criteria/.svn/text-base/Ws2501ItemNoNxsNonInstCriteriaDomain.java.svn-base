...
/**
 * The Criteria domain for acquiring the result of SearchItemNoNxsNonInst.
 * <br />SearchItemNoNxsNonInstの結果を取得するためのCriteriaドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Ws2501ItemNoNxsNonInstCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * <br />デフォルトコンストラクタ。
     */
    public Ws2501ItemNoNxsNonInstCriteriaDomain() {
    }
