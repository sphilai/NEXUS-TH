...
/**
 * The domain that holds the search condition of the header information of the form [LC001].
 * <br />帳票【LC001】のヘッダー情報の検索条件を保持するドメインです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 10993 $
 */
public class LC001TtPltzByHeaderCriteriaDomain extends AbstractDomain {
     ...
     *
     */
    public LC001TtPltzByHeaderCriteriaDomain() {
    }
