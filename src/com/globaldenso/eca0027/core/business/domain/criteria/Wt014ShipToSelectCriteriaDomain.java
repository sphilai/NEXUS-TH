...
/**
 * The PL layer domain class that holds the criteria information of Ship to Search Sub Screen.
 * <br/>送荷先選択子画面の検索条件を保持するPL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Wt014ShipToSelectCriteriaDomain extends AbstractDomain{
     ...
     * Default constructor.
     */
    public Wt014ShipToSelectCriteriaDomain() {
    }
