...
/**
 * The domain that holds the search condition of the item of information form [LB001].
 * <br />帳票【LB001】のヘッダー情報の検索条件を保持するドメインです。
 * 
 * @author $Author: r-moribe $
 * @version $Revision: 1559 $
 */
public class LB001VtRpOdrRcvErrReportByHdrCriteriaDomain extends AbstractDomain {
     ...
     *
     */
    public LB001VtRpOdrRcvErrReportByHdrCriteriaDomain() {
    }
