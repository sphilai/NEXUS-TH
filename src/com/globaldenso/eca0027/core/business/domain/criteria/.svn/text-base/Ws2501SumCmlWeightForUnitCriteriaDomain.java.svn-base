...
/**
 * Criteria domain for acquiring the result of SearchSumCmlWeightForUnit.
 * <br />SearchSumCmlWeightForUnitの結果を取得するためのCriteriaドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Ws2501SumCmlWeightForUnitCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * <br />デフォルトコンストラクタ。
     */
    public Ws2501SumCmlWeightForUnitCriteriaDomain() {
    }
