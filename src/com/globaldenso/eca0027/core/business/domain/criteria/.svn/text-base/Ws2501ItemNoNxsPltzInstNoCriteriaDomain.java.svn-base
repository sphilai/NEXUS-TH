...
/**
 * The Criteria domain for acquiring the result of SearchItemNoNxsPltzInstNo.
 * <br />SearchItemNoNxsPltzInstNoの結果を取得するためのCriteriaドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Ws2501ItemNoNxsPltzInstNoCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * <br />デフォルトコンストラクタ。
     */
    public Ws2501ItemNoNxsPltzInstNoCriteriaDomain() {
    }
