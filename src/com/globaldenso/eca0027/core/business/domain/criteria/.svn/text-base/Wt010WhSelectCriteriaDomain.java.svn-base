...
/**
 * The BL layer domain class that holds the criteria information of Warehouse Search Sub
 * Screen. <br/>倉庫選択子画面の検索条件を保持するBL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */

public class Wt010WhSelectCriteriaDomain extends AbstractDomain {
     ...
     * Default constructor.
     */
    public Wt010WhSelectCriteriaDomain() {
    }
