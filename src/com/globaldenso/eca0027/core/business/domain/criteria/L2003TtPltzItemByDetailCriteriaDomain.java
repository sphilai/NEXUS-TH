...
/**
 * The domain that holds the search criteria for acquisition of header information of the form [L2003].(in the case of single and multi item for the result).
 * <br/>帳票【L2003】のヘッダー情報の取得（単品）（多品番品番が結果的に単品になった場合も含む）の検索条件を保持するドメインです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 10993 $
 */
public class L2003TtPltzItemByDetailCriteriaDomain extends AbstractDomain {
     ...
     *
     */
    public L2003TtPltzItemByDetailCriteriaDomain() {
    }
