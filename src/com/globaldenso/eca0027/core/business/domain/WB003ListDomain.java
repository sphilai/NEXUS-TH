...
/**
 * This is a List domain of ordering two or more P / O registration picture.
 * <br />受注複数P/O登録画面のListドメインです。
 *
 * @version $Revision: 6761 $
 */
public class WB003ListDomain extends AbstractDomain {
     ...
     * <br />分納回数
     */
    private String partialDelivCnt;
     ...
     * <br />梱包引当数量
     */
    private String pltzAllocQtyHidden;
    ...
    /**
     * Warning Flg (Firm Qty)
     * <br />ワーニングフラグ(Firm Qty)
     */
    private String warningFlgFirmQty;
    
    /**
     * Warning Flg (Forecast Qty)
     * <br />ワーニングフラグ(Forecast Qty)
     */
    private String warningFlgForecastQty;
     ...
     */
    public void setOdrQtyOrg(String odrQtyOrg) {
     ...
     */
    public String getPartialDelivCnt() {
     ...
     */
    public void setPartialDelivCnt(String partialDelivCnt) {
     ...
     */
    public String getPltzAllocQtyHidden() {
     ...
     */
    public void setPltzAllocQtyHidden(String pltzAllocQtyHidden) {
    ...
    /**
     * Getter method for warningFlgFirmQty.
     *
     * @return the warningFlgFirmQty
     */
    public String getWarningFlgFirmQty() {
        return warningFlgFirmQty;
    }

    /**
     * Setter method for warningFlgFirmQty.
     *
     * @param warningFlgFirmQty Set for warningFlgFirmQty
     */
    public void setWarningFlgFirmQty(String warningFlgFirmQty) {
        this.warningFlgFirmQty = warningFlgFirmQty;
    }

    /**
     * Getter method for warningFlgForecastQty.
     *
     * @return the warningFlgForecastQty
     */
    public String getWarningFlgForecastQty() {
        return warningFlgForecastQty;
    }

    /**
     * Setter method for warningFlgForecastQty.
     *
     * @param warningFlgForecastQty Set for warningFlgForecastQty
     */
    public void setWarningFlgForecastQty(String warningFlgForecastQty) {
        this.warningFlgForecastQty = warningFlgForecastQty;
    }
}
