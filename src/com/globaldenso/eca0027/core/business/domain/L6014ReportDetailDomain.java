...
/**
 * The domain class of form [L6014] that output for domain form (specification).
 * <br/>帳票【L6014】の帳票出力用ドメイン（明細）です。
 *
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class L6014ReportDetailDomain extends AbstractDomain {
    /**
     * serial version<br />
     * シリアルバージョン
     */
     ...
     * Default Constructor
     */
    public L6014ReportDetailDomain() {
    }
    ...
    /**
     * Setter method for customerOrderNo.<br />
