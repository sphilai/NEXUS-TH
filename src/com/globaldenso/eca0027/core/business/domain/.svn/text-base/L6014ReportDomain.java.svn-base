...
/**
 * The domain class that holds the information of the document [L6014].
 * <br/>帳票【L6014】の情報を保持するドメインクラスです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 11913 $
 */
public class L6014ReportDomain extends AbstractDomain {
    /**
     * serial version<br />
     * シリアルバージョン
     */
    ...
    /** detailList */
    private List<? extends L6014ReportDetailDomain> detailList = null;
    
    /**
     * Default Constructor
     */
    public L6014ReportDomain() {
    }
     ...
     */
    public List<? extends L6014ReportDetailDomain> getDetailList() {
        return detailList;
    }
    /**
     ...
     */
    public void setDetailList(List<? extends L6014ReportDetailDomain> detailList) {
