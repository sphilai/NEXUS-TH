...
/**
 * The BL layer domain class that holds the detail information of Shipping Actuality Warning List Sub Screen List section. 
 * <br/>船積実績ワーニングリスト子画面一覧部の明細情報を保持するBL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Wt017ShippingActWarnListDomain extends AbstractDomain{
     ...
     * Default constructor.
     */
    public Wt017ShippingActWarnListDomain() {
    }
    ...
    /**
     * <p>Getter method for timezoneId.</p>
     *
    ...
    /**
     * <p>Setter method for timezoneId.</p>
     *
