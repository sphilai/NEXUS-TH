...
/**
 * The domain class that holds the information of EXPORT TRANSFER REPORT (BY Parts Kanban)
 * 
 * @author $Author: chonthicha.a@denso.co.th $
 * @version $Revision: XXXX $
 */
public class L3004ReportDomain extends AbstractDomain {
    ...
    */
     ...
     * Total Boxes
     */
    private String sumCarryOutCaseQty;
    ...
    */
     ...
     * Detail domain list.
     */
    private List<? extends L3004ReportDetailDomain> detailDomainList;

    /**
     * Constructor.
     */
    public L3004ReportDomain() {
    }
    ...
    /**
     * Getter method for sumCarryOutCaseQty.
     * 
     * @return the sumCarryOutCaseQty
     */
    public String getSumCarryOutCaseQty() {
        return sumCarryOutCaseQty;
    }

    /**
     * Setter method for sumCarryOutCaseQty.
     * 
     * @param sumCarryOutCaseQty Set for sumCarryOutCaseQty
     */
    public void setSumCarryOutCaseQty(String sumCarryOutCaseQty) {
        this.sumCarryOutCaseQty = sumCarryOutCaseQty;
    }
     ...
     */
    public List<? extends L3004ReportDetailDomain> getDetailDomainList() {
     ...
     */
    public void setDetailDomainList(List<? extends L3004ReportDetailDomain> detailDomainList) {
