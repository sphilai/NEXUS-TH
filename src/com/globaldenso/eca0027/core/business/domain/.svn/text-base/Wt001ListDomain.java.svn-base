...
/**
 * The PLlayer domain class that holds the detail information of Company Search
 * Sub Screen List section. <br />
 * 会社選択子画面一覧部の明細情報を保持するPL層用ドメインクラスです。
 * 
 * @author $Author: 400616000407 $
 * @version $Revision: 12983 $
 */
public class Wt001ListDomain extends AbstractDomain {
    ...
    /**
     * <p>Getter method for compNmAbb.</p>
     *
    ...
    /**
     * <p>Setter method for compNmAbb.</p>
     *
    ...
    /**
     * <p>Getter method for compAddr.</p>
     *
     * @return the compAddr
     */
    ...
    /**
     * <p>Setter method for compAddr.</p>
     *
     * @param compAddr Set for compAddr
     */
    ...
    /**
     * <p>
     * Setter method for compTel.
     * </p>
     * 
     * @param compTel Set for compTel
     */
