...
/**
 * It is a mass update domain class of Receive
 * <br />Receive画面の一括更新ドメインクラスです。
 *
 * @author SNT Ri
 * @version v.1.0
 */
public class W3010ReceiveDomain extends AbstractDomain {
     ...
     */
    private List<? extends W3010ListDomain> w3010ListDomainList;
     ...
     * Constructor.
     */
    public W3010ReceiveDomain() {
    }

    /**
     * <p>
     * Getter method for w3010ListDomainList.
     * </p>
     * 
     * @return the w3010ListDomainList
     */
    public List<? extends W3010ListDomain> getW3010ListDomainList() {
        return w3010ListDomainList;
    }

    /**
     * <p>
     * Setter method for w3010ListDomainList.
     * </p>
     * 
     * @param listDomainList Set for w3010ListDomainList
     */
    public void setW3010ListDomainList(
        List<? extends W3010ListDomain> listDomainList) {
        w3010ListDomainList = listDomainList;
    }
