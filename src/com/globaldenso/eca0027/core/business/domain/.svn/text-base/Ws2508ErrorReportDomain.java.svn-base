 ...
 * <br />ECA0027_WS_2508のエラーレポート結果ドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class Ws2508ErrorReportDomain {
    ...
    /**
     * The time stamp of the MixTag error report (header) registered by Web service
     * <br />Webサービスで登録したMixTagエラーレポート（ヘッダ）のタイムスタンプ
     */
     ...
     *
     */
    public Ws2508ErrorReportDomain() {
        super();
    }
