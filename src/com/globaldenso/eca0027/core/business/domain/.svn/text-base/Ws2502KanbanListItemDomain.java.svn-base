...
/**
 * This is a KANBAN list item result domain of ECA0027_WS_2502.
 * <br />ECA0027_WS_2502のかんばんリスト項目結果ドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class Ws2502KanbanListItemDomain implements Serializable {
    ...
    /**
     * EXPORT CUSTOMER REGULATE NO
     * <br />輸出側得意先整理NO
     */
    @XmlElement(name = "customerTagSeq")
     ...
     *
     */
    public Ws2502KanbanListItemDomain() {
        super();
    }
