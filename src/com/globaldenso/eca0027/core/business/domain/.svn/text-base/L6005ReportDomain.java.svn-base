...
/**
 * The domain class that holds the information of the document [L6005].
 * <br/>帳票【L6005】の情報を保持するドメインクラスです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 11913 $
 */
public class L6005ReportDomain extends AbstractDomain {
    ...
    /** detailList */
    private List<L6005ReportDetailDomain> detailList = null;
    
    /**
     * Default Constructor
     */
    public L6005ReportDomain() {
    }
    ...
    /**
     * It is the setter method of totalAmount.<br />
     ...
     */
    public List<L6005ReportDetailDomain> getDetailList() {
        return detailList;
    }
    /**
     ...
     */
    public void setDetailList(List<L6005ReportDetailDomain> detailList) {
