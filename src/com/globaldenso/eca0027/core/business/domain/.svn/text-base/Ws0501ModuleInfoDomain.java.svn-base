 ...
 *
 * <p>
 * This is the domain that holds the information of BHT module.
 * BHTモジュールの情報を保持するドメインです。
 * </p>
 *
 * @version 1.00
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class Ws0501ModuleInfoDomain implements
        Serializable {
