 ...
 */
public class L6005ReportDetailDomain extends AbstractDomain {
    ...
    /** LWH of Returnable Package Material */
    private String lwh; // UT287 ADD
    
    /**
     * Default Constructor
     */
    public L6005ReportDetailDomain() {
    }
    ...
    /**
     * Setter method for lwh.
     *
     * @param lwh Set for lwh
     */
