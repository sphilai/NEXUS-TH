...
/**
 * The PL layer domain class that holds the criteria information of Package Search Sub Screen.
 * <br/>包装材選択子画面の検索条件を保持するPL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Wt004CriteriaDomain extends AbstractDomain {
