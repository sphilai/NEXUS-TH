...
/**
 * The domain class that holds the information of the document [L2003].
 * <br/>帳票【L2003】の情報を保持するドメインクラスです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 11947 $
 */
public class L2003ReportDomain extends AbstractDomain {
     ...
     *      * Sub QR Title.
     */
    private String subQrTitle = null;
     ...
     * 明細ドメインのリスト
     */
    private List<? extends L2003ReportDetailDomain> detailList;

    /**
     * Default Constructor
     */
    public L2003ReportDomain() {
    }
     ...
     */
    public List<? extends L2003ReportDetailDomain> getDetailList() {
        return detailList;
    }
     ...
     */
    public void setDetailList(List<? extends L2003ReportDetailDomain> detailList) {
    ...
    /**
     * Getter method of subQrTitle.
     *
     * @return the subQrTitle.
     */
    public String getSubQrTitle() {
        return subQrTitle;
    }

    /**
     * Setter method of subQrTitle.
     *
     * @param subQrTitle Value to be stored in subQrTitle.
     */
    public void setSubQrTitle(String subQrTitle) {
        this.subQrTitle = subQrTitle;
    }
