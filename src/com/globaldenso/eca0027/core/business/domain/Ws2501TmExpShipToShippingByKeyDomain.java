...
/**
 * The domain holding the result of TmExpShipToShippingByKeyDomain.
 * <br />TmExpShipToShippingByKeyDomainの結果を保持するドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Ws2501TmExpShipToShippingByKeyDomain extends AbstractDomain implements Serializable {
     ...
     * <br />デフォルトコンストラクタ。
     */
    public Ws2501TmExpShipToShippingByKeyDomain() {
    }
    /**
