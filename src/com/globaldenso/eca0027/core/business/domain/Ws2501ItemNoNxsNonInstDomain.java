...
/**
 * The domain holding the result of SearchItemNoNxsNonInst.
 * <br />SearchItemNoNxsNonInstの結果を保持するドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Ws2501ItemNoNxsNonInstDomain extends AbstractDomain implements Serializable {
     ...
     * QTY
     */
    private BigDecimal  tmpStockQty;

    /**
     * constructor.
     * <br />デフォルトコンストラクタ。
     */
    public Ws2501ItemNoNxsNonInstDomain() {
    }
    ...
    /**
     * Getter method for tmpStockQty.
     *
     * @return the tmpStockQty
     */
    public BigDecimal getTmpStockQty() {
        return tmpStockQty;
    }

    /**
     * Setter method for tmpStockQty.
     *
     * @param tmpStockQty Set for tmpStockQty
     */
    public void setTmpStockQty(BigDecimal tmpStockQty) {
        this.tmpStockQty = tmpStockQty;
    }
}
