 ...
 * of CIGMA Ship to X-Reference MA Inquiry Screen.
 * <br />CIGMA Ship to X-Reference MA Inquiry画面の修正・参照facadeサービス実装クラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class W9009EditOrReferFacadeServiceImpl 
    extends AbstractProcessFacadeService<W9009UpdateDomain, W9009UpdateDomain>{

    /**
     * Default constructor./デフォルトコンストラクタ。
     */
    public W9009EditOrReferFacadeServiceImpl() {
    }
     ...
     */
    @Override
    protected  W9009UpdateDomain callServices(W9009UpdateDomain criteriaDomain)
