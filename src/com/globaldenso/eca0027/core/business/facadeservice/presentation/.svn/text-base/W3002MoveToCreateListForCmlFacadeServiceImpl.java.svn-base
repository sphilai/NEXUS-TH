...
/**
 * <p>The implementation class of Create List for CML Action on Carry out Header</p>
 * <p>Carry out HeaderのMove to Create List for CMLアクションに対するFacadeサービスの実装クラスです。</p>
 * @author DIAT Chaiporn.A
 * @version 1.00
 */
public class W3002MoveToCreateListForCmlFacadeServiceImpl extends AbstractTransactFacadeService<Void, W3002CriteriaDomain> {
     ...
     *
     */
    public W3002MoveToCreateListForCmlFacadeServiceImpl() {
        super();
    }
