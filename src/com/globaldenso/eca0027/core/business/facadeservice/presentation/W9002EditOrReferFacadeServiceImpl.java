...
/**
 * The implementation class for facade service to edit or refer action of 
 * Agent MA Inquiry screen.
 * <br />Agent MA Inquiry画面のEditOrReferアクションに対するFacadeサービスの実装クラスです。
 *
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class W9002EditOrReferFacadeServiceImpl extends AbstractProcessFacadeService<Void, W9002UpdateDomain> {
     ...
     * デフォルトコンストラクタです。
     */
    public W9002EditOrReferFacadeServiceImpl() {
    }
    ...
    protected W9002UpdateDomain filterDomain(W9002UpdateDomain updateDomain)
        ...
        List<W9002ListDomain> newListDomainList = new ArrayList<W9002ListDomain>();
        
        // selected List domain is extracted.
        // 選択されたListドメインを抽出
        for (W9002ListDomain listDomain : updateDomain.getListDomainList()) {
    ...
    * <pre>
     ...
     */
    @Override
    protected Void callServices(W9002UpdateDomain updateDomain)
        throws GscmApplicationException, ApplicationException {
        return null;
    }
}
