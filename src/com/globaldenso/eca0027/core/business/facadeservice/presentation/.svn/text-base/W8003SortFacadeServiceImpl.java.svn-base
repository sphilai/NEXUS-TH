...
/**
 * An implementation class for facade service to sort action of progress control case mark list screen.
 * <br />進度管理 ケースマーク一覧画面のSortアクションに対するFacadeサービスの実装クラスです。
 *
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class W8003SortFacadeServiceImpl extends AbstractSearchFacadeService<List<? extends W8003ListDomain>, W8003CriteriaDomain> {
     ...
     * <br />デフォルトコンストラクタです。
     */
    public W8003SortFacadeServiceImpl() {
    }
     ...
     * - Get search result.
     * Call  {@link W8001ProgCtrlService#searchOnCmlDetailSort}.
     * </pre>
     * <pre>
     * ‐進度管理サービスの条件ドメインを作成
     ...
     * 
     * ‐検索結果データ取得
     *     {@link W8001ProgCtrlService#searchOnCmlDetailSort}を呼出す
     * </pre>
    ...
    protected List<? extends W8003ListDomain> callServices(W8003CriteriaDomain w8003CriteriaDomain)
        ...
        List<? extends W8001ProgCtrlDomain> progCtrlList = w8001ProgCtrlService.searchOnCmlDetailSort(criteria);
     ...
     * 変換結果
     */
    protected List<? extends W8003ListDomain> convertToListDomain(W8001ProgCtrlCriteriaDomain criteria, List<? extends W8001ProgCtrlDomain> progCtrlList, String dateFormat, String authFlag) {
