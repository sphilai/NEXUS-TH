...
/**
 * <p>The implementation class of Create TR for Parts Action on Carry out Header</p>
 * <p>Carry out HeaderのMove to Create TR for Partsアクションに対するFacadeサービスの実装クラスです。</p>
 * @author TIS Tanaka
 * @version 1.00
 */
public class W3002MoveToCreateTrForPartsFacadeServiceImpl extends AbstractTransactFacadeService<Void, W3002CriteriaDomain> {
     ...
     *
     */
    public W3002MoveToCreateTrForPartsFacadeServiceImpl() {
        super();
    }
