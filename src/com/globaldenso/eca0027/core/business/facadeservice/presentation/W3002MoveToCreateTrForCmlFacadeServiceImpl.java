...
/**
 * <p>The implementation class of Create TR for CML Action on Carry out Header</p>
 * <p>Carry out HeaderのMove to Create TR for CMLアクションに対するFacadeサービスの実装クラスです。</p>
 * @author TIS Tanaka
 * @version 1.00
 */
public class W3002MoveToCreateTrForCmlFacadeServiceImpl extends AbstractTransactFacadeService<Void, W3002CriteriaDomain> {
     ...
     *
     */
    public W3002MoveToCreateTrForCmlFacadeServiceImpl() {
        super();
    }
