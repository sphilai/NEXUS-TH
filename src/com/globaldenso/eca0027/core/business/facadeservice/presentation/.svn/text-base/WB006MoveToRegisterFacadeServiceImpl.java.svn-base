 ...
 */
public class WB006MoveToRegisterFacadeServiceImpl extends AbstractProcessFacadeService<WB006UpdateDomain, WB006UpdateDomain> {

    /**
     * constructor.
     * <br />デフォルトコンストラクタです。
     */
    public WB006MoveToRegisterFacadeServiceImpl() {
    }
     ...
     */
    @Override
    protected WB006UpdateDomain filterDomain(WB006UpdateDomain updateDomain)
     ...
     */
    @Override
    protected void validateItems(WB006UpdateDomain updateDomain)
     ...
     */
    @Override
    protected void validateConsistency(WB006UpdateDomain updateDomain)
        throws GscmApplicationException, ValidationException, ApplicationException {
        // No Action
        // 処理なし
    }
     ...
     */
    @Override
    protected void validateDatabase(WB006UpdateDomain updateDomain)
        throws GscmApplicationException, ValidationException, ApplicationException {
        // No Action
        // 処理なし
    }
     ...
     */
    @Override
    protected WB006UpdateDomain callServices(WB006UpdateDomain updateDomain)
        throws GscmApplicationException, ApplicationException {
        // No Action
        // 処理なし
        return updateDomain;
