...
/**
 * 
 * Facade Service with respect to the initial display action of Shipping Document Upload screen.
 * <br />船積書類アップロード画面の初期表示アクションに対するFacadeサービスです。
 *
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class W7006InitFacadeServiceImpl extends AbstractSearchFacadeService<W7006UpdateDomain, W7006CriteriaDomain> {
     ...
     * デフォルトコンストラクタです。
     */
    public W7006InitFacadeServiceImpl() {
        super();
    }
     ...
     */
    @Override
    protected W7006CriteriaDomain filterDomain(W7006CriteriaDomain criteriaDomain)
     ...
     */
    @Override
    protected void validateItems(W7006CriteriaDomain criteriaDomain)
     ...
     */
    @Override
    protected void validateConsistency(W7006CriteriaDomain criteriaDomain)
        throws GscmApplicationException, ValidationException, ApplicationException {
    }
     ...
     */
    @Override
    protected void validateDatabase(W7006CriteriaDomain criteriaDomain)
        throws GscmApplicationException, ValidationException, ApplicationException {
    }
     ...
     *     Convert to the {@link W7006UpdateDomain} {@link W7001ShippingActCriteriaDomain}
     *     
     * - Retrieval data 
     *     Call {@link W7001ShippingActService#searchOnOtherDocUploadIndividualInit}
     * </pre>
     * <pre>
     * ‐船積実績サービスの条件ドメイン作成
     ...
     * 
     * ‐検索データの取得
     *     {@link W7001ShippingActService#searchOnOtherDocUploadIndividualInit}を呼出す
     * </pre>
     * @see com.globaldenso.gscm.framework.business.facadeservice.presentation.AbstractFacadeService#callServices(com.globaldenso.gscm.framework.business.domain.AbstractDomain)
     */
    @Override
    protected W7006UpdateDomain callServices(W7006CriteriaDomain criteriaDomain)
        throws GscmApplicationException, ApplicationException {
        
        W7001ShippingActCriteriaDomain shippingActCriteria = createShippingActCriteriaDomain(criteriaDomain);
        
        W7001ShippingActDomain shippingAct = w7001ShippingActService.searchOnOtherDocUploadIndividualInit(shippingActCriteria);
        
        return convertToCriteriaDomain(criteriaDomain, shippingAct);
    }
     ...
     * 船積実績サービスの条件ドメイン
     */
    protected W7001ShippingActCriteriaDomain createShippingActCriteriaDomain(W7006CriteriaDomain criteriaDomain) {
     ...
     *
     * @param criteriaDomain Search conditions domain passed from the screen<br />
     * 画面から渡された検索条件ドメイン
     ...
     * 変換結果
     */
    protected W7006UpdateDomain convertToCriteriaDomain(W7006CriteriaDomain criteriaDomain, W7001ShippingActDomain shippingActDomain) {
        ...
        for(W7001ShippingActDocDomain docDomain : shippingActDocList) {
            ...
            // DOC_TYPが'3'のデータ
                ...
                // Others is a maximum of 20 affairs. 
                // Othersは最大10件まで
