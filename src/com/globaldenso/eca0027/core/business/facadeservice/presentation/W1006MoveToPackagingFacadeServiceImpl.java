 ...
 */
public class W1006MoveToPackagingFacadeServiceImpl extends AbstractProcessFacadeService<W1006UpdateDomain, W1006UpdateDomain> {
     ...
     * デフォルトコンストラクタです。
     */
    public W1006MoveToPackagingFacadeServiceImpl() {
    }
     ...
     */
    @Override
    protected W1006UpdateDomain filterDomain(W1006UpdateDomain updateDomain)
        ...
        W1006CriteriaDomain domain = updateDomain.getCriteriaDomain();
     ...
     */
    @Override
    protected void validateItems(W1006UpdateDomain updateDomain)
     ...
     */
    @Override
    protected void validateConsistency(W1006UpdateDomain updateDomain)
        throws GscmApplicationException, ValidationException, ApplicationException {
    }
     ...
     */
    @Override
    protected void validateDatabase(W1006UpdateDomain updateDomain)
        throws GscmApplicationException, ValidationException, ApplicationException {
    }
     ...
     */
    @Override
    protected W1006UpdateDomain callServices(W1006UpdateDomain updateDomain)
        throws GscmApplicationException, ApplicationException {
        return updateDomain;
    }
