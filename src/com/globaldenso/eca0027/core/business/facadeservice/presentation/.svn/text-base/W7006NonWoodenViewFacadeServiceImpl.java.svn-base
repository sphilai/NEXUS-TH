...
/**
 * 
 * A service for Facade NonWoodenView action of Shipping Document Upload screen.
 * <br />船積書類アップロード画面のNonWoodenViewアクションに対するFacadeサービスです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 11618 $
 */
public class W7006NonWoodenViewFacadeServiceImpl extends AbstractProcessFacadeService<OutputStream, W7006CriteriaDomain> {
     ...
     * デフォルトコンストラクタです。
     */
    public W7006NonWoodenViewFacadeServiceImpl() {
        super();
    }
     ...
     *     Call {@link W7001ShippingActService#validateDatabaseTtShippingActOnOtherDocUploadIndividualNonWoodenView}
     * </pre>
     * <pre>
     * ‐ファイル管理 取得チェック.
     *     {@link W7001ShippingActService#validateDatabaseTtShippingActOnOtherDocUploadIndividualNonWoodenView}を呼出す
     * </pre>
    ...
    protected void validateDatabase(W7006CriteriaDomain criteriaDomain)
        ...
        // ファイル管理 ロック＆取得件数チェック
        if (!w7001ShippingActService.validateDatabaseTtShippingActOnOtherDocUploadIndividualNonWoodenView(shipperCd
            , invoiceNo, invoiceIssueDt, criteriaDomain.getViewData())) {
     ...
     */
    @Override
    protected OutputStream callServices(W7006CriteriaDomain criteriaDomain)
        throws GscmApplicationException, ApplicationException {
        return criteriaDomain.getViewData();
    }
}
