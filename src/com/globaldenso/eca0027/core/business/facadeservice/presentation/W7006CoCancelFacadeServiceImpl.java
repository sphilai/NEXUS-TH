...
/**
 * 
 * A service for Facade CoCancel action of Shipping Document Upload screen.
 * <br />船積書類アップロード画面のCoCancelアクションに対するFacadeサービスです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 11615 $
 */
public class W7006CoCancelFacadeServiceImpl extends AbstractDeleteFacadeService<W7006UpdateDomain, W7006UpdateDomain> {
     ...
     * デフォルトコンストラクタです。
     */
    public W7006CoCancelFacadeServiceImpl() {
        super();
    }
     ...
     *     Call {@link W7001ShippingActService#validateDatabaseTtShippingActOnOtherDocUploadIndividualCoCancel}
     *     
     ...
     * <pre>
     * ‐船積書類 ロック＆取得件数チェック
     *     {@link W7001ShippingActService#validateDatabaseTtShippingActOnOtherDocUploadIndividualCoCancel}を呼出す
     * 
     * ‐ファイル管理 ロック＆取得件数チェック
    ...
    protected void validateDatabase(W7006UpdateDomain updateDomain)
        ...
        // 船積書類 ロック＆取得件数チェック
        if (!w7001ShippingActService.validateDatabaseTtShippingActOnOtherDocUploadIndividualCoCancel(shipperCd, invoiceNo, invoiceIssueDt, fileId)) {
        ...
        if (w7001ShippingActService.validateDatabaseLbFileManagerByShippingActDoc(docDomain)) {
            // The last update date used in order to delete the data of file ID from file management 
     ...
     *      
     * - Upload file is locked and they are deletion and re-search. . 
     *      Call {@link W7001ShippingActService#deleteOnOtherDocUploadIndividualCoCancel}
     * </pre>
     * <pre>
     * ‐船積実績サービスの条件ドメイン作成
     ...
     *     {@link W7001ShippingActService#deleteOnOtherDocUploadIndividualCoCancel}を呼出す
     * </pre>
    ...
    protected W7006UpdateDomain callServices(W7006UpdateDomain updateDomain)
        ...
        W7001ShippingActDomain shippingAct = w7001ShippingActService.deleteOnOtherDocUploadIndividualCoCancel(shippingActtCriteria);
    ...
    /**
     * Convert to FacadeService domain shipping actuality domain.
