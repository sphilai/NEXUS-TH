...
/**
 * Interface of the service that provides the output function form [Invoice Header(Comercial_Intangible)].
 * <br/>帳票【 Invoice Header(Comercial_Intangible)  】出力機能を提供するサービスのインターフェースです。
 * <pre>
 * bean id:l9001ReportService
 * </pre>
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public interface L9001ReportService {
