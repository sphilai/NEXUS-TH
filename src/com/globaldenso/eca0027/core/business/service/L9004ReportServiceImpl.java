...
import static com.globaldenso.eca0027.core.common.constants.Eca0027Constants.REPORT_ID_L9004;
...
import com.globaldenso.eca0027.core.business.domain.L9004ReportDomain;
import com.globaldenso.gscm.framework.exception.GscmApplicationException;
import com.globaldenso.gscm.framework.util.CheckUtil;

/**
 * Implementation class of the form creation service L9004 [Packing Header (Main)].
 * <br/>L9004【 Packing Header(Main)  】の帳票作成サービスの実装クラスです。
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class L9004ReportServiceImpl extends AbstractReportServiceImpl implements L9004ReportService {
    ...
    /**
     * {@inheritDoc}
     * @see com.globaldenso.eca0027.core.business.service.L9004ReportService#searchSmplPackHdrForMain(String company, String documentNo)
     */
    public File searchSmplPackHdrForMain(String company, String documentNo) throws ApplicationException {

        L9004ReportDomain reportDomain = new L9004ReportDomain();
        ...
        // Create report.
        // 帳票生成
        return createReport(REPORT_ID_L9004, reportDomain);
    }
