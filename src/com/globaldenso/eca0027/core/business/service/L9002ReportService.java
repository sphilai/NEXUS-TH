 ...
 */
public interface L9002ReportService {

    /**
     * Get the form output information to generate a form [Invoice Header (NonComercial)].<br />
     * 帳票出力情報を取得し、帳票【 Invoice Header(NonComercial)  】を生成します。
     * <pre>
