...
import static com.globaldenso.eca0027.core.common.constants.Eca0027Constants.REPORT_ID_L9008;
...
import com.globaldenso.eca0027.core.business.domain.L9008ReportDomain;
import com.globaldenso.gscm.framework.exception.GscmApplicationException;
import com.globaldenso.gscm.framework.util.CheckUtil;

/**
 * Implementation class of the form creation service L9008 [Sales Contract Header (FRT)].<br />
 * L9008【  Sales Contract Header(FRT) 】の帳票作成サービスの実装クラスです。
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class L9008ReportServiceImpl extends AbstractReportServiceImpl implements L9008ReportService {
    ...
    /**
     * {@inheritDoc}
     * @see com.globaldenso.eca0027.core.business.service.L9008ReportService#searchSmplSalesCntrctHdrForFrt(String company, String documentNo)
     */
    public File searchSmplSalesCntrctHdrForFrt(String company, String documentNo) throws ApplicationException {

        L9008ReportDomain reportDomain = new L9008ReportDomain();
        ...
        // Create report.
        // 帳票生成
        return createReport(REPORT_ID_L9008, reportDomain);
    }
