 ...
 * PROJECT：eca0027
 * 
 * W1008PltzItem のServiceインターフェース
 * 
...
/**
 * W1008PltzItem のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface W1008PltzItemService {


    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria W1008PltzItemの CriteriaDomain クラス
     * @return W1008PltzItemのDomainクラスのList
     ...
     * データを登録します。
     * 
     * @param domain W1008PltzItemのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain List<W1008PltzItemDomain>
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public void createList(List<W1008PltzItemDomain> domain) throws ApplicationException;

    /**
     * 主キーを条件に、データを物理削除します。
     * 
     * @param criteria W1008PltzItemのCriteriaDomainクラス
     * @return 削除件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
