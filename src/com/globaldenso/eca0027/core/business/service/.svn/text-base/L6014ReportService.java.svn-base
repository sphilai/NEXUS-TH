...
/**
 * Interface of the service that provides the output function form [Sales Contract Attached(MAIN)].
 * <br/>帳票【 Sales Contract Attached(MAIN) 】出力機能を提供するサービスのインターフェースです。
 * <pre>
 * bean id:l6014ReportService
 * </pre>
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7682 $
 */
public interface L6014ReportService {

    /**
     * Get the form output information to generate document [Sales Contract Attached (MAIN)].
     * <br/>帳票出力情報を取得し、帳票【 Sales Contract Attached(MAIN) 】を生成します。
     * <pre>
