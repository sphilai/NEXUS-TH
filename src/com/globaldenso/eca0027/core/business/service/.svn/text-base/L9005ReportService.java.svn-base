...
/**
 * Interface of the service that provides the output function form [Packing Header(FRT)].
 * <br/>帳票【 Packing Header(FRT)   】出力機能を提供するサービスのインターフェースです。
 * <pre>
 * bean id:l9005ReportService
 * </pre>
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public interface L9005ReportService {

    /**
     * Get the form output information to generate a form [Packing Header (FRT)] .
