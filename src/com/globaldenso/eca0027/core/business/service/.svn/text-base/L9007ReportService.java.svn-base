 ...
 * <pre>
 * bean id:l9007ReportService
 * </pre>
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public interface L9007ReportService {

    /**
     * Get the form output information to generate document [Sales Contract Header (NonComercial)] .
     * <br/>帳票出力情報を取得し、帳票【 Sales Contract Header(NonComercial)  】を生成します。
     * <pre>
