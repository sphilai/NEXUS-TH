...
/**
 * Interface of the service that provides the output function form [Packing Attached(FRT)].
 * <br/>帳票【 Packing Attached(FRT)  】出力機能を提供するサービスのインターフェースです。
 * <pre>
 * bean id:l6009ReportService
 * </pre>
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7682 $
 */
public interface L6009ReportService {
     ...
     *   Call the VtRpPackAtchedForFrtService.searchByCondition (VtRpPackAtchedForFrtCriteriaDomain) as an argument criteriaDomain.
     ...
     *       criteriaDomainを引数に{@link VtRpPackAtchedForFrtService#searchByCondition(VtRpPackAtchedForFrtCriteriaDomain)}を呼び出します。
     *       取得件数が0であれば、エラーとします。
     *       
