 ...
 * <pre>
 * bean id:l6002ReportService
 * </pre>
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7682 $
 */
public interface L6002ReportService {
     ...
     *   Call the VtRpInvHdrForNonCmrclService.searchByCondition (VtRpInvHdrForNonCmrclCriteriaDomain) as an argument criteriaDomain.
     ...
     *       
     * - 印刷対象のインボイスヘッダデータの取得
     *       criteriaDomainを引数に{@link VtRpInvHdrForNonCmrclService#searchByCondition(VtRpInvHdrForNonCmrclCriteriaDomain)}を呼び出します。
     *       取得件数が0であれば、エラーとします。
     *       
     * - 帳票の生成
