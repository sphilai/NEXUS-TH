 ...
 * <pre>
 * bean id:L6016ReportService
 * </pre>
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7682 $
 */
public interface L6016ReportService {

    /**
     * Get the form output information to generate a form [Packing List Summary].
     * <br/>帳票出力情報を取得し、帳票【 Packing List Summary】を生成します。
     * <pre>
