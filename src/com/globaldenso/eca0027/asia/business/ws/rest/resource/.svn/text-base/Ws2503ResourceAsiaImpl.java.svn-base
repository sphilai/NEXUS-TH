...
import com.globaldenso.eca0027.asia.business.domain.criteria.Ws2503ItemNoCriteriaAsiaDomain;
 ...
 * <br />ws2503(Asia固有機能)のリソース実装クラスです。
 * 
 */
public class Ws2503ResourceAsiaImpl extends AbstractResourceImpl implements Ws2503ResourceAsia {
    ...
    /**
     * {@inheritDoc}
     * @see com.globaldenso.eca0027.core.ws.rest.resource.Ws2503Resource#createNonInstrPltz(String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String)
     */
...
//        xmlRootCriteriaDomain = XmlUtil.unmarshal(Ws2503XmlRootCriteriaDomain.class, ws2503Criteria);
        ...
        List<Ws2503ItemNoCriteriaAsiaDomain> itemNoCriteriaList = new ArrayList<Ws2503ItemNoCriteriaAsiaDomain>();
        for (int i = 0; i < itemNos.length; i++) {
            Ws2503ItemNoCriteriaAsiaDomain criteria = new Ws2503ItemNoCriteriaAsiaDomain();
