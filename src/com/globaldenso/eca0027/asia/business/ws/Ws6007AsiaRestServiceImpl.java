...
import com.globaldenso.eca0027.asia.business.domain.Ws6007AsiaParamDomain;
...
/**
 * The implementation class of Web Service (Ws6007)
 * 
 * @author $Author: A.Chonthicha $
 * @version $Revision: 7289 $
 */
public class Ws6007AsiaRestServiceImpl implements Ws6007AsiaRestService {
     ...
     * Default constructor. 
     */
    public Ws6007AsiaRestServiceImpl() {
    }
    ...
    /**
     * {@inheritDoc}
     * @see com.globaldenso.eca0027.core.business.ws.Ws6007AsiaRestService#submitReInvoiceJob(java.lang.String, java.lang.String)
     */
    public ResultDomain submitReInvoiceJob(String compCd, String invoiceNo) 
        throws ApplicationException {

        String webServicePath = "ws6007";
        WebServiceCallerRestDomain wsCallerRestDomain
            = commonService.searchCigmaWebServiceCallerRestDomain(compCd, webServicePath);

        Ws6007AsiaParamDomain ws6007AsiaParam = new Ws6007AsiaParamDomain();
        ws6007AsiaParam.setInvoiceNo(invoiceNo);
        ...
        ws6007AsiaParam.setLibPgm(result.getLibPgm());
        ws6007AsiaParam.setJobDesc(result.getJobDescription());
        ws6007AsiaParam.setJobHost(result.getJobHost());
        ws6007AsiaParam.setJobUser(result.getJobUser());
        ws6007AsiaParam.setJobPassword(result.getJobPassword());

        wsCallerRestDomain.setParamMap("param", XmlUtil.marshal(ws6007AsiaParam));
