...
public interface TmUserService {
     ...
     * データを登録します。
     * 
     * @param domains tmUserのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmUserのDomainクラスのList
     * @param criteria tmUserのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmUserDomain> domains, List<TmUserCriteriaDomain> criteria) throws ApplicationException;
