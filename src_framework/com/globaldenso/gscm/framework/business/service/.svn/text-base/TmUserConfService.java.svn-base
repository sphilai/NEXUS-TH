...
/**
 * TmUserConf のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmUserConfService {
     ...
     * データを登録します。
     * 
     * @param domains tmUserConfのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmUserConfのDomainクラスのList
     * @param criteria tmUserConfのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmUserConfDomain> domains, List<TmUserConfCriteriaDomain> criteria) throws ApplicationException;
