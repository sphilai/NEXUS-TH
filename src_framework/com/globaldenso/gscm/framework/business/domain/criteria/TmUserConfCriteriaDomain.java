 ...
 * PROJECT：GSCM 共通機能群
 * 
 * TmUserConf の検索条件Domainクラス
 * テーブル概要：User Config Master/ユーザ設定原単位  Table that contains the configuration of individual user basis./ユーザ個人単位の設定を格納するテーブル。
 * 
...
/**
 * TmUserConf の検索条件Domainクラスです。<BR>
 * テーブル概要：User Config Master/ユーザ設定原単位  Table that contains the configuration of individual user basis./ユーザ個人単位の設定を格納するテーブル。<BR>
 * 
 * <BR>
 ...
 */
public class TmUserConfCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * DSC-ID/DSC-ID  個々のユーザーを特定するID
     */
    private String dscId;

    /**
     * OWNER COMPANY/責任会社  ログイン時にデフォルトで使用される責任会社コード
     */
    private String compCd;

    /**
     * USER LANGUAGE CODE/ユーザ言語コード  ログイン時にデフォルトで使用される言語コード
     */
    private String userLngCd;

    /**
     * TIMEZONE ID/タイムゾーンID  ログイン時にデフォルトで使用されるタイムゾーン
     */
    private String timezoneId;

    /**
     * CHAR CODE/文字コード  CSVダウンロード時などに利用する文字コードの個人設定。メイン画面でユーザーが選択した文字コードを登録
     */
     ...
     * デフォルトコンストラクタ。
     */
    public TmUserConfCriteriaDomain() {
    }
