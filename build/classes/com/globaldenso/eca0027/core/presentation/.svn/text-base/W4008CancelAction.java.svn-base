...
/**
 * The Cancel action class of Staging Actuality Register screen
 * <br />山作り実績Register画面のCancelアクションクラスです。
 * <pre>
 * forward name-path mappings:
 *     - "success":/W4005Init.do
 *     - "error":W4008.jsp
 * </pre>
 *
 ...
 */
public class W4008CancelAction extends W4008AbstractAction {

    /**
     * Cancel facade service.
     */
    protected TransactFacadeService<Void, W4008UpdateDomain> w4008CancelFacadeService;

    /**
     * constructor.
     */
    public W4008CancelAction() {
        super();
    }

    /**
     * Setter method for w4008CancelFacadeService.
     *
     * @param cancelFacadeService Set for w4008CancelFacadeService
     */
    public void setW4008CancelFacadeService(
        TransactFacadeService<Void, W4008UpdateDomain> cancelFacadeService) {
        w4008CancelFacadeService = cancelFacadeService;
    }
     ...
     * - Call the W4008CancelFacadeService.transact an argument updateDomain
     *
     ...
     * - updateDomainを引数にW4008CancelFacadeService.transactの呼び出し
     * </pre>
     *
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm actForm,
        ...
        // facadeサービスの呼び出し
        w4008CancelFacadeService.transact(w4008UpdateDomain);
