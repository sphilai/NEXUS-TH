...
import com.globaldenso.eca0027.core.business.facadeservice.presentation.W2004PrintInstrFacadeServiceImpl;
...
/**
 *    This is a Print Instr action class of a Packaging Instruction (=Pull) Register screen.
 * <br />梱包指示Register画面のPrint Instrアクションクラスです。
 * <pre>
 ...
 */
public class W2004PrintInstrAction extends W2004AbstractAction {

    /**
     * PrintInstr Facade service
     * <br />PrintInstr Facadeサービス
     */
    protected UpdateFacadeService<File, W2004CriteriaDomain> w2004PrintInstrFacadeService;
    
    /**
     * constructor
     * <br />デフォルトコンストラクタです。
     */
    public W2004PrintInstrAction() {
        super();
    }

    /**
     * Setter method for w2004PrintInstrFacadeService.
     *
     * @param printInstrFacadeService Set for w2004PrintInstrFacadeService
     */
    public void setW2004PrintInstrFacadeService(
        UpdateFacadeService<File, W2004CriteriaDomain> printInstrFacadeService) {
        w2004PrintInstrFacadeService = printInstrFacadeService;
    }
     ...
     *       {@link W2004PrintInstrFacadeServiceImpl W2004PrintInstrFacadeServiceImpl#transact(W2004CriteriaDomain)} is called for {@link W2004CriteriaDomain} to an argument.
     *
     ...
     *       {@link W2004ActionForm#downloadInstr} is set as true.
     *
     ...
     *       
     * - PDF帳票の作成
     *     {@link W2004CriteriaDomain}を引数に{@link W2004PrintInstrFacadeServiceImpl W2004PrintInstrFacadeServiceImpl#transact(W2004CriteriaDomain)}を呼出す
     *     
     * - PDF帳票の保存
     ...
     *     
     * - ダウンロードフラグの設定
     *     {@link W2004ActionForm#downloadInstr}をtrueに設定する
     *     
     * [ダウンロードフラグ = trueの場合]
     * - PDF帳票の取得
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form,
        ...
        if (!w2004Form.isDownloadInstr()) {
            ...
            // create of PDF list
            // PDF帳票の作成
            File report = w2004PrintInstrFacadeService.update(criteriaDomain);
            ...
            // Setting of a download flag
            // ダウンロードフラグの設定
            w2004Form.setDownloadInstr(true);
            ...
            // Download of PDF list
            // PDF帳票のダウンロード
            String fileName = w2004Form.getPltzInstrNo() + EXT_PDF;
