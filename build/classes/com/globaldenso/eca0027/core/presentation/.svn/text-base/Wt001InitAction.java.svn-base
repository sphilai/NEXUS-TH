...
/**
 * The initial action class of Company Search Sub Screen. <br />
 * 会社選択子画面の初期表示アクションクラスです。
 * 
 * <pre>
 ...
 */
public class Wt001InitAction extends Wt001AbstractAction {

    /**
     * Default constructor.
     */
    public Wt001InitAction() {
        super();
    }
