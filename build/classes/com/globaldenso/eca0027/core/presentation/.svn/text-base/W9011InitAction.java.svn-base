...
/**
 * The initial action class of CIGMA Customer No. X-Reference MA Inquiry Screen.
 * <br />CIGMA Customer No. X-Reference MA Inquiry画面の初期表示アクションです。
 * <pre>
 ...
 */
public class W9011InitAction extends W9011AbstractAction {

    /**
     * Default constructor./デフォルトコンストラクタ。
     */
    public W9011InitAction() {
        super();
    }
     ...
     *     ({@link W9011AbstractAction#controlDisplay(W9011ActionForm, HttpServletRequest)})
    ...
    protected String invokeExecute(ActionMapping mapping, ActionForm form,
        ...
        // Display control.
        controlDisplay((W9011ActionForm) form, request);
