 ...
 * of CIGMA W/H X-Reference MA Inquiry Screen.
 * <br />CIGMA W/H X-Reference MA Inquiry画面の修正・参照facadeサービス実装クラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class W9014EditOrReferFacadeServiceImpl 
    extends AbstractProcessFacadeService<W9014UpdateDomain, W9014UpdateDomain>{

    /**
     * Default constructor./デフォルトコンストラクタ。
     */
    public W9014EditOrReferFacadeServiceImpl() {
    }
     ...
     */
    @Override
    protected  W9014UpdateDomain callServices(W9014UpdateDomain criteriaDomain)
