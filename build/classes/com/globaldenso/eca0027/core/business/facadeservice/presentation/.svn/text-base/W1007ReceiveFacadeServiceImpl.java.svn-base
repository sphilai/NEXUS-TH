...
/**
 * The Receive service facade implementation class of Export Request Header screen
 * <br />荷揃え指示Register画面の登録facadeサービス実装クラスです。
 * <pre>
 * bean id:w1007ReceiveFacadeService
 * </pre>
 *
 * @author $Author: DCS
 * @version $Revision: 5446 $
 */
public class W1007ReceiveFacadeServiceImpl extends
     ...
     * Constructor.
     */
    public W1007ReceiveFacadeServiceImpl() {
    }
            ...
            for (W1007ExpRequestDtlDomain domain : w1007ExpRequestDtlDomain) {
                ...
                if(map.get(index) != null){//if (CHECK_ON.equals(domain.getSelected())) {
                    if(domain.getLineNo() == null) //KIT
                    {
                        ...
                        // Set data to HashMap for update exp request Status
