...
/**
 * 
 * A service for Facade CoView action of Shipping Document Upload screen.
 * <br />船積書類アップロード画面のCoViewアクションに対するFacadeサービスです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 11616 $
 */
public class W7006CoViewFacadeServiceImpl extends AbstractProcessFacadeService<OutputStream, W7006CriteriaDomain> {
     ...
     * デフォルトコンストラクタです。
     */
    public W7006CoViewFacadeServiceImpl() {
        super();
    }
     ...
     *     Call {@link W7001ShippingActService#validateDatabaseTtShippingActOnOtherDocUploadIndividualCoView}
     * </pre>
     * <pre>
     * ‐ファイル管理 取得チェック
     *     {@link W7001ShippingActService#validateDatabaseTtShippingActOnOtherDocUploadIndividualCoView}を呼出す
     * </pre>
    ...
    protected void validateDatabase(W7006CriteriaDomain criteriaDomain)
        ...
        // ファイル管理 ロック＆取得件数チェック
        if (!w7001ShippingActService.validateDatabaseTtShippingActOnOtherDocUploadIndividualCoView(shipperCd
