 ...
 */
public class W9008UpdateDomain extends AbstractDomain {
     ...
     * 画面の検索条件ドメイン
     */
    private W9008CriteriaDomain criteriaDomain;
     ...
     */
    public W9008CriteriaDomain getCriteriaDomain() {
     ...
     */
    public void setCriteriaDomain(W9008CriteriaDomain criteriaDomain) {
