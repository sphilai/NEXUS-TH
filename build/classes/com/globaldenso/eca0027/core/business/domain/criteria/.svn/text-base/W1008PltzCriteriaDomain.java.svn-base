 ...
 * PROJECT：eca0027
 * 
 * W1008Pltz の検索条件Domainクラス
 * テーブル概要：Palletize/?????  Table to hold the information of the pallet packing unit/????????????????????
 * 
...
/**
 * W1008Pltz の検索条件Domainクラスです。<BR>
 * テーブル概要：Palletize/?????  Table to hold the information of the pallet packing unit/????????????????????<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public class W1008PltzCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * TRANSPORT CODE ORIGINAL/????????????  ???????
     */
    private String trnsCdOrg;

    /**
     * REVISE FLAG/??????????  Y:Revised, N:Not
     */
    ...
    /**
     * LEGACY WAREHOUSE CODE/LEGACY?????
     */
    private String lgcyWhCd;

    /**
     * CUR LEGACY WAREHOUSE CODE/??LEGACY?????
     */
    private String curLgcyWhCd;

    /**
     * PACKAGE FORM TYPE/??????  M:Multi, S:Single
     */
    ...
    /**
     * CONTAINER LOOSE TYPE/?????????  L:Loose, C:Full Container
     */
    ...
    /**
     * CML TYPE/????????  1:CIGMA, 2:E-RT, 3:Miscellaneous
     */
    ...
    /**
     * STAGING INSTRUCTION ITEM FLAG/????????  Y:Staging Instruction Item, N:Not
     */
...
B:BACK
    ...
    /**
     * SITE TYPE/????  A:1/4(Front), B:Front2/4, C:Rear3/4, D:Rear4/4(Rear)
     */
    private String siteTyp;

    /**
     * EXPORT LIMIT FLAG/???????  Y:Includes Regulating Item, N:Not
     */
    ...
    /**
     * STAGING INSTRUCTION NO/?????NO
     */
    private String stgInstrNo;

    /**
     * STAGING ACTUALITY NO/?????NO
     */
    private String stgActNo;

    /**
     * SHIPPING CONFIRM NO/????NO
     */
...
(10 Palletizing immediately)
    ...
    /**
     * EXPORT REQUEST ALL CML ISSUED FLAG/?????CML???????  Y:Issued All, N:Not
     */
...
X:T/T Remittance
    ...
    /**
     * FREIGHT RESPONSIBLE CODE/????????  P:Prepaid, C:Collect
     */
    private String freightResponsibleCd;

    /**
     * MIGRATION FLAG/?????  Y:Migration Data, N:Not
     */
    ...
    /**
     * OLD QR CONTAINER GROUP CODE/?QR??????????????
     */
    ...
    /**
     * TRANSPORT CODE ORIGINAL/????????????  ???????（大なり）
     */
    private String trnsCdOrgGreaterThan;

    /**
     * TRANSPORT CODE ORIGINAL/????????????  ???????（大なりイコール）
     */
    private String trnsCdOrgGreaterThanEqual;

    /**
     * TRANSPORT CODE ORIGINAL/????????????  ???????（小なり）
     */
    private String trnsCdOrgLessThan;

    /**
     * TRANSPORT CODE ORIGINAL/????????????  ???????（小なりイコール）
     */
    private String trnsCdOrgLessThanEqual;

    /**
     * TRANSPORT CODE ORIGINAL/????????????  ???????（前方一致）
     */
    private String trnsCdOrgLikeFront;

    /**
     * REVISE FLAG/??????????  Y:Revised, N:Not（大なり）
     */
    private String reviseFlgGreaterThan;

    /**
     * REVISE FLAG/??????????  Y:Revised, N:Not（大なりイコール）
     */
    private String reviseFlgGreaterThanEqual;

    /**
     * REVISE FLAG/??????????  Y:Revised, N:Not（小なり）
     */
    private String reviseFlgLessThan;

    /**
     * REVISE FLAG/??????????  Y:Revised, N:Not（小なりイコール）
     */
    private String reviseFlgLessThanEqual;

    /**
     * REVISE FLAG/??????????  Y:Revised, N:Not（前方一致）
     */
    private String reviseFlgLikeFront;
    ...
    /**
     * LEGACY WAREHOUSE CODE/LEGACY?????（大なり）
     */
    private String lgcyWhCdGreaterThan;

    /**
     * LEGACY WAREHOUSE CODE/LEGACY?????（大なりイコール）
     */
    private String lgcyWhCdGreaterThanEqual;

    /**
     * LEGACY WAREHOUSE CODE/LEGACY?????（小なり）
     */
    private String lgcyWhCdLessThan;

    /**
     * LEGACY WAREHOUSE CODE/LEGACY?????（小なりイコール）
     */
    private String lgcyWhCdLessThanEqual;

    /**
     * LEGACY WAREHOUSE CODE/LEGACY?????（前方一致）
     */
    private String lgcyWhCdLikeFront;

    /**
     * CUR LEGACY WAREHOUSE CODE/??LEGACY?????（大なり）
     */
    private String curLgcyWhCdGreaterThan;

    /**
     * CUR LEGACY WAREHOUSE CODE/??LEGACY?????（大なりイコール）
     */
    private String curLgcyWhCdGreaterThanEqual;

    /**
     * CUR LEGACY WAREHOUSE CODE/??LEGACY?????（小なり）
     */
    private String curLgcyWhCdLessThan;

    /**
     * CUR LEGACY WAREHOUSE CODE/??LEGACY?????（小なりイコール）
     */
    private String curLgcyWhCdLessThanEqual;

    /**
     * CUR LEGACY WAREHOUSE CODE/??LEGACY?????（前方一致）
     */
    private String curLgcyWhCdLikeFront;

    /**
     * PACKAGE FORM TYPE/??????  M:Multi, S:Single（大なり）
     */
    private String pkgFormTypGreaterThan;

    /**
     * PACKAGE FORM TYPE/??????  M:Multi, S:Single（大なりイコール）
     */
    private String pkgFormTypGreaterThanEqual;

    /**
     * PACKAGE FORM TYPE/??????  M:Multi, S:Single（小なり）
     */
    private String pkgFormTypLessThan;

    /**
     * PACKAGE FORM TYPE/??????  M:Multi, S:Single（小なりイコール）
     */
    private String pkgFormTypLessThanEqual;

    /**
     * PACKAGE FORM TYPE/??????  M:Multi, S:Single（前方一致）
     */
    ...
    /**
     * CONTAINER LOOSE TYPE/?????????  L:Loose, C:Full Container（大なり）
     */
    private String containerLooseTypGreaterThan;

    /**
     * CONTAINER LOOSE TYPE/?????????  L:Loose, C:Full Container（大なりイコール）
     */
    private String containerLooseTypGreaterThanEqual;

    /**
     * CONTAINER LOOSE TYPE/?????????  L:Loose, C:Full Container（小なり）
     */
    private String containerLooseTypLessThan;

    /**
     * CONTAINER LOOSE TYPE/?????????  L:Loose, C:Full Container（小なりイコール）
     */
    private String containerLooseTypLessThanEqual;

    /**
     * CONTAINER LOOSE TYPE/?????????  L:Loose, C:Full Container（前方一致）
     */
    private String containerLooseTypLikeFront;

    /**
     * RETURN STYLE CODE/???????（大なり）
     */
    private String returnStyleCdGreaterThan;

    /**
     * RETURN STYLE CODE/???????（大なりイコール）
     */
    private String returnStyleCdGreaterThanEqual;

    /**
     * RETURN STYLE CODE/???????（小なり）
     */
    private String returnStyleCdLessThan;

    /**
     * RETURN STYLE CODE/???????（小なりイコール）
     */
    private String returnStyleCdLessThanEqual;

    /**
     * RETURN STYLE CODE/???????（前方一致）
     */
    private String returnStyleCdLikeFront;

    /**
     * VARIANT FLAG/?????  Y:Vriant, N:Not（大なり）
     */
    private String variantFlgGreaterThan;

    /**
     * VARIANT FLAG/?????  Y:Vriant, N:Not（大なりイコール）
     */
    private String variantFlgGreaterThanEqual;

    /**
     * VARIANT FLAG/?????  Y:Vriant, N:Not（小なり）
     */
    private String variantFlgLessThan;

    /**
     * VARIANT FLAG/?????  Y:Vriant, N:Not（小なりイコール）
     */
    private String variantFlgLessThanEqual;

    /**
     * VARIANT FLAG/?????  Y:Vriant, N:Not（前方一致）
     */
    private String variantFlgLikeFront;
    ...
    /**
     * SUPPLIER MAIN MARK/?????????（大なり）
     */
    private String supplierMainMarkGreaterThan;

    /**
     * SUPPLIER MAIN MARK/?????????（大なりイコール）
     */
    private String supplierMainMarkGreaterThanEqual;

    /**
     * SUPPLIER MAIN MARK/?????????（小なり）
     */
    private String supplierMainMarkLessThan;

    /**
     * SUPPLIER MAIN MARK/?????????（小なりイコール）
     */
    private String supplierMainMarkLessThanEqual;

    /**
     * SUPPLIER MAIN MARK/?????????（前方一致）
     */
    private String supplierMainMarkLikeFront;

    /**
     * CML TYPE/????????  1:CIGMA, 2:E-RT, 3:Miscellaneous（大なり）
     */
    private String cmlTypGreaterThan;

    /**
     * CML TYPE/????????  1:CIGMA, 2:E-RT, 3:Miscellaneous（大なりイコール）
     */
    private String cmlTypGreaterThanEqual;

    /**
     * CML TYPE/????????  1:CIGMA, 2:E-RT, 3:Miscellaneous（小なり）
     */
    private String cmlTypLessThan;

    /**
     * CML TYPE/????????  1:CIGMA, 2:E-RT, 3:Miscellaneous（小なりイコール）
     */
    private String cmlTypLessThanEqual;

    /**
     * CML TYPE/????????  1:CIGMA, 2:E-RT, 3:Miscellaneous（前方一致）
     */
    private String cmlTypLikeFront;

    /**
     * OUTER PACKAGE CODE/?????（大なり）
     */
    private String outerPkgCdGreaterThan;

    /**
     * OUTER PACKAGE CODE/?????（大なりイコール）
     */
    private String outerPkgCdGreaterThanEqual;

    /**
     * OUTER PACKAGE CODE/?????（小なり）
     */
    private String outerPkgCdLessThan;

    /**
     * OUTER PACKAGE CODE/?????（小なりイコール）
     */
    private String outerPkgCdLessThanEqual;

    /**
     * OUTER PACKAGE CODE/?????（前方一致）
     */
    private String outerPkgCdLikeFront;

    /**
     * EXPORT PACKING DATE/?????（大なりイコール）
     */
    private Date expPackingDtGreaterThanEqual;

    /**
     * EXPORT PACKING DATE/?????（小なりイコール）
     */
    private Date expPackingDtLessThanEqual;

    /**
     * EXPORT PACKING ISSUER ID/?????ID（大なり）
     */
    private String expPackingIssuerIdGreaterThan;

    /**
     * EXPORT PACKING ISSUER ID/?????ID（大なりイコール）
     */
    private String expPackingIssuerIdGreaterThanEqual;

    /**
     * EXPORT PACKING ISSUER ID/?????ID（小なり）
     */
    private String expPackingIssuerIdLessThan;

    /**
     * EXPORT PACKING ISSUER ID/?????ID（小なりイコール）
     */
    private String expPackingIssuerIdLessThanEqual;

    /**
     * EXPORT PACKING ISSUER ID/?????ID（前方一致）
     */
    private String expPackingIssuerIdLikeFront;

    /**
     * EXPORT PACKING ISSUER NAME/??????（大なり）
     */
    private String expPackingIssuerNmGreaterThan;

    /**
     * EXPORT PACKING ISSUER NAME/??????（大なりイコール）
     */
    private String expPackingIssuerNmGreaterThanEqual;

    /**
     * EXPORT PACKING ISSUER NAME/??????（小なり）
     */
    private String expPackingIssuerNmLessThan;

    /**
     * EXPORT PACKING ISSUER NAME/??????（小なりイコール）
     */
    private String expPackingIssuerNmLessThanEqual;

    /**
     * EXPORT PACKING ISSUER NAME/??????（前方一致）
     */
    ...
    /**
     * STAGING INSTRUCTION ITEM FLAG/????????  Y:Staging Instruction Item, N:Not（大なり）
     */
    private String stgInstrItemFlgGreaterThan;

    /**
     * STAGING INSTRUCTION ITEM FLAG/????????  Y:Staging Instruction Item, N:Not（大なりイコール）
     */
    private String stgInstrItemFlgGreaterThanEqual;

    /**
     * STAGING INSTRUCTION ITEM FLAG/????????  Y:Staging Instruction Item, N:Not（小なり）
     */
    private String stgInstrItemFlgLessThan;

    /**
     * STAGING INSTRUCTION ITEM FLAG/????????  Y:Staging Instruction Item, N:Not（小なりイコール）
     */
    private String stgInstrItemFlgLessThanEqual;

    /**
     * STAGING INSTRUCTION ITEM FLAG/????????  Y:Staging Instruction Item, N:Not（前方一致）
     */
...
70:Shipping Comfirmation,
80:Shipping Comfirmation Actual,
90:Customs clearance(Type A)（大なり）
     */
    private String pltzStatusGreaterThan;
...
70:Shipping Comfirmation,
80:Shipping Comfirmation Actual,
90:Customs clearance(Type A)（大なりイコール）
     */
    private String pltzStatusGreaterThanEqual;
...
70:Shipping Comfirmation,
80:Shipping Comfirmation Actual,
90:Customs clearance(Type A)（小なり）
     */
    private String pltzStatusLessThan;
...
70:Shipping Comfirmation,
80:Shipping Comfirmation Actual,
90:Customs clearance(Type A)（小なりイコール）
     */
    private String pltzStatusLessThanEqual;
...
70:Shipping Comfirmation,
80:Shipping Comfirmation Actual,
90:Customs clearance(Type A)（前方一致）
     */
    private String pltzStatusLikeFront;

    /**
     * PACKING WAREHOUSE COMPANY CODE/?????????（大なり）
     */
    private String packingWhCompCdGreaterThan;

    /**
     * PACKING WAREHOUSE COMPANY CODE/?????????（大なりイコール）
     */
    private String packingWhCompCdGreaterThanEqual;

    /**
     * PACKING WAREHOUSE COMPANY CODE/?????????（小なり）
     */
    private String packingWhCompCdLessThan;

    /**
     * PACKING WAREHOUSE COMPANY CODE/?????????（小なりイコール）
     */
    private String packingWhCompCdLessThanEqual;

    /**
     * PACKING WAREHOUSE COMPANY CODE/?????????（前方一致）
     */
    private String packingWhCompCdLikeFront;
    ...
    /**
     * INVOICE ISSUE DATE/????????（大なりイコール）
     */
    private Date invoiceIssueDtGreaterThanEqual;

    /**
     * INVOICE ISSUE DATE/????????（小なりイコール）
     */
...
B:BACK（前方一致）
    ...
    /**
     * SITE TYPE/????  A:1/4(Front), B:Front2/4, C:Rear3/4, D:Rear4/4(Rear)（大なり）
     */
    private String siteTypGreaterThan;

    /**
     * SITE TYPE/????  A:1/4(Front), B:Front2/4, C:Rear3/4, D:Rear4/4(Rear)（大なりイコール）
     */
    private String siteTypGreaterThanEqual;

    /**
     * SITE TYPE/????  A:1/4(Front), B:Front2/4, C:Rear3/4, D:Rear4/4(Rear)（小なり）
     */
    private String siteTypLessThan;

    /**
     * SITE TYPE/????  A:1/4(Front), B:Front2/4, C:Rear3/4, D:Rear4/4(Rear)（小なりイコール）
     */
    private String siteTypLessThanEqual;

    /**
     * SITE TYPE/????  A:1/4(Front), B:Front2/4, C:Rear3/4, D:Rear4/4(Rear)（前方一致）
     */
    private String siteTypLikeFront;

    /**
     * EXPORT LIMIT FLAG/???????  Y:Includes Regulating Item, N:Not（大なり）
     */
    private String expLimitFlgGreaterThan;

    /**
     * EXPORT LIMIT FLAG/???????  Y:Includes Regulating Item, N:Not（大なりイコール）
     */
    private String expLimitFlgGreaterThanEqual;

    /**
     * EXPORT LIMIT FLAG/???????  Y:Includes Regulating Item, N:Not（小なり）
     */
    private String expLimitFlgLessThan;

    /**
     * EXPORT LIMIT FLAG/???????  Y:Includes Regulating Item, N:Not（小なりイコール）
     */
    private String expLimitFlgLessThanEqual;

    /**
     * EXPORT LIMIT FLAG/???????  Y:Includes Regulating Item, N:Not（前方一致）
     */
    private String expLimitFlgLikeFront;
...
30:Activate TR,
40:Received at To
(10 Palletizing immediately)（大なり）
     */
    private String lastTrStatusGreaterThan;
...
30:Activate TR,
40:Received at To
(10 Palletizing immediately)（大なりイコール）
     */
    private String lastTrStatusGreaterThanEqual;
...
30:Activate TR,
40:Received at To
(10 Palletizing immediately)（小なり）
     */
    private String lastTrStatusLessThan;
...
30:Activate TR,
40:Received at To
(10 Palletizing immediately)（小なりイコール）
     */
    private String lastTrStatusLessThanEqual;
...
30:Activate TR,
40:Received at To
(10 Palletizing immediately)（前方一致）
     */
    private String lastTrStatusLikeFront;

    /**
     * LAST TR RECEIVE DATE/????????（大なりイコール）
     */
    private Date lastTrRcvDtGreaterThanEqual;

    /**
     * LAST TR RECEIVE DATE/????????（小なりイコール）
     */
    private Date lastTrRcvDtLessThanEqual;
    ...
    /**
     * EXPORT REQUEST ALL CML ISSUED FLAG/?????CML???????  Y:Issued All, N:Not（大なり）
     */
    private String expRequestAllCmlIssuedFlgGreaterThan;

    /**
     * EXPORT REQUEST ALL CML ISSUED FLAG/?????CML???????  Y:Issued All, N:Not（大なりイコール）
     */
    private String expRequestAllCmlIssuedFlgGreaterThanEqual;

    /**
     * EXPORT REQUEST ALL CML ISSUED FLAG/?????CML???????  Y:Issued All, N:Not（小なり）
     */
    private String expRequestAllCmlIssuedFlgLessThan;

    /**
     * EXPORT REQUEST ALL CML ISSUED FLAG/?????CML???????  Y:Issued All, N:Not（小なりイコール）
     */
    private String expRequestAllCmlIssuedFlgLessThanEqual;

    /**
     * EXPORT REQUEST ALL CML ISSUED FLAG/?????CML???????  Y:Issued All, N:Not（前方一致）
     */
    private String expRequestAllCmlIssuedFlgLikeFront;
    ...
    /**
     * SHIP TO TEL/???TEL（小なりイコール）
     */
    private String shipToTelLessThanEqual;

    /**
     * SHIP TO TEL/???TEL（前方一致）
     */
...
X:T/T Remittance（前方一致）
     ...
     * デフォルトコンストラクタ。
     */
    public W1008PltzCriteriaDomain() {
    }
    ...
    /**
     * reviseFlgGreaterThan のゲッターメソッドです。
     * 
     * @return the reviseFlgGreaterThan
     */
    public String getReviseFlgGreaterThan() {
        return reviseFlgGreaterThan;
    }

    /**
     * reviseFlgGreaterThan のセッターメソッドです。
     * 
     * @param reviseFlgGreaterThan reviseFlgGreaterThan に設定する
     */
    public void setReviseFlgGreaterThan(String reviseFlgGreaterThan) {
        this.reviseFlgGreaterThan = reviseFlgGreaterThan;
    }

    /**
     * reviseFlgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the reviseFlgGreaterThanEqual
     */
    public String getReviseFlgGreaterThanEqual() {
        return reviseFlgGreaterThanEqual;
    }

    /**
     * reviseFlgGreaterThanEqual のセッターメソッドです。
     * 
     * @param reviseFlgGreaterThanEqual reviseFlgGreaterThanEqual に設定する
     */
    public void setReviseFlgGreaterThanEqual(String reviseFlgGreaterThanEqual) {
        this.reviseFlgGreaterThanEqual = reviseFlgGreaterThanEqual;
    }

    /**
     * reviseFlgLessThan のゲッターメソッドです。
     * 
     * @return the reviseFlgLessThan
     */
    public String getReviseFlgLessThan() {
        return reviseFlgLessThan;
    }

    /**
     * reviseFlgLessThan のセッターメソッドです。
     * 
     * @param reviseFlgLessThan reviseFlgLessThan に設定する
     */
    public void setReviseFlgLessThan(String reviseFlgLessThan) {
        this.reviseFlgLessThan = reviseFlgLessThan;
    }

    /**
     * reviseFlgLessThanEqual のゲッターメソッドです。
     * 
     * @return the reviseFlgLessThanEqual
     */
    public String getReviseFlgLessThanEqual() {
        return reviseFlgLessThanEqual;
    }

    /**
     * reviseFlgLessThanEqual のセッターメソッドです。
     * 
     * @param reviseFlgLessThanEqual reviseFlgLessThanEqual に設定する
     */
    public void setReviseFlgLessThanEqual(String reviseFlgLessThanEqual) {
        this.reviseFlgLessThanEqual = reviseFlgLessThanEqual;
    }

    /**
     * reviseFlgLikeFront のゲッターメソッドです。
     * 
     * @return the reviseFlgLikeFront
     */
    public String getReviseFlgLikeFront() {
        return reviseFlgLikeFront;
    }

    /**
     * reviseFlgLikeFront のセッターメソッドです。
     * 
     * @param reviseFlgLikeFront reviseFlgLikeFront に設定する
     */
    public void setReviseFlgLikeFront(String reviseFlgLikeFront) {
        this.reviseFlgLikeFront = reviseFlgLikeFront;
    }
    ...
    /**
     * curLgcyWhCdGreaterThan のゲッターメソッドです。
     * 
     * @return the curLgcyWhCdGreaterThan
     */
    public String getCurLgcyWhCdGreaterThan() {
        return curLgcyWhCdGreaterThan;
    }

    /**
     * curLgcyWhCdGreaterThan のセッターメソッドです。
     * 
     * @param curLgcyWhCdGreaterThan curLgcyWhCdGreaterThan に設定する
     */
    public void setCurLgcyWhCdGreaterThan(String curLgcyWhCdGreaterThan) {
        this.curLgcyWhCdGreaterThan = curLgcyWhCdGreaterThan;
    }

    /**
     * curLgcyWhCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the curLgcyWhCdGreaterThanEqual
     */
    public String getCurLgcyWhCdGreaterThanEqual() {
        return curLgcyWhCdGreaterThanEqual;
    }

    /**
     * curLgcyWhCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param curLgcyWhCdGreaterThanEqual curLgcyWhCdGreaterThanEqual に設定する
     */
    public void setCurLgcyWhCdGreaterThanEqual(String curLgcyWhCdGreaterThanEqual) {
        this.curLgcyWhCdGreaterThanEqual = curLgcyWhCdGreaterThanEqual;
    }

    /**
     * curLgcyWhCdLessThan のゲッターメソッドです。
     * 
     * @return the curLgcyWhCdLessThan
     */
    public String getCurLgcyWhCdLessThan() {
        return curLgcyWhCdLessThan;
    }

    /**
     * curLgcyWhCdLessThan のセッターメソッドです。
     * 
     * @param curLgcyWhCdLessThan curLgcyWhCdLessThan に設定する
     */
    public void setCurLgcyWhCdLessThan(String curLgcyWhCdLessThan) {
        this.curLgcyWhCdLessThan = curLgcyWhCdLessThan;
    }

    /**
     * curLgcyWhCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the curLgcyWhCdLessThanEqual
     */
    public String getCurLgcyWhCdLessThanEqual() {
        return curLgcyWhCdLessThanEqual;
    }

    /**
     * curLgcyWhCdLessThanEqual のセッターメソッドです。
     * 
     * @param curLgcyWhCdLessThanEqual curLgcyWhCdLessThanEqual に設定する
     */
    public void setCurLgcyWhCdLessThanEqual(String curLgcyWhCdLessThanEqual) {
        this.curLgcyWhCdLessThanEqual = curLgcyWhCdLessThanEqual;
    }

    /**
     * curLgcyWhCdLikeFront のゲッターメソッドです。
     * 
     * @return the curLgcyWhCdLikeFront
     */
    public String getCurLgcyWhCdLikeFront() {
        return curLgcyWhCdLikeFront;
    }

    /**
     * curLgcyWhCdLikeFront のセッターメソッドです。
     * 
     * @param curLgcyWhCdLikeFront curLgcyWhCdLikeFront に設定する
     */
    public void setCurLgcyWhCdLikeFront(String curLgcyWhCdLikeFront) {
        this.curLgcyWhCdLikeFront = curLgcyWhCdLikeFront;
    }
    ...
    /**
     * returnStyleCdGreaterThan のゲッターメソッドです。
     * 
     * @return the returnStyleCdGreaterThan
     */
    public String getReturnStyleCdGreaterThan() {
        return returnStyleCdGreaterThan;
    }

    /**
     * returnStyleCdGreaterThan のセッターメソッドです。
     * 
     * @param returnStyleCdGreaterThan returnStyleCdGreaterThan に設定する
     */
    public void setReturnStyleCdGreaterThan(String returnStyleCdGreaterThan) {
        this.returnStyleCdGreaterThan = returnStyleCdGreaterThan;
    }

    /**
     * returnStyleCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the returnStyleCdGreaterThanEqual
     */
    public String getReturnStyleCdGreaterThanEqual() {
        return returnStyleCdGreaterThanEqual;
    }

    /**
     * returnStyleCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param returnStyleCdGreaterThanEqual returnStyleCdGreaterThanEqual に設定する
     */
    public void setReturnStyleCdGreaterThanEqual(String returnStyleCdGreaterThanEqual) {
        this.returnStyleCdGreaterThanEqual = returnStyleCdGreaterThanEqual;
    }

    /**
     * returnStyleCdLessThan のゲッターメソッドです。
     * 
     * @return the returnStyleCdLessThan
     */
    public String getReturnStyleCdLessThan() {
        return returnStyleCdLessThan;
    }

    /**
     * returnStyleCdLessThan のセッターメソッドです。
     * 
     * @param returnStyleCdLessThan returnStyleCdLessThan に設定する
     */
    public void setReturnStyleCdLessThan(String returnStyleCdLessThan) {
        this.returnStyleCdLessThan = returnStyleCdLessThan;
    }

    /**
     * returnStyleCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the returnStyleCdLessThanEqual
     */
    public String getReturnStyleCdLessThanEqual() {
        return returnStyleCdLessThanEqual;
    }

    /**
     * returnStyleCdLessThanEqual のセッターメソッドです。
     * 
     * @param returnStyleCdLessThanEqual returnStyleCdLessThanEqual に設定する
     */
    public void setReturnStyleCdLessThanEqual(String returnStyleCdLessThanEqual) {
        this.returnStyleCdLessThanEqual = returnStyleCdLessThanEqual;
    }

    /**
     * returnStyleCdLikeFront のゲッターメソッドです。
     * 
     * @return the returnStyleCdLikeFront
     */
    public String getReturnStyleCdLikeFront() {
        return returnStyleCdLikeFront;
    }

    /**
     * returnStyleCdLikeFront のセッターメソッドです。
     * 
     * @param returnStyleCdLikeFront returnStyleCdLikeFront に設定する
     */
    public void setReturnStyleCdLikeFront(String returnStyleCdLikeFront) {
        this.returnStyleCdLikeFront = returnStyleCdLikeFront;
    }

    /**
     * variantFlgGreaterThan のゲッターメソッドです。
     * 
     * @return the variantFlgGreaterThan
     */
    public String getVariantFlgGreaterThan() {
        return variantFlgGreaterThan;
    }

    /**
     * variantFlgGreaterThan のセッターメソッドです。
     * 
     * @param variantFlgGreaterThan variantFlgGreaterThan に設定する
     */
    public void setVariantFlgGreaterThan(String variantFlgGreaterThan) {
        this.variantFlgGreaterThan = variantFlgGreaterThan;
    }

    /**
     * variantFlgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the variantFlgGreaterThanEqual
     */
    public String getVariantFlgGreaterThanEqual() {
        return variantFlgGreaterThanEqual;
    }

    /**
     * variantFlgGreaterThanEqual のセッターメソッドです。
     * 
     * @param variantFlgGreaterThanEqual variantFlgGreaterThanEqual に設定する
     */
    public void setVariantFlgGreaterThanEqual(String variantFlgGreaterThanEqual) {
        this.variantFlgGreaterThanEqual = variantFlgGreaterThanEqual;
    }

    /**
     * variantFlgLessThan のゲッターメソッドです。
     * 
     * @return the variantFlgLessThan
     */
    public String getVariantFlgLessThan() {
        return variantFlgLessThan;
    }

    /**
     * variantFlgLessThan のセッターメソッドです。
     * 
     * @param variantFlgLessThan variantFlgLessThan に設定する
     */
    public void setVariantFlgLessThan(String variantFlgLessThan) {
        this.variantFlgLessThan = variantFlgLessThan;
    }

    /**
     * variantFlgLessThanEqual のゲッターメソッドです。
     * 
     * @return the variantFlgLessThanEqual
     */
    public String getVariantFlgLessThanEqual() {
        return variantFlgLessThanEqual;
    }

    /**
     * variantFlgLessThanEqual のセッターメソッドです。
     * 
     * @param variantFlgLessThanEqual variantFlgLessThanEqual に設定する
     */
    public void setVariantFlgLessThanEqual(String variantFlgLessThanEqual) {
        this.variantFlgLessThanEqual = variantFlgLessThanEqual;
    }

    /**
     * variantFlgLikeFront のゲッターメソッドです。
     * 
     * @return the variantFlgLikeFront
     */
    public String getVariantFlgLikeFront() {
        return variantFlgLikeFront;
    }

    /**
     * variantFlgLikeFront のセッターメソッドです。
     * 
     * @param variantFlgLikeFront variantFlgLikeFront に設定する
     */
    public void setVariantFlgLikeFront(String variantFlgLikeFront) {
        this.variantFlgLikeFront = variantFlgLikeFront;
    }
    ...
    /**
     * supplierMainMarkGreaterThan のゲッターメソッドです。
     * 
     * @return the supplierMainMarkGreaterThan
     */
    public String getSupplierMainMarkGreaterThan() {
        return supplierMainMarkGreaterThan;
    }

    /**
     * supplierMainMarkGreaterThan のセッターメソッドです。
     * 
     * @param supplierMainMarkGreaterThan supplierMainMarkGreaterThan に設定する
     */
    public void setSupplierMainMarkGreaterThan(String supplierMainMarkGreaterThan) {
        this.supplierMainMarkGreaterThan = supplierMainMarkGreaterThan;
    }

    /**
     * supplierMainMarkGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the supplierMainMarkGreaterThanEqual
     */
    public String getSupplierMainMarkGreaterThanEqual() {
        return supplierMainMarkGreaterThanEqual;
    }

    /**
     * supplierMainMarkGreaterThanEqual のセッターメソッドです。
     * 
     * @param supplierMainMarkGreaterThanEqual supplierMainMarkGreaterThanEqual に設定する
     */
    public void setSupplierMainMarkGreaterThanEqual(String supplierMainMarkGreaterThanEqual) {
        this.supplierMainMarkGreaterThanEqual = supplierMainMarkGreaterThanEqual;
    }

    /**
     * supplierMainMarkLessThan のゲッターメソッドです。
     * 
     * @return the supplierMainMarkLessThan
     */
    public String getSupplierMainMarkLessThan() {
        return supplierMainMarkLessThan;
    }

    /**
     * supplierMainMarkLessThan のセッターメソッドです。
     * 
     * @param supplierMainMarkLessThan supplierMainMarkLessThan に設定する
     */
    public void setSupplierMainMarkLessThan(String supplierMainMarkLessThan) {
        this.supplierMainMarkLessThan = supplierMainMarkLessThan;
    }

    /**
     * supplierMainMarkLessThanEqual のゲッターメソッドです。
     * 
     * @return the supplierMainMarkLessThanEqual
     */
    public String getSupplierMainMarkLessThanEqual() {
        return supplierMainMarkLessThanEqual;
    }

    /**
     * supplierMainMarkLessThanEqual のセッターメソッドです。
     * 
     * @param supplierMainMarkLessThanEqual supplierMainMarkLessThanEqual に設定する
     */
    public void setSupplierMainMarkLessThanEqual(String supplierMainMarkLessThanEqual) {
        this.supplierMainMarkLessThanEqual = supplierMainMarkLessThanEqual;
    }

    /**
     * supplierMainMarkLikeFront のゲッターメソッドです。
     * 
     * @return the supplierMainMarkLikeFront
     */
    public String getSupplierMainMarkLikeFront() {
        return supplierMainMarkLikeFront;
    }

    /**
     * supplierMainMarkLikeFront のセッターメソッドです。
     * 
     * @param supplierMainMarkLikeFront supplierMainMarkLikeFront に設定する
     */
    public void setSupplierMainMarkLikeFront(String supplierMainMarkLikeFront) {
        this.supplierMainMarkLikeFront = supplierMainMarkLikeFront;
    }
    ...
    /**
     * expPackingDtGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the expPackingDtGreaterThanEqual
     */
    public Date getExpPackingDtGreaterThanEqual() {
        return expPackingDtGreaterThanEqual;
    }

    /**
     * expPackingDtGreaterThanEqual のセッターメソッドです。
     * 
     * @param expPackingDtGreaterThanEqual expPackingDtGreaterThanEqual に設定する
     */
    public void setExpPackingDtGreaterThanEqual(Date expPackingDtGreaterThanEqual) {
        this.expPackingDtGreaterThanEqual = expPackingDtGreaterThanEqual;
    }

    /**
     * expPackingDtLessThanEqual のゲッターメソッドです。
     * 
     * @return the expPackingDtLessThanEqual
     */
    public Date getExpPackingDtLessThanEqual() {
        return expPackingDtLessThanEqual;
    }

    /**
     * expPackingDtLessThanEqual のセッターメソッドです。
     * 
     * @param expPackingDtLessThanEqual expPackingDtLessThanEqual に設定する
     */
    public void setExpPackingDtLessThanEqual(Date expPackingDtLessThanEqual) {
        this.expPackingDtLessThanEqual = expPackingDtLessThanEqual;
    }

    /**
     * expPackingIssuerIdGreaterThan のゲッターメソッドです。
     * 
     * @return the expPackingIssuerIdGreaterThan
     */
    public String getExpPackingIssuerIdGreaterThan() {
        return expPackingIssuerIdGreaterThan;
    }

    /**
     * expPackingIssuerIdGreaterThan のセッターメソッドです。
     * 
     * @param expPackingIssuerIdGreaterThan expPackingIssuerIdGreaterThan に設定する
     */
    public void setExpPackingIssuerIdGreaterThan(String expPackingIssuerIdGreaterThan) {
        this.expPackingIssuerIdGreaterThan = expPackingIssuerIdGreaterThan;
    }

    /**
     * expPackingIssuerIdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the expPackingIssuerIdGreaterThanEqual
     */
    public String getExpPackingIssuerIdGreaterThanEqual() {
        return expPackingIssuerIdGreaterThanEqual;
    }

    /**
     * expPackingIssuerIdGreaterThanEqual のセッターメソッドです。
     * 
     * @param expPackingIssuerIdGreaterThanEqual expPackingIssuerIdGreaterThanEqual に設定する
     */
    public void setExpPackingIssuerIdGreaterThanEqual(String expPackingIssuerIdGreaterThanEqual) {
        this.expPackingIssuerIdGreaterThanEqual = expPackingIssuerIdGreaterThanEqual;
    }

    /**
     * expPackingIssuerIdLessThan のゲッターメソッドです。
     * 
     * @return the expPackingIssuerIdLessThan
     */
    public String getExpPackingIssuerIdLessThan() {
        return expPackingIssuerIdLessThan;
    }

    /**
     * expPackingIssuerIdLessThan のセッターメソッドです。
     * 
     * @param expPackingIssuerIdLessThan expPackingIssuerIdLessThan に設定する
     */
    public void setExpPackingIssuerIdLessThan(String expPackingIssuerIdLessThan) {
        this.expPackingIssuerIdLessThan = expPackingIssuerIdLessThan;
    }

    /**
     * expPackingIssuerIdLessThanEqual のゲッターメソッドです。
     * 
     * @return the expPackingIssuerIdLessThanEqual
     */
    public String getExpPackingIssuerIdLessThanEqual() {
        return expPackingIssuerIdLessThanEqual;
    }

    /**
     * expPackingIssuerIdLessThanEqual のセッターメソッドです。
     * 
     * @param expPackingIssuerIdLessThanEqual expPackingIssuerIdLessThanEqual に設定する
     */
    public void setExpPackingIssuerIdLessThanEqual(String expPackingIssuerIdLessThanEqual) {
        this.expPackingIssuerIdLessThanEqual = expPackingIssuerIdLessThanEqual;
    }

    /**
     * expPackingIssuerIdLikeFront のゲッターメソッドです。
     * 
     * @return the expPackingIssuerIdLikeFront
     */
    public String getExpPackingIssuerIdLikeFront() {
        return expPackingIssuerIdLikeFront;
    }

    /**
     * expPackingIssuerIdLikeFront のセッターメソッドです。
     * 
     * @param expPackingIssuerIdLikeFront expPackingIssuerIdLikeFront に設定する
     */
    public void setExpPackingIssuerIdLikeFront(String expPackingIssuerIdLikeFront) {
        this.expPackingIssuerIdLikeFront = expPackingIssuerIdLikeFront;
    }
    ...
    /**
     * pltzStatusGreaterThan のゲッターメソッドです。
     * 
     * @return the pltzStatusGreaterThan
     */
    public String getPltzStatusGreaterThan() {
        return pltzStatusGreaterThan;
    }

    /**
     * pltzStatusGreaterThan のセッターメソッドです。
     * 
     * @param pltzStatusGreaterThan pltzStatusGreaterThan に設定する
     */
    public void setPltzStatusGreaterThan(String pltzStatusGreaterThan) {
        this.pltzStatusGreaterThan = pltzStatusGreaterThan;
    }

    /**
     * pltzStatusGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the pltzStatusGreaterThanEqual
     */
    public String getPltzStatusGreaterThanEqual() {
        return pltzStatusGreaterThanEqual;
    }

    /**
     * pltzStatusGreaterThanEqual のセッターメソッドです。
     * 
     * @param pltzStatusGreaterThanEqual pltzStatusGreaterThanEqual に設定する
     */
    public void setPltzStatusGreaterThanEqual(String pltzStatusGreaterThanEqual) {
        this.pltzStatusGreaterThanEqual = pltzStatusGreaterThanEqual;
    }

    /**
     * pltzStatusLessThan のゲッターメソッドです。
     * 
     * @return the pltzStatusLessThan
     */
    public String getPltzStatusLessThan() {
        return pltzStatusLessThan;
    }

    /**
     * pltzStatusLessThan のセッターメソッドです。
     * 
     * @param pltzStatusLessThan pltzStatusLessThan に設定する
     */
    public void setPltzStatusLessThan(String pltzStatusLessThan) {
        this.pltzStatusLessThan = pltzStatusLessThan;
    }

    /**
     * pltzStatusLessThanEqual のゲッターメソッドです。
     * 
     * @return the pltzStatusLessThanEqual
     */
    public String getPltzStatusLessThanEqual() {
        return pltzStatusLessThanEqual;
    }

    /**
     * pltzStatusLessThanEqual のセッターメソッドです。
     * 
     * @param pltzStatusLessThanEqual pltzStatusLessThanEqual に設定する
     */
    public void setPltzStatusLessThanEqual(String pltzStatusLessThanEqual) {
        this.pltzStatusLessThanEqual = pltzStatusLessThanEqual;
    }

    /**
     * pltzStatusLikeFront のゲッターメソッドです。
     * 
     * @return the pltzStatusLikeFront
     */
    public String getPltzStatusLikeFront() {
        return pltzStatusLikeFront;
    }

    /**
     * pltzStatusLikeFront のセッターメソッドです。
     * 
     * @param pltzStatusLikeFront pltzStatusLikeFront に設定する
     */
    public void setPltzStatusLikeFront(String pltzStatusLikeFront) {
        this.pltzStatusLikeFront = pltzStatusLikeFront;
    }

    /**
     * packingWhCompCdGreaterThan のゲッターメソッドです。
     * 
     * @return the packingWhCompCdGreaterThan
     */
    public String getPackingWhCompCdGreaterThan() {
        return packingWhCompCdGreaterThan;
    }

    /**
     * packingWhCompCdGreaterThan のセッターメソッドです。
     * 
     * @param packingWhCompCdGreaterThan packingWhCompCdGreaterThan に設定する
     */
    public void setPackingWhCompCdGreaterThan(String packingWhCompCdGreaterThan) {
        this.packingWhCompCdGreaterThan = packingWhCompCdGreaterThan;
    }

    /**
     * packingWhCompCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the packingWhCompCdGreaterThanEqual
     */
    public String getPackingWhCompCdGreaterThanEqual() {
        return packingWhCompCdGreaterThanEqual;
    }

    /**
     * packingWhCompCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param packingWhCompCdGreaterThanEqual packingWhCompCdGreaterThanEqual に設定する
     */
    public void setPackingWhCompCdGreaterThanEqual(String packingWhCompCdGreaterThanEqual) {
        this.packingWhCompCdGreaterThanEqual = packingWhCompCdGreaterThanEqual;
    }

    /**
     * packingWhCompCdLessThan のゲッターメソッドです。
     * 
     * @return the packingWhCompCdLessThan
     */
    public String getPackingWhCompCdLessThan() {
        return packingWhCompCdLessThan;
    }

    /**
     * packingWhCompCdLessThan のセッターメソッドです。
     * 
     * @param packingWhCompCdLessThan packingWhCompCdLessThan に設定する
     */
    public void setPackingWhCompCdLessThan(String packingWhCompCdLessThan) {
        this.packingWhCompCdLessThan = packingWhCompCdLessThan;
    }

    /**
     * packingWhCompCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the packingWhCompCdLessThanEqual
     */
    public String getPackingWhCompCdLessThanEqual() {
        return packingWhCompCdLessThanEqual;
    }

    /**
     * packingWhCompCdLessThanEqual のセッターメソッドです。
     * 
     * @param packingWhCompCdLessThanEqual packingWhCompCdLessThanEqual に設定する
     */
    public void setPackingWhCompCdLessThanEqual(String packingWhCompCdLessThanEqual) {
        this.packingWhCompCdLessThanEqual = packingWhCompCdLessThanEqual;
    }

    /**
     * packingWhCompCdLikeFront のゲッターメソッドです。
     * 
     * @return the packingWhCompCdLikeFront
     */
    public String getPackingWhCompCdLikeFront() {
        return packingWhCompCdLikeFront;
    }

    /**
     * packingWhCompCdLikeFront のセッターメソッドです。
     * 
     * @param packingWhCompCdLikeFront packingWhCompCdLikeFront に設定する
     */
    public void setPackingWhCompCdLikeFront(String packingWhCompCdLikeFront) {
        this.packingWhCompCdLikeFront = packingWhCompCdLikeFront;
    }
    ...
    /**
     * siteTypGreaterThan のゲッターメソッドです。
     * 
     * @return the siteTypGreaterThan
     */
    public String getSiteTypGreaterThan() {
        return siteTypGreaterThan;
    }

    /**
     * siteTypGreaterThan のセッターメソッドです。
     * 
     * @param siteTypGreaterThan siteTypGreaterThan に設定する
     */
    public void setSiteTypGreaterThan(String siteTypGreaterThan) {
        this.siteTypGreaterThan = siteTypGreaterThan;
    }

    /**
     * siteTypGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the siteTypGreaterThanEqual
     */
    public String getSiteTypGreaterThanEqual() {
        return siteTypGreaterThanEqual;
    }

    /**
     * siteTypGreaterThanEqual のセッターメソッドです。
     * 
     * @param siteTypGreaterThanEqual siteTypGreaterThanEqual に設定する
     */
    public void setSiteTypGreaterThanEqual(String siteTypGreaterThanEqual) {
        this.siteTypGreaterThanEqual = siteTypGreaterThanEqual;
    }

    /**
     * siteTypLessThan のゲッターメソッドです。
     * 
     * @return the siteTypLessThan
     */
    public String getSiteTypLessThan() {
        return siteTypLessThan;
    }

    /**
     * siteTypLessThan のセッターメソッドです。
     * 
     * @param siteTypLessThan siteTypLessThan に設定する
     */
    public void setSiteTypLessThan(String siteTypLessThan) {
        this.siteTypLessThan = siteTypLessThan;
    }

    /**
     * siteTypLessThanEqual のゲッターメソッドです。
     * 
     * @return the siteTypLessThanEqual
     */
    public String getSiteTypLessThanEqual() {
        return siteTypLessThanEqual;
    }

    /**
     * siteTypLessThanEqual のセッターメソッドです。
     * 
     * @param siteTypLessThanEqual siteTypLessThanEqual に設定する
     */
    public void setSiteTypLessThanEqual(String siteTypLessThanEqual) {
        this.siteTypLessThanEqual = siteTypLessThanEqual;
    }

    /**
     * siteTypLikeFront のゲッターメソッドです。
     * 
     * @return the siteTypLikeFront
     */
    public String getSiteTypLikeFront() {
        return siteTypLikeFront;
    }

    /**
     * siteTypLikeFront のセッターメソッドです。
     * 
     * @param siteTypLikeFront siteTypLikeFront に設定する
     */
    public void setSiteTypLikeFront(String siteTypLikeFront) {
        this.siteTypLikeFront = siteTypLikeFront;
    }

    /**
     * expLimitFlgGreaterThan のゲッターメソッドです。
     * 
     * @return the expLimitFlgGreaterThan
     */
    public String getExpLimitFlgGreaterThan() {
        return expLimitFlgGreaterThan;
    }

    /**
     * expLimitFlgGreaterThan のセッターメソッドです。
     * 
     * @param expLimitFlgGreaterThan expLimitFlgGreaterThan に設定する
     */
    public void setExpLimitFlgGreaterThan(String expLimitFlgGreaterThan) {
        this.expLimitFlgGreaterThan = expLimitFlgGreaterThan;
    }

    /**
     * expLimitFlgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the expLimitFlgGreaterThanEqual
     */
    public String getExpLimitFlgGreaterThanEqual() {
        return expLimitFlgGreaterThanEqual;
    }

    /**
     * expLimitFlgGreaterThanEqual のセッターメソッドです。
     * 
     * @param expLimitFlgGreaterThanEqual expLimitFlgGreaterThanEqual に設定する
     */
    public void setExpLimitFlgGreaterThanEqual(String expLimitFlgGreaterThanEqual) {
        this.expLimitFlgGreaterThanEqual = expLimitFlgGreaterThanEqual;
    }

    /**
     * expLimitFlgLessThan のゲッターメソッドです。
     * 
     * @return the expLimitFlgLessThan
     */
    public String getExpLimitFlgLessThan() {
        return expLimitFlgLessThan;
    }

    /**
     * expLimitFlgLessThan のセッターメソッドです。
     * 
     * @param expLimitFlgLessThan expLimitFlgLessThan に設定する
     */
    public void setExpLimitFlgLessThan(String expLimitFlgLessThan) {
        this.expLimitFlgLessThan = expLimitFlgLessThan;
    }

    /**
     * expLimitFlgLessThanEqual のゲッターメソッドです。
     * 
     * @return the expLimitFlgLessThanEqual
     */
    public String getExpLimitFlgLessThanEqual() {
        return expLimitFlgLessThanEqual;
    }

    /**
     * expLimitFlgLessThanEqual のセッターメソッドです。
     * 
     * @param expLimitFlgLessThanEqual expLimitFlgLessThanEqual に設定する
     */
    public void setExpLimitFlgLessThanEqual(String expLimitFlgLessThanEqual) {
        this.expLimitFlgLessThanEqual = expLimitFlgLessThanEqual;
    }

    /**
     * expLimitFlgLikeFront のゲッターメソッドです。
     * 
     * @return the expLimitFlgLikeFront
     */
    public String getExpLimitFlgLikeFront() {
        return expLimitFlgLikeFront;
    }

    /**
     * expLimitFlgLikeFront のセッターメソッドです。
     * 
     * @param expLimitFlgLikeFront expLimitFlgLikeFront に設定する
     */
    public void setExpLimitFlgLikeFront(String expLimitFlgLikeFront) {
        this.expLimitFlgLikeFront = expLimitFlgLikeFront;
    }
    ...
    /**
     * lastTrStatusGreaterThan のゲッターメソッドです。
     * 
     * @return the lastTrStatusGreaterThan
     */
    public String getLastTrStatusGreaterThan() {
        return lastTrStatusGreaterThan;
    }

    /**
     * lastTrStatusGreaterThan のセッターメソッドです。
     * 
     * @param lastTrStatusGreaterThan lastTrStatusGreaterThan に設定する
     */
    public void setLastTrStatusGreaterThan(String lastTrStatusGreaterThan) {
        this.lastTrStatusGreaterThan = lastTrStatusGreaterThan;
    }

    /**
     * lastTrStatusGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the lastTrStatusGreaterThanEqual
     */
    public String getLastTrStatusGreaterThanEqual() {
        return lastTrStatusGreaterThanEqual;
    }

    /**
     * lastTrStatusGreaterThanEqual のセッターメソッドです。
     * 
     * @param lastTrStatusGreaterThanEqual lastTrStatusGreaterThanEqual に設定する
     */
    public void setLastTrStatusGreaterThanEqual(String lastTrStatusGreaterThanEqual) {
        this.lastTrStatusGreaterThanEqual = lastTrStatusGreaterThanEqual;
    }

    /**
     * lastTrStatusLessThan のゲッターメソッドです。
     * 
     * @return the lastTrStatusLessThan
     */
    public String getLastTrStatusLessThan() {
        return lastTrStatusLessThan;
    }

    /**
     * lastTrStatusLessThan のセッターメソッドです。
     * 
     * @param lastTrStatusLessThan lastTrStatusLessThan に設定する
     */
    public void setLastTrStatusLessThan(String lastTrStatusLessThan) {
        this.lastTrStatusLessThan = lastTrStatusLessThan;
    }

    /**
     * lastTrStatusLessThanEqual のゲッターメソッドです。
     * 
     * @return the lastTrStatusLessThanEqual
     */
    public String getLastTrStatusLessThanEqual() {
        return lastTrStatusLessThanEqual;
    }

    /**
     * lastTrStatusLessThanEqual のセッターメソッドです。
     * 
     * @param lastTrStatusLessThanEqual lastTrStatusLessThanEqual に設定する
     */
    public void setLastTrStatusLessThanEqual(String lastTrStatusLessThanEqual) {
        this.lastTrStatusLessThanEqual = lastTrStatusLessThanEqual;
    }

    /**
     * lastTrStatusLikeFront のゲッターメソッドです。
     * 
     * @return the lastTrStatusLikeFront
     */
    public String getLastTrStatusLikeFront() {
        return lastTrStatusLikeFront;
    }

    /**
     * lastTrStatusLikeFront のセッターメソッドです。
     * 
     * @param lastTrStatusLikeFront lastTrStatusLikeFront に設定する
     */
    public void setLastTrStatusLikeFront(String lastTrStatusLikeFront) {
        this.lastTrStatusLikeFront = lastTrStatusLikeFront;
    }

    /**
     * lastTrRcvDtGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the lastTrRcvDtGreaterThanEqual
     */
    public Date getLastTrRcvDtGreaterThanEqual() {
        return lastTrRcvDtGreaterThanEqual;
    }

    /**
     * lastTrRcvDtGreaterThanEqual のセッターメソッドです。
     * 
     * @param lastTrRcvDtGreaterThanEqual lastTrRcvDtGreaterThanEqual に設定する
     */
    public void setLastTrRcvDtGreaterThanEqual(Date lastTrRcvDtGreaterThanEqual) {
        this.lastTrRcvDtGreaterThanEqual = lastTrRcvDtGreaterThanEqual;
    }

    /**
     * lastTrRcvDtLessThanEqual のゲッターメソッドです。
     * 
     * @return the lastTrRcvDtLessThanEqual
     */
    public Date getLastTrRcvDtLessThanEqual() {
        return lastTrRcvDtLessThanEqual;
    }

    /**
     * lastTrRcvDtLessThanEqual のセッターメソッドです。
     * 
     * @param lastTrRcvDtLessThanEqual lastTrRcvDtLessThanEqual に設定する
     */
    public void setLastTrRcvDtLessThanEqual(Date lastTrRcvDtLessThanEqual) {
        this.lastTrRcvDtLessThanEqual = lastTrRcvDtLessThanEqual;
    }
    ...
    /**
     * expRequestAllCmlIssuedFlgGreaterThan のゲッターメソッドです。
     * 
     * @return the expRequestAllCmlIssuedFlgGreaterThan
     */
    public String getExpRequestAllCmlIssuedFlgGreaterThan() {
        return expRequestAllCmlIssuedFlgGreaterThan;
    }

    /**
     * expRequestAllCmlIssuedFlgGreaterThan のセッターメソッドです。
     * 
     * @param expRequestAllCmlIssuedFlgGreaterThan expRequestAllCmlIssuedFlgGreaterThan に設定する
     */
    public void setExpRequestAllCmlIssuedFlgGreaterThan(String expRequestAllCmlIssuedFlgGreaterThan) {
        this.expRequestAllCmlIssuedFlgGreaterThan = expRequestAllCmlIssuedFlgGreaterThan;
    }

    /**
     * expRequestAllCmlIssuedFlgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the expRequestAllCmlIssuedFlgGreaterThanEqual
     */
    public String getExpRequestAllCmlIssuedFlgGreaterThanEqual() {
        return expRequestAllCmlIssuedFlgGreaterThanEqual;
    }

    /**
     * expRequestAllCmlIssuedFlgGreaterThanEqual のセッターメソッドです。
     * 
     * @param expRequestAllCmlIssuedFlgGreaterThanEqual expRequestAllCmlIssuedFlgGreaterThanEqual に設定する
     */
    public void setExpRequestAllCmlIssuedFlgGreaterThanEqual(String expRequestAllCmlIssuedFlgGreaterThanEqual) {
        this.expRequestAllCmlIssuedFlgGreaterThanEqual = expRequestAllCmlIssuedFlgGreaterThanEqual;
    }

    /**
     * expRequestAllCmlIssuedFlgLessThan のゲッターメソッドです。
     * 
     * @return the expRequestAllCmlIssuedFlgLessThan
     */
    public String getExpRequestAllCmlIssuedFlgLessThan() {
        return expRequestAllCmlIssuedFlgLessThan;
    }

    /**
     * expRequestAllCmlIssuedFlgLessThan のセッターメソッドです。
     * 
     * @param expRequestAllCmlIssuedFlgLessThan expRequestAllCmlIssuedFlgLessThan に設定する
     */
    public void setExpRequestAllCmlIssuedFlgLessThan(String expRequestAllCmlIssuedFlgLessThan) {
        this.expRequestAllCmlIssuedFlgLessThan = expRequestAllCmlIssuedFlgLessThan;
    }

    /**
     * expRequestAllCmlIssuedFlgLessThanEqual のゲッターメソッドです。
     * 
     * @return the expRequestAllCmlIssuedFlgLessThanEqual
     */
    public String getExpRequestAllCmlIssuedFlgLessThanEqual() {
        return expRequestAllCmlIssuedFlgLessThanEqual;
    }

    /**
     * expRequestAllCmlIssuedFlgLessThanEqual のセッターメソッドです。
     * 
     * @param expRequestAllCmlIssuedFlgLessThanEqual expRequestAllCmlIssuedFlgLessThanEqual に設定する
     */
    public void setExpRequestAllCmlIssuedFlgLessThanEqual(String expRequestAllCmlIssuedFlgLessThanEqual) {
        this.expRequestAllCmlIssuedFlgLessThanEqual = expRequestAllCmlIssuedFlgLessThanEqual;
    }

    /**
     * expRequestAllCmlIssuedFlgLikeFront のゲッターメソッドです。
     * 
     * @return the expRequestAllCmlIssuedFlgLikeFront
     */
    public String getExpRequestAllCmlIssuedFlgLikeFront() {
        return expRequestAllCmlIssuedFlgLikeFront;
    }

    /**
     * expRequestAllCmlIssuedFlgLikeFront のセッターメソッドです。
     * 
     * @param expRequestAllCmlIssuedFlgLikeFront expRequestAllCmlIssuedFlgLikeFront に設定する
     */
    public void setExpRequestAllCmlIssuedFlgLikeFront(String expRequestAllCmlIssuedFlgLikeFront) {
        this.expRequestAllCmlIssuedFlgLikeFront = expRequestAllCmlIssuedFlgLikeFront;
    }
