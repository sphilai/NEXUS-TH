...
/**
 * The domain holding the result of TtMixTag.
 * <br />TtMixTagの結果を保持するドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Ws2501TtMixTagDomain extends AbstractDomain implements Serializable {
