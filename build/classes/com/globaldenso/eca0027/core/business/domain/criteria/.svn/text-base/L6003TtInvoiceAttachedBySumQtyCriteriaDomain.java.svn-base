...
/**
 * The domain that holds the search criteria for the summary of QUANTITY and WEIGHT for the form [L6003].
 * <br/>帳票【L6003】の数量、重量のサマリの検索条件を保持するドメインです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 10993 $
 */
public class L6003TtInvoiceAttachedBySumQtyCriteriaDomain extends AbstractDomain {
    ...
    /**
     * Shipper to be printed.
     * 印刷対象のShipper
     */
    private String shipperCd = null;
    
    /**
     * Invoice No to be printed.
     * 印刷対象のInvoice No
     */
    private String invoiceNo = null;
    
    /**
     * Invoice Issue Dt to be printed.
     * 印刷対象のInvoice Issue Dt
     */
     ...
     *
     */
    public L6003TtInvoiceAttachedBySumQtyCriteriaDomain() {
    }
