 ...
 * @version $Revision$
 */
public class W1006ExpRequestDtlDomain extends AbstractDomain implements Serializable {
    ...
    */
     ...
     * デフォルトコンストラクタ。
     */
    public W1006ExpRequestDtlDomain() {
    }
    /**
     * <p>Getter method for noOfChild.</p>
     *
    ...
    /**
     * <p>Setter method for noOfChild.</p>
     *
     * @param noOfChild Set for noOfChild
     */
