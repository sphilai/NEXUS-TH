...
/**
 * The domain class that holds the search criteria document for Head Importer information acquisition.
 * </br>Head帳票用Importer情報取得時の検索条件を保持するドメインクラスです。
 *
 * @author $Author: 400616000304 $
 * @version $Revision: 10993 $
 */
public class L7001TtPltzByImporterCriteriaDomain extends AbstractDomain {
     ...
     *
     */
    public L7001TtPltzByImporterCriteriaDomain() {
    }
