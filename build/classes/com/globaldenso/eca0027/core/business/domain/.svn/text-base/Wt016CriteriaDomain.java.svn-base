...
/**
 * The PL layer domain class that holds the criteria information of Unregistered HS CODE List Sub Screen.
 * <br/>HS CODE登録なし品番表示子画面一覧部の検索条件を保持するPL層用のドメインクラスです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */

public class Wt016CriteriaDomain extends AbstractDomain{
