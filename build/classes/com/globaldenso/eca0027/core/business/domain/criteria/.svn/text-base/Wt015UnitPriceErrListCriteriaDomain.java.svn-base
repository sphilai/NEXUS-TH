...
/**
 * The BL layer domain class that holds the criteria information of Unit Price Error List Sub Screen.
 * <br/>売価登録なし品番表示子画面一覧部の検索条件を保持するBL層用のドメインクラスです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */

public class Wt015UnitPriceErrListCriteriaDomain extends AbstractDomain{
     ...
     * Default constructor.
     */
    public Wt015UnitPriceErrListCriteriaDomain() {
    }
