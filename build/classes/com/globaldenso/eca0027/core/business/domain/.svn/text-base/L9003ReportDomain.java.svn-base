...
/** 
 * The domain class that holds the information of the document [L9003].
 * </br>帳票【L9003】の情報を保持するドメインクラスです。
 *
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class L9003ReportDomain extends AbstractDomain {
    /** 
     * serial version<br />
     * シリアルバージョン
     */
