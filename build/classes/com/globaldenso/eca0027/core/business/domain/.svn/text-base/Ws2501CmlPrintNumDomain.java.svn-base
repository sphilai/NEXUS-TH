...
/**
 * The domain holding the result of SearchCmlPrintNum.
 * <br />SearchCmlPrintNumの結果を保持するドメインです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Ws2501CmlPrintNumDomain extends AbstractDomain implements Serializable {
     ...
     * <br />デフォルトコンストラクタ。
     */
    public Ws2501CmlPrintNumDomain() {
    }
