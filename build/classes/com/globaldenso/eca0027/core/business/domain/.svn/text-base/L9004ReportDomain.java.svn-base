...
/** 
 * The domain class that holds the information of the document [L9004].
 * </br>帳票【L9004】の情報を保持するドメインクラスです。
 *
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class L9004ReportDomain extends AbstractDomain {
    /** 
     * serial version<br />
     * シリアルバージョン
     */
    ...
    private String totalGrossWeightUnit = null;
    /** totalNetWeightUnit */
    ...
    /**
     * Getter method for totalGrossWeightUnit
     *
    ...
    /**
     * Setter method for totalGrossWeightUnit
     *
     * @param totalGrossWeightUnit Set for totalGrossWeightUnit
     */
