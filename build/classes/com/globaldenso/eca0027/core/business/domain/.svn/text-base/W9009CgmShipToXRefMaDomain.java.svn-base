 ...
 * CIGMA Ship to X-Reference MA Screen List section.
 * <br/>CIGMA Ship to X-Reference MA 画面一覧部の明細情報を保持するBL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class W9009CgmShipToXRefMaDomain extends AbstractDomain implements Serializable{
     ...
     */
    public W9009CgmShipToXRefMaDomain() {
    }
    ...
    /**
     * <p>Getter method for comCreateTimestamp.</p>
     *
    ...
    /**
     * <p>Setter method for comCreateTimestamp.</p>
     *
