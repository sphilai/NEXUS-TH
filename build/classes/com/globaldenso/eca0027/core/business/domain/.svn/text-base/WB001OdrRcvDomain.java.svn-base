...
/**
 * 
 * This is a domain class holding Customer Order Receiving.
 * <br />Customer Order Receivingを保持するドメインクラスです。
 *
 * @author $Author: 810833843 $
 * @version $Revision: 9972 $
 */
public class WB001OdrRcvDomain extends AbstractDomain {
    ...
    /**
     * Operating-days flag list
     * <br />稼働日フラグリスト
     */
    private List<String> workDayFlgList;
    
    /**
     * CUSTOMER PART NO. list
     * <br />CUSTOMER PART NO.リスト
     */
