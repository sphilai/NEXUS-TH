...
/**
 * The BL layer domain class that holds the detail information of Unit Price Error List Sub Screen List section. 
 * <br/>売価登録なし品番表示子画面一覧部の明細情報を保持するBL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class Wt015UnitPriceErrListDomain extends AbstractDomain{
    ...
    /**
     * UNIT PRICE(Y:UNIT PRICE YES VALUE,N:UNIT PRICE NO VALUE)/単価(Y:単価に値有,N:単価に値無)
     */
     ...
     * Default constructor.
     */
    public Wt015UnitPriceErrListDomain() {
    }
