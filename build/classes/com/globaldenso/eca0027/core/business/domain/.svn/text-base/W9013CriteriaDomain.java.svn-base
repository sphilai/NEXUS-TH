...
/**
 * The PL layer domain class that holds the criteria information of Warehouse Search Screen.
 * <br/>倉庫検索画面の検索条件を保持するPL層用のドメインクラスです。
 * 
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */

public class W9013CriteriaDomain extends AbstractDomain {
