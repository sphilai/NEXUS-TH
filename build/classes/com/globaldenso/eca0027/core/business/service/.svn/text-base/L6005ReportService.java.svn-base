...
/**
 * Interface of the service that provides the output function form [Invoice Attached(RT)].
 * <br/>帳票【 Invoice Attached(RT)  】出力機能を提供するサービスのインターフェースです。
 * <pre>
 * bean id:l6005ReportService
 * </pre>
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7682 $
 */
public interface L6005ReportService {

    /**
     * Get the form output information to generate a form [Invoice Attached (RT)] a.
     * <br/>帳票出力情報を取得し、帳票【 Invoice Attached(RT) 】を生成します。
     * <pre>
     ...
     *       criteriaDomainを引数に{@link VtRpInvAtchedForRtService#searchByCondition(VtRpInvAtchedForRtCriteriaDomain)}を呼び出します。
     *       取得件数が0であれば、エラーとします。
     *       
