...
/**
 * Interface of the service that provides the output function form [Sales Contract Header(Comercial_Intangible)].
 * <br/>帳票【 Sales Contract Header(Comercial_Intangible) 】出力機能を提供するサービスのインターフェースです。
 * <pre>
 * bean id:l6011ReportService
 * </pre>
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7682 $
 */
public interface L6011ReportService {

    /**
     * Get the form output information to generate a form [Packing Attached (FRT)] a.
