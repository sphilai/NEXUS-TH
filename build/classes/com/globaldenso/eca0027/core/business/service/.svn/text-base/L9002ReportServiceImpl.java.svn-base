...
import static com.globaldenso.eca0027.core.common.constants.Eca0027Constants.REPORT_ID_L9002;
...
import com.globaldenso.eca0027.core.business.domain.L9002ReportDomain;
import com.globaldenso.gscm.framework.exception.GscmApplicationException;
import com.globaldenso.gscm.framework.util.CheckUtil;

/**
 * Implementation class of the form creation service L9002 [Invoice Header (Comercial_Intangible)].<br />
 * L9002【 Invoice Header(Comercial_Intangible) 】の帳票作成サービスの実装クラスです。
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7765 $
 */
public class L9002ReportServiceImpl extends AbstractReportServiceImpl implements L9002ReportService {
    ...
    /**
     * {@inheritDoc}
     * @see com.globaldenso.eca0027.core.business.service.L9002ReportService#searchSmplInvHdrForNonCmrcl(String company, String documentNo)
     */
    public File searchSmplInvHdrForNonCmrcl(String company, String documentNo) throws ApplicationException {

        L9002ReportDomain reportDomain = new L9002ReportDomain();
        ...
        // Create report.
        // 帳票生成
        return createReport(REPORT_ID_L9002, reportDomain);
    }
