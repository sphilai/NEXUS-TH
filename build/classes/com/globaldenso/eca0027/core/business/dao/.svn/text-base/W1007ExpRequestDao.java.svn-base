...
/**
 * W1006ExpRequest のDAOインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface W1007ExpRequestDao {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria W1007ExpRequestの CriteriaDomain クラス
     * @return W1007ExpRequestのDomainクラス
     ...
     * 主キーを条件に、データを更新します。
     * 
     * @param domain W1007ExpRequestのDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
