...
/**
 * The implementation class for the Web Call Service (WS6005)
 * <br />Webサービス(WS6005)呼出しサービスの実装クラスです。
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7053 $
 */
public class Ws6005RestServiceImpl implements Ws6005RestService {
    ...
    /**
     * {@inheritDoc}
     * @see com.globaldenso.eca0027.core.business.ws.Ws6005RestService#registInvoiceDb(java.lang.String, com.globaldenso.eca0027.core.business.domain.Ws6005ParamDomain)
     */
    public ResultDomain registInvoiceDb(String compCd, Ws6005ParamDomain param) throws ApplicationException {

        String webServicePath = "ws6005";
