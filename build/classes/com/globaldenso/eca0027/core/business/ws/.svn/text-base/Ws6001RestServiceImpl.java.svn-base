...
/**
 * The implementation class for the Web Call Service (WS6001)
 * <br />Webサービス(WS6001)呼出しサービスの実装クラスです。
 * 
 * @author $Author: 810833613 $
 * @version $Revision: 7053 $
 */
public class Ws6001RestServiceImpl implements Ws6001RestService {
