 ...
 * PROJECT：eca0027
 * 
 * TtExpRequestPltzRt のServiceインターフェース
 * 
...
/**
 * TtExpRequestPltzRt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtExpRequestPltzRtService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria ttExpRequestPltzRtの CriteriaDomain クラス
     * @return ttExpRequestPltzRtのDomainクラス
     ...
     * 
     * @param criteria ttExpRequestPltzRtの CriteriaDomain クラス
     * @return ttExpRequestPltzRtのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain ttExpRequestPltzRtのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains ttExpRequestPltzRtのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain ttExpRequestPltzRtのDomainクラス
     * @param criteria ttExpRequestPltzRtのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttExpRequestPltzRtのDomainクラスのList
     * @param criteria ttExpRequestPltzRtのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtExpRequestPltzRtDomain> domains, List<TtExpRequestPltzRtCriteriaDomain> criteria) throws ApplicationException;
