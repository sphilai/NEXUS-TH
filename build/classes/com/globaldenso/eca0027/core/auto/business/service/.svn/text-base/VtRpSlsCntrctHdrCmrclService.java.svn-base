 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctHdrCmrcl のServiceインターフェース
 * 
...
/**
 * VtRpSlsCntrctHdrCmrcl のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpSlsCntrctHdrCmrclService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpSlsCntrctHdrCmrclの CriteriaDomain クラス
     * @return vtRpSlsCntrctHdrCmrclのDomainクラスのList
