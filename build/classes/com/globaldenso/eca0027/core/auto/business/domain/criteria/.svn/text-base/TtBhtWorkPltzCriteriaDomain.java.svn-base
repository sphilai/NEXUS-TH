 ...
 * PROJECT：eca0027
 * 
 * TtBhtWorkPltz の検索条件Domainクラス
 * テーブル概要：TT_BHT_WORK_PLTZ
 * 
...
/**
 * TtBhtWorkPltz の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_BHT_WORK_PLTZ<BR>
 * 
 * <BR>
 ...
 */
public class TtBhtWorkPltzCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtBhtWorkPltzCriteriaDomain() {
    }
    ...
    /**
     * pltzTagQty のゲッターメソッドです。
     * 
     * @return the pltzTagQty
     */
    public BigDecimal getPltzTagQty() {
        return pltzTagQty;
    }

    /**
     * pltzTagQty のセッターメソッドです。
     * 
     * @param pltzTagQty pltzTagQty に設定する
     */
    public void setPltzTagQty(BigDecimal pltzTagQty) {
        this.pltzTagQty = pltzTagQty;
    }
