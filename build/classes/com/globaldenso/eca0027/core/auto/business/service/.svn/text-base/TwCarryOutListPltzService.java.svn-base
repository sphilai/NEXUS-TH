 ...
 * PROJECT：eca0027
 * 
 * TwCarryOutListPltz のServiceインターフェース
 * 
...
/**
 * TwCarryOutListPltz のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface TwCarryOutListPltzService {
     ...
     * データを登録します。
     * 
     * @param domains twCarryOutListPltzのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twCarryOutListPltzのDomainクラスのList
     * @param criteria twCarryOutListPltzのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwCarryOutListPltzDomain> domains, List<TwCarryOutListPltzCriteriaDomain> criteria) throws ApplicationException;
