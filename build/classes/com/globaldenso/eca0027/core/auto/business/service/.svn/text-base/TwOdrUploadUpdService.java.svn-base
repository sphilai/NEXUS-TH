 ...
 * PROJECT：eca0027
 * 
 * TwOdrUploadUpd のServiceインターフェース
 * 
...
/**
 * TwOdrUploadUpd のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwOdrUploadUpdService {
     ...
     * データを登録します。
     * 
     * @param domains twOdrUploadUpdのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twOdrUploadUpdのDomainクラスのList
     * @param criteria twOdrUploadUpdのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwOdrUploadUpdDomain> domains, List<TwOdrUploadUpdCriteriaDomain> criteria) throws ApplicationException;
