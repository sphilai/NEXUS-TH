...
/**
 * TwStgInstr の検索条件Domainクラスです。<BR>
 * テーブル概要：TW_STG_INSTR<BR>
 * 
 * <BR>
 ...
 */
public class TwStgInstrCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TwStgInstrCriteriaDomain() {
    }
