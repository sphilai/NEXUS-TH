...
/**
 * TmPkgSpecHdr のDAOインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface TmPkgSpecHdrDao {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmPkgSpecHdrの CriteriaDomain クラス
     * @return tmPkgSpecHdrのDomainクラス
     ...
     * 
     * @param criteria tmPkgSpecHdrの CriteriaDomain クラス
     * @return tmPkgSpecHdrのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
