 ...
 * PROJECT：eca0027
 * 
 * TmActualItemWeight のServiceインターフェース
 * 
...
/**
 * TmActualItemWeight のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface TmActualItemWeightService {
     ...
     * データを登録します。
     * 
     * @param domains tmActualItemWeightのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmActualItemWeightのDomainクラスのList
     * @param criteria tmActualItemWeightのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmActualItemWeightDomain> domains, List<TmActualItemWeightCriteriaDomain> criteria) throws ApplicationException;
