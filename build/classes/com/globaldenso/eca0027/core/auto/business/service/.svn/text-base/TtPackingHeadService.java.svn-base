 ...
 * PROJECT：eca0027
 * 
 * TtPackingHead のServiceインターフェース
 * 
...
/**
 * TtPackingHead のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtPackingHeadService {
     ...
     * データを登録します。
     * 
     * @param domains ttPackingHeadのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttPackingHeadのDomainクラスのList
     * @param criteria ttPackingHeadのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtPackingHeadDomain> domains, List<TtPackingHeadCriteriaDomain> criteria) throws ApplicationException;
