...
/**
 * TmUomCnvDec の検索条件Domainクラスです。<BR>
 ...
 */
public class TmUomCnvDecCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * UOM_CD_CONV_SRC（大なり）
     */
    private String uomCdConvSrcGreaterThan;

    /**
     * UOM_CD_CONV_SRC（大なりイコール）
     */
    private String uomCdConvSrcGreaterThanEqual;

    /**
     * UOM_CD_CONV_SRC（小なり）
     */
    private String uomCdConvSrcLessThan;

    /**
     * UOM_CD_CONV_SRC（小なりイコール）
     */
    private String uomCdConvSrcLessThanEqual;

    /**
     * UOM_CD_CONV_SRC（前方一致）
     */
    private String uomCdConvSrcLikeFront;

    /**
     * UOM_CD_CONV_TRGT（大なり）
     */
    private String uomCdConvTrgtGreaterThan;

    /**
     * UOM_CD_CONV_TRGT（大なりイコール）
     */
    private String uomCdConvTrgtGreaterThanEqual;

    /**
     * UOM_CD_CONV_TRGT（小なり）
     */
    private String uomCdConvTrgtLessThan;

    /**
     * UOM_CD_CONV_TRGT（小なりイコール）
     */
    private String uomCdConvTrgtLessThanEqual;

    /**
     * UOM_CD_CONV_TRGT（前方一致）
     */
    private String uomCdConvTrgtLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TmUomCnvDecCriteriaDomain() {
    }
    ...
    /**
     * uomCdConvSrcGreaterThan のゲッターメソッドです。
     * 
     * @return the uomCdConvSrcGreaterThan
     */
    public String getUomCdConvSrcGreaterThan() {
        return uomCdConvSrcGreaterThan;
    }

    /**
     * uomCdConvSrcGreaterThan のセッターメソッドです。
     * 
     * @param uomCdConvSrcGreaterThan uomCdConvSrcGreaterThan に設定する
     */
    public void setUomCdConvSrcGreaterThan(String uomCdConvSrcGreaterThan) {
        this.uomCdConvSrcGreaterThan = uomCdConvSrcGreaterThan;
    }

    /**
     * uomCdConvSrcGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the uomCdConvSrcGreaterThanEqual
     */
    public String getUomCdConvSrcGreaterThanEqual() {
        return uomCdConvSrcGreaterThanEqual;
    }

    /**
     * uomCdConvSrcGreaterThanEqual のセッターメソッドです。
     * 
     * @param uomCdConvSrcGreaterThanEqual uomCdConvSrcGreaterThanEqual に設定する
     */
    public void setUomCdConvSrcGreaterThanEqual(String uomCdConvSrcGreaterThanEqual) {
        this.uomCdConvSrcGreaterThanEqual = uomCdConvSrcGreaterThanEqual;
    }

    /**
     * uomCdConvSrcLessThan のゲッターメソッドです。
     * 
     * @return the uomCdConvSrcLessThan
     */
    public String getUomCdConvSrcLessThan() {
        return uomCdConvSrcLessThan;
    }

    /**
     * uomCdConvSrcLessThan のセッターメソッドです。
     * 
     * @param uomCdConvSrcLessThan uomCdConvSrcLessThan に設定する
     */
    public void setUomCdConvSrcLessThan(String uomCdConvSrcLessThan) {
        this.uomCdConvSrcLessThan = uomCdConvSrcLessThan;
    }

    /**
     * uomCdConvSrcLessThanEqual のゲッターメソッドです。
     * 
     * @return the uomCdConvSrcLessThanEqual
     */
    public String getUomCdConvSrcLessThanEqual() {
        return uomCdConvSrcLessThanEqual;
    }

    /**
     * uomCdConvSrcLessThanEqual のセッターメソッドです。
     * 
     * @param uomCdConvSrcLessThanEqual uomCdConvSrcLessThanEqual に設定する
     */
    public void setUomCdConvSrcLessThanEqual(String uomCdConvSrcLessThanEqual) {
        this.uomCdConvSrcLessThanEqual = uomCdConvSrcLessThanEqual;
    }

    /**
     * uomCdConvSrcLikeFront のゲッターメソッドです。
     * 
     * @return the uomCdConvSrcLikeFront
     */
    public String getUomCdConvSrcLikeFront() {
        return uomCdConvSrcLikeFront;
    }

    /**
     * uomCdConvSrcLikeFront のセッターメソッドです。
     * 
     * @param uomCdConvSrcLikeFront uomCdConvSrcLikeFront に設定する
     */
    public void setUomCdConvSrcLikeFront(String uomCdConvSrcLikeFront) {
        this.uomCdConvSrcLikeFront = uomCdConvSrcLikeFront;
    }

    /**
     * uomCdConvTrgtGreaterThan のゲッターメソッドです。
     * 
     * @return the uomCdConvTrgtGreaterThan
     */
    public String getUomCdConvTrgtGreaterThan() {
        return uomCdConvTrgtGreaterThan;
    }

    /**
     * uomCdConvTrgtGreaterThan のセッターメソッドです。
     * 
     * @param uomCdConvTrgtGreaterThan uomCdConvTrgtGreaterThan に設定する
     */
    public void setUomCdConvTrgtGreaterThan(String uomCdConvTrgtGreaterThan) {
        this.uomCdConvTrgtGreaterThan = uomCdConvTrgtGreaterThan;
    }

    /**
     * uomCdConvTrgtGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the uomCdConvTrgtGreaterThanEqual
     */
    public String getUomCdConvTrgtGreaterThanEqual() {
        return uomCdConvTrgtGreaterThanEqual;
    }

    /**
     * uomCdConvTrgtGreaterThanEqual のセッターメソッドです。
     * 
     * @param uomCdConvTrgtGreaterThanEqual uomCdConvTrgtGreaterThanEqual に設定する
     */
    public void setUomCdConvTrgtGreaterThanEqual(String uomCdConvTrgtGreaterThanEqual) {
        this.uomCdConvTrgtGreaterThanEqual = uomCdConvTrgtGreaterThanEqual;
    }

    /**
     * uomCdConvTrgtLessThan のゲッターメソッドです。
     * 
     * @return the uomCdConvTrgtLessThan
     */
    public String getUomCdConvTrgtLessThan() {
        return uomCdConvTrgtLessThan;
    }

    /**
     * uomCdConvTrgtLessThan のセッターメソッドです。
     * 
     * @param uomCdConvTrgtLessThan uomCdConvTrgtLessThan に設定する
     */
    public void setUomCdConvTrgtLessThan(String uomCdConvTrgtLessThan) {
        this.uomCdConvTrgtLessThan = uomCdConvTrgtLessThan;
    }

    /**
     * uomCdConvTrgtLessThanEqual のゲッターメソッドです。
     * 
     * @return the uomCdConvTrgtLessThanEqual
     */
    public String getUomCdConvTrgtLessThanEqual() {
        return uomCdConvTrgtLessThanEqual;
    }

    /**
     * uomCdConvTrgtLessThanEqual のセッターメソッドです。
     * 
     * @param uomCdConvTrgtLessThanEqual uomCdConvTrgtLessThanEqual に設定する
     */
    public void setUomCdConvTrgtLessThanEqual(String uomCdConvTrgtLessThanEqual) {
        this.uomCdConvTrgtLessThanEqual = uomCdConvTrgtLessThanEqual;
    }

    /**
     * uomCdConvTrgtLikeFront のゲッターメソッドです。
     * 
     * @return the uomCdConvTrgtLikeFront
     */
    public String getUomCdConvTrgtLikeFront() {
        return uomCdConvTrgtLikeFront;
    }

    /**
     * uomCdConvTrgtLikeFront のセッターメソッドです。
     * 
     * @param uomCdConvTrgtLikeFront uomCdConvTrgtLikeFront に設定する
     */
    public void setUomCdConvTrgtLikeFront(String uomCdConvTrgtLikeFront) {
        this.uomCdConvTrgtLikeFront = uomCdConvTrgtLikeFront;
    }
