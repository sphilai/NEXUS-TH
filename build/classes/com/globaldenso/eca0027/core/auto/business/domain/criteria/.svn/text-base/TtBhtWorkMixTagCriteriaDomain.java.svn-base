 ...
 * PROJECT：eca0027
 * 
 * TtBhtWorkMixTag の検索条件Domainクラス
 * テーブル概要：TT_BHT_WORK_MIX_TAG
 * 
...
/**
 * TtBhtWorkMixTag の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_BHT_WORK_MIX_TAG<BR>
 * 
 * <BR>
 ...
 */
public class TtBhtWorkMixTagCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtBhtWorkMixTagCriteriaDomain() {
    }
    ...
    /**
     * mixTagQty のゲッターメソッドです。
     * 
     * @return the mixTagQty
     */
    public BigDecimal getMixTagQty() {
        return mixTagQty;
    }

    /**
     * mixTagQty のセッターメソッドです。
     * 
     * @param mixTagQty mixTagQty に設定する
     */
    public void setMixTagQty(BigDecimal mixTagQty) {
        this.mixTagQty = mixTagQty;
    }
