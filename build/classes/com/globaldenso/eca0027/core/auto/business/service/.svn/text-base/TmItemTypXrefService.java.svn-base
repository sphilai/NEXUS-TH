 ...
 * PROJECT：eca0027
 * 
 * TmItemTypXref のServiceインターフェース
 * 
...
/**
 * TmItemTypXref のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmItemTypXrefService {
     ...
     * データを登録します。
     * 
     * @param domains tmItemTypXrefのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmItemTypXrefのDomainクラスのList
     * @param criteria tmItemTypXrefのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmItemTypXrefDomain> domains, List<TmItemTypXrefCriteriaDomain> criteria) throws ApplicationException;
