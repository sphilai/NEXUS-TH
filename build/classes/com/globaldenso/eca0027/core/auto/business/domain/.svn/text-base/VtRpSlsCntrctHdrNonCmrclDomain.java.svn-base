 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctHdrNonCmrcl のDomainクラス
...
/**
 * VtRpSlsCntrctHdrNonCmrcl のDomainクラスです。<BR>
 ...
 */
public class VtRpSlsCntrctHdrNonCmrclDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpSlsCntrctHdrNonCmrclDomain() {
    }
