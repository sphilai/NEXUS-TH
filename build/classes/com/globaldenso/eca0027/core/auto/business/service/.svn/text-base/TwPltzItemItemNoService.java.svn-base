 ...
 * PROJECT：eca0027
 * 
 * TwPltzItemItemNo のServiceインターフェース
 * 
...
/**
 * TwPltzItemItemNo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwPltzItemItemNoService {
     ...
     * データを登録します。
     * 
     * @param domains twPltzItemItemNoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twPltzItemItemNoのDomainクラスのList
     * @param criteria twPltzItemItemNoのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwPltzItemItemNoDomain> domains, List<TwPltzItemItemNoCriteriaDomain> criteria) throws ApplicationException;
