...
/**
 * TmTrnsTyp の検索条件Domainクラスです。<BR>
 * テーブル概要：TM_TRNS_TYP<BR>
 * 
 * <BR>
 ...
 */
public class TmTrnsTypCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TmTrnsTypCriteriaDomain() {
    }
