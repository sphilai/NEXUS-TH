 ...
 * PROJECT：eca0027
 * 
 * TmInvFreeItem のServiceインターフェース
 * 
...
/**
 * TmInvFreeItem のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmInvFreeItemService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmInvFreeItemの CriteriaDomain クラス
     * @return tmInvFreeItemのDomainクラス
     ...
     * 
     * @param criteria tmInvFreeItemの CriteriaDomain クラス
     * @return tmInvFreeItemのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain tmInvFreeItemのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmInvFreeItemのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmInvFreeItemのDomainクラス
     * @param criteria tmInvFreeItemのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmInvFreeItemのDomainクラスのList
     * @param criteria tmInvFreeItemのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmInvFreeItemDomain> domains, List<TmInvFreeItemCriteriaDomain> criteria) throws ApplicationException;
