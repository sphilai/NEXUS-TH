 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctHdrCmrcl のDomainクラス
...
/**
 * VtRpSlsCntrctHdrCmrcl のDomainクラスです。<BR>
 ...
 */
public class VtRpSlsCntrctHdrCmrclDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpSlsCntrctHdrCmrclDomain() {
    }
