 ...
 * PROJECT：eca0027
 * 
 * VtRpInvHdrForFrt の検索条件Domainクラス
 * テーブル概要：VT_RP_INV_HDR_FOR_FRT
 * 
...
/**
 * VtRpInvHdrForFrt の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_INV_HDR_FOR_FRT<BR>
 * 
 * <BR>
 ...
 */
public class VtRpInvHdrForFrtCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpInvHdrForFrtCriteriaDomain() {
    }
