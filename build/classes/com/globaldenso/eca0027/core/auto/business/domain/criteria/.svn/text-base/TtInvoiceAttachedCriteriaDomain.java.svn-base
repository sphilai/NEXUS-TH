 ...
 * PROJECT：eca0027
 * 
 * TtInvoiceAttached の検索条件Domainクラス
...
/**
 * TtInvoiceAttached の検索条件Domainクラスです。<BR>
 ...
 */
public class TtInvoiceAttachedCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * NET WEIGHT UNIT/ネット重量単位（大なり）
     */
    private String netWeightUnitGreaterThan;

    /**
     * NET WEIGHT UNIT/ネット重量単位（大なりイコール）
     */
    private String netWeightUnitGreaterThanEqual;

    /**
     * NET WEIGHT UNIT/ネット重量単位（小なり）
     */
    private String netWeightUnitLessThan;

    /**
     * NET WEIGHT UNIT/ネット重量単位（小なりイコール）
     */
    private String netWeightUnitLessThanEqual;

    /**
     * NET WEIGHT UNIT/ネット重量単位（前方一致）
     */
    private String netWeightUnitLikeFront;

    /**
     * TOTAL NET WEIGHT UNIT/ネット総重量_単位（大なり）
     */
    private String totalNetWeightUnitGreaterThan;

    /**
     * TOTAL NET WEIGHT UNIT/ネット総重量_単位（大なりイコール）
     */
    private String totalNetWeightUnitGreaterThanEqual;

    /**
     * TOTAL NET WEIGHT UNIT/ネット総重量_単位（小なり）
     */
    private String totalNetWeightUnitLessThan;

    /**
     * TOTAL NET WEIGHT UNIT/ネット総重量_単位（小なりイコール）
     */
    private String totalNetWeightUnitLessThanEqual;

    /**
     * TOTAL NET WEIGHT UNIT/ネット総重量_単位（前方一致）
     */
     ...
     * デフォルトコンストラクタ。
     */
    public TtInvoiceAttachedCriteriaDomain() {
    }
    ...
    /**
     * netWeightUnitGreaterThan のゲッターメソッドです。
     * 
     * @return the netWeightUnitGreaterThan
     */
    public String getNetWeightUnitGreaterThan() {
        return netWeightUnitGreaterThan;
    }

    /**
     * netWeightUnitGreaterThan のセッターメソッドです。
     * 
     * @param netWeightUnitGreaterThan netWeightUnitGreaterThan に設定する
     */
    public void setNetWeightUnitGreaterThan(String netWeightUnitGreaterThan) {
        this.netWeightUnitGreaterThan = netWeightUnitGreaterThan;
    }

    /**
     * netWeightUnitGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the netWeightUnitGreaterThanEqual
     */
    public String getNetWeightUnitGreaterThanEqual() {
        return netWeightUnitGreaterThanEqual;
    }

    /**
     * netWeightUnitGreaterThanEqual のセッターメソッドです。
     * 
     * @param netWeightUnitGreaterThanEqual netWeightUnitGreaterThanEqual に設定する
     */
    public void setNetWeightUnitGreaterThanEqual(String netWeightUnitGreaterThanEqual) {
        this.netWeightUnitGreaterThanEqual = netWeightUnitGreaterThanEqual;
    }

    /**
     * netWeightUnitLessThan のゲッターメソッドです。
     * 
     * @return the netWeightUnitLessThan
     */
    public String getNetWeightUnitLessThan() {
        return netWeightUnitLessThan;
    }

    /**
     * netWeightUnitLessThan のセッターメソッドです。
     * 
     * @param netWeightUnitLessThan netWeightUnitLessThan に設定する
     */
    public void setNetWeightUnitLessThan(String netWeightUnitLessThan) {
        this.netWeightUnitLessThan = netWeightUnitLessThan;
    }

    /**
     * netWeightUnitLessThanEqual のゲッターメソッドです。
     * 
     * @return the netWeightUnitLessThanEqual
     */
    public String getNetWeightUnitLessThanEqual() {
        return netWeightUnitLessThanEqual;
    }

    /**
     * netWeightUnitLessThanEqual のセッターメソッドです。
     * 
     * @param netWeightUnitLessThanEqual netWeightUnitLessThanEqual に設定する
     */
    public void setNetWeightUnitLessThanEqual(String netWeightUnitLessThanEqual) {
        this.netWeightUnitLessThanEqual = netWeightUnitLessThanEqual;
    }

    /**
     * netWeightUnitLikeFront のゲッターメソッドです。
     * 
     * @return the netWeightUnitLikeFront
     */
    public String getNetWeightUnitLikeFront() {
        return netWeightUnitLikeFront;
    }

    /**
     * netWeightUnitLikeFront のセッターメソッドです。
     * 
     * @param netWeightUnitLikeFront netWeightUnitLikeFront に設定する
     */
    public void setNetWeightUnitLikeFront(String netWeightUnitLikeFront) {
        this.netWeightUnitLikeFront = netWeightUnitLikeFront;
    }
