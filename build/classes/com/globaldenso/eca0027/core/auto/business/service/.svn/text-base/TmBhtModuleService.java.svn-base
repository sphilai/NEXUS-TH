...
/**
 * TmBhtModule のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmBhtModuleService {
     ...
     * データを登録します。
     * 
     * @param domains tmBhtModuleのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmBhtModuleのDomainクラスのList
     * @param criteria tmBhtModuleのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmBhtModuleDomain> domains, List<TmBhtModuleCriteriaDomain> criteria) throws ApplicationException;
