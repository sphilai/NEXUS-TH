 ...
 * PROJECT：eca0027
 * 
 * VtTrnsTypStgAct のServiceインターフェース
 * 
...
/**
 * VtTrnsTypStgAct のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtTrnsTypStgActService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtTrnsTypStgActの CriteriaDomain クラス
     * @return vtTrnsTypStgActのDomainクラスのList
