 ...
 * PROJECT：eca0027
 * 
 * VtRpInvAtchedForRt の検索条件Domainクラス
 * テーブル概要：VT_RP_INV_ATCHED_FOR_RT
 * 
...
/**
 * VtRpInvAtchedForRt の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_INV_ATCHED_FOR_RT<BR>
 * 
 * <BR>
 ...
 */
public class VtRpInvAtchedForRtCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpInvAtchedForRtCriteriaDomain() {
    }
