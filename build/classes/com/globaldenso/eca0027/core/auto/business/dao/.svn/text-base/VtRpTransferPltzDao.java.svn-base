...
/**
 * VtRpTransferPltz のDAOインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface VtRpTransferPltzDao {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpTransferPltzの CriteriaDomain クラス
     * @return vtRpTransferPltzのDomainクラスのList
