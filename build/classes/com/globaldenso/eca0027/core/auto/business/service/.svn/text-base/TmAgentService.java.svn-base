...
public interface TmAgentService {
     ...
     * データを登録します。
     * 
     * @param domains tmAgentのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmAgentのDomainクラスのList
     * @param criteria tmAgentのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmAgentDomain> domains, List<TmAgentCriteriaDomain> criteria) throws ApplicationException;
