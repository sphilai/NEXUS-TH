...
/**
 * TtExpRequestPltzRt のDomainクラスです。<BR>
 ...
 */
public class TtExpRequestPltzRtDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtExpRequestPltzRtDomain() {
    }
