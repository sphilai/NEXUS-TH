...
/**
 * TtScAttached のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtScAttachedService {
     ...
     * データを登録します。
     * 
     * @param domains ttScAttachedのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttScAttachedのDomainクラスのList
     * @param criteria ttScAttachedのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtScAttachedDomain> domains, List<TtScAttachedCriteriaDomain> criteria) throws ApplicationException;
