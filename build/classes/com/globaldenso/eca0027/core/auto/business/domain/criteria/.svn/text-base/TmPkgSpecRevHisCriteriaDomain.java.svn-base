 ...
 * PROJECT：eca0027
 * 
 * TmPkgSpecRevHis の検索条件Domainクラス
 * テーブル概要：Package Specification Revision History Master/包装仕様有効リビジョン履歴原単位  Master you want to keep the changes history of packaging specifications valid revision Master/包装仕様有効リビジョンMasterの変更履歴を保持するMaster
 * 
...
/**
 * TmPkgSpecRevHis の検索条件Domainクラスです。<BR>
 * テーブル概要：Package Specification Revision History Master/包装仕様有効リビジョン履歴原単位  Master you want to keep the changes history of packaging specifications valid revision Master/包装仕様有効リビジョンMasterの変更履歴を保持するMaster<BR>
 * 
 * <BR>
 ...
 */
public class TmPkgSpecRevHisCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * NEXT PROCESS/次区（小なりイコール）
     */
    private String nProcLessThanEqual;

    /**
     * NEXT PROCESS/次区（前方一致）
     */
     ...
     * デフォルトコンストラクタ。
     */
    public TmPkgSpecRevHisCriteriaDomain() {
    }
