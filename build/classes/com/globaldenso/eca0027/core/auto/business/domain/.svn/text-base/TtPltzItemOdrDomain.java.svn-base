 ...
 * PROJECT：eca0027
 * 
 * TtPltzItemOdr のDomainクラス
 * テーブル概要：TT_PLTZ_ITEM_ODR
 * 
...
/**
 * TtPltzItemOdr のDomainクラスです。<BR>
 * テーブル概要：TT_PLTZ_ITEM_ODR<BR>
 * 
 * <BR>
 ...
 */
public class TtPltzItemOdrDomain extends AbstractDomain implements Serializable {
