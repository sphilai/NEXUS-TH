 ...
 * PROJECT：eca0027
 * 
 * VmRpPrinterPurpose のServiceインターフェース
 * 
...
/**
 * VmRpPrinterPurpose のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VmRpPrinterPurposeService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vmRpPrinterPurposeの CriteriaDomain クラス
     * @return vmRpPrinterPurposeのDomainクラスのList
