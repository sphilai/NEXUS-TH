...
/**
 * TmNxsComp のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmNxsCompService {
     ...
     * データを登録します。
     * 
     * @param domains tmNxsCompのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmNxsCompのDomainクラスのList
     * @param criteria tmNxsCompのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmNxsCompDomain> domains, List<TmNxsCompCriteriaDomain> criteria) throws ApplicationException;
