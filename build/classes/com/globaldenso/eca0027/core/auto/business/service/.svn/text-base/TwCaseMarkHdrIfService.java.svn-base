 ...
 * PROJECT：eca0027
 * 
 * TwCaseMarkHdrIf のServiceインターフェース
 * 
...
/**
 * TwCaseMarkHdrIf のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwCaseMarkHdrIfService {
     ...
     * データを登録します。
     * 
     * @param domains twCaseMarkHdrIfのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twCaseMarkHdrIfのDomainクラスのList
     * @param criteria twCaseMarkHdrIfのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwCaseMarkHdrIfDomain> domains, List<TwCaseMarkHdrIfCriteriaDomain> criteria) throws ApplicationException;
