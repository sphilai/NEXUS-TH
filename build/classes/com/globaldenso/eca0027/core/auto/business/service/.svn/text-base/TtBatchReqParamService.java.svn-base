 ...
 * PROJECT：eca0027
 * 
 * TtBatchReqParam のServiceインターフェース
 * 
...
/**
 * TtBatchReqParam のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtBatchReqParamService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria ttBatchReqParamの CriteriaDomain クラス
     * @return ttBatchReqParamのDomainクラス
     ...
     * 
     * @param criteria ttBatchReqParamの CriteriaDomain クラス
     * @return ttBatchReqParamのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain ttBatchReqParamのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains ttBatchReqParamのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain ttBatchReqParamのDomainクラス
     * @param criteria ttBatchReqParamのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttBatchReqParamのDomainクラスのList
     * @param criteria ttBatchReqParamのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtBatchReqParamDomain> domains, List<TtBatchReqParamCriteriaDomain> criteria) throws ApplicationException;
