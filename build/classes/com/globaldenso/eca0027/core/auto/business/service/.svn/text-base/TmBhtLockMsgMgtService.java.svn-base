 ...
 * PROJECT：eca0027
 * 
 * TmBhtLockMsgMgt のServiceインターフェース
 * 
...
/**
 * TmBhtLockMsgMgt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmBhtLockMsgMgtService {
     ...
     * データを登録します。
     * 
     * @param domains tmBhtLockMsgMgtのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmBhtLockMsgMgtのDomainクラスのList
     * @param criteria tmBhtLockMsgMgtのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmBhtLockMsgMgtDomain> domains, List<TmBhtLockMsgMgtCriteriaDomain> criteria) throws ApplicationException;
