 ...
 * PROJECT：eca0027
 * 
 * VtRpInvHdrForCmrclIntang のDomainクラス
...
/**
 * VtRpInvHdrForCmrclIntang のDomainクラスです。<BR>
 ...
 */
public class VtRpInvHdrForCmrclIntangDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpInvHdrForCmrclIntangDomain() {
    }
