...
/**
 * TtScHeader の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_SC_HEADER<BR>
 * 
 * <BR>
 ...
 */
public class TtScHeaderCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtScHeaderCriteriaDomain() {
    }
