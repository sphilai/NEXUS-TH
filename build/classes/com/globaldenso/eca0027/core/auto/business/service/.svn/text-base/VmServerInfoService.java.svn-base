...
/**
 * VmServerInfo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VmServerInfoService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vmServerInfoの CriteriaDomain クラス
     * @return vmServerInfoのDomainクラスのList
