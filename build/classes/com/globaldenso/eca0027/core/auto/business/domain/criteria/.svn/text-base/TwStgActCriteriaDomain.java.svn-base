...
/**
 * TwStgAct の検索条件Domainクラスです。<BR>
 * テーブル概要：TW_STG_ACT<BR>
 * 
 * <BR>
 ...
 */
public class TwStgActCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * MAIN_MARK_TYP（大なり）
     */
    private String mainMarkTypGreaterThan;

    /**
     * MAIN_MARK_TYP（大なりイコール）
     */
    private String mainMarkTypGreaterThanEqual;

    /**
     * MAIN_MARK_TYP（小なり）
     */
    private String mainMarkTypLessThan;

    /**
     * MAIN_MARK_TYP（小なりイコール）
     */
    private String mainMarkTypLessThanEqual;

    /**
     * MAIN_MARK_TYP（前方一致）
     */
    private String mainMarkTypLikeFront;
    ...
    /**
     * mainMarkTyp のセッターメソッドです。
     * 
     * @param mainMarkTyp mainMarkTyp に設定する
     */
    ...
    /**
     * mainMarkTypGreaterThan のゲッターメソッドです。
     * 
     * @return the mainMarkTypGreaterThan
     */
    public String getMainMarkTypGreaterThan() {
        return mainMarkTypGreaterThan;
    }

    /**
     * mainMarkTypGreaterThan のセッターメソッドです。
     * 
     * @param mainMarkTypGreaterThan mainMarkTypGreaterThan に設定する
     */
    public void setMainMarkTypGreaterThan(String mainMarkTypGreaterThan) {
        this.mainMarkTypGreaterThan = mainMarkTypGreaterThan;
    }

    /**
     * mainMarkTypGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the mainMarkTypGreaterThanEqual
     */
    public String getMainMarkTypGreaterThanEqual() {
        return mainMarkTypGreaterThanEqual;
    }

    /**
     * mainMarkTypGreaterThanEqual のセッターメソッドです。
     * 
     * @param mainMarkTypGreaterThanEqual mainMarkTypGreaterThanEqual に設定する
     */
    public void setMainMarkTypGreaterThanEqual(String mainMarkTypGreaterThanEqual) {
        this.mainMarkTypGreaterThanEqual = mainMarkTypGreaterThanEqual;
    }

    /**
     * mainMarkTypLessThan のゲッターメソッドです。
     * 
     * @return the mainMarkTypLessThan
     */
    public String getMainMarkTypLessThan() {
        return mainMarkTypLessThan;
    }

    /**
     * mainMarkTypLessThan のセッターメソッドです。
     * 
     * @param mainMarkTypLessThan mainMarkTypLessThan に設定する
     */
    public void setMainMarkTypLessThan(String mainMarkTypLessThan) {
        this.mainMarkTypLessThan = mainMarkTypLessThan;
    }

    /**
     * mainMarkTypLessThanEqual のゲッターメソッドです。
     * 
     * @return the mainMarkTypLessThanEqual
     */
    public String getMainMarkTypLessThanEqual() {
        return mainMarkTypLessThanEqual;
    }

    /**
     * mainMarkTypLessThanEqual のセッターメソッドです。
     * 
     * @param mainMarkTypLessThanEqual mainMarkTypLessThanEqual に設定する
     */
    public void setMainMarkTypLessThanEqual(String mainMarkTypLessThanEqual) {
        this.mainMarkTypLessThanEqual = mainMarkTypLessThanEqual;
    }

    /**
     * mainMarkTypLikeFront のゲッターメソッドです。
     * 
     * @return the mainMarkTypLikeFront
     */
    public String getMainMarkTypLikeFront() {
        return mainMarkTypLikeFront;
    }

    /**
     * mainMarkTypLikeFront のセッターメソッドです。
     * 
     * @param mainMarkTypLikeFront mainMarkTypLikeFront に設定する
     */
    public void setMainMarkTypLikeFront(String mainMarkTypLikeFront) {
        this.mainMarkTypLikeFront = mainMarkTypLikeFront;
    }
