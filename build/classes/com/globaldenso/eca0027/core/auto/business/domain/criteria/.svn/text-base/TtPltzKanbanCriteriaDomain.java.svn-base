 ...
 * PROJECT：eca0027
 * 
 * TtPltzKanban の検索条件Domainクラス
 * テーブル概要：TT_PLTZ_KANBAN
 * 
...
/**
 * TtPltzKanban の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_PLTZ_KANBAN<BR>
 * 
 * <BR>
 ...
 */
public class TtPltzKanbanCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtPltzKanbanCriteriaDomain() {
    }
