 ...
 */
public interface TmCntryService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmCntryの CriteriaDomain クラス
     * @return tmCntryのDomainクラス
     ...
     * データを登録します。
     * 
     * @param domain tmCntryのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmCntryのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmCntryのDomainクラス
     * @param criteria tmCntryのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmCntryのDomainクラスのList
     * @param criteria tmCntryのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmCntryDomain> domains, List<TmCntryCriteriaDomain> criteria) throws ApplicationException;
