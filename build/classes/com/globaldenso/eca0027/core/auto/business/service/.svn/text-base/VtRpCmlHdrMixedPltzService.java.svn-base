 ...
 * PROJECT：eca0027
 * 
 * VtRpCmlHdrMixedPltz のServiceインターフェース
 * 
...
/**
 * VtRpCmlHdrMixedPltz のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpCmlHdrMixedPltzService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpCmlHdrMixedPltzの CriteriaDomain クラス
     * @return vtRpCmlHdrMixedPltzのDomainクラスのList
