...
/**
 * TmCigmaEnv のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmCigmaEnvService {
     ...
     * データを登録します。
     * 
     * @param domains tmCigmaEnvのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmCigmaEnvのDomainクラスのList
     * @param criteria tmCigmaEnvのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmCigmaEnvDomain> domains, List<TmCigmaEnvCriteriaDomain> criteria) throws ApplicationException;
