 ...
 * PROJECT：eca0027
 * 
 * TmBhtResourceFile のServiceインターフェース
 * 
...
/**
 * TmBhtResourceFile のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmBhtResourceFileService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmBhtResourceFileの CriteriaDomain クラス
     * @return tmBhtResourceFileのDomainクラス
     ...
     * 
     * @param criteria tmBhtResourceFileの CriteriaDomain クラス
     * @return tmBhtResourceFileのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain tmBhtResourceFileのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmBhtResourceFileのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmBhtResourceFileのDomainクラス
     * @param criteria tmBhtResourceFileのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmBhtResourceFileのDomainクラスのList
     * @param criteria tmBhtResourceFileのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmBhtResourceFileDomain> domains, List<TmBhtResourceFileCriteriaDomain> criteria) throws ApplicationException;
