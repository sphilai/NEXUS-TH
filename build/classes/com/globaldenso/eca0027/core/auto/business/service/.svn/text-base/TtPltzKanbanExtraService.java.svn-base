 ...
 * PROJECT：eca0027
 * 
 * TtPltzKanbanExtra のServiceインターフェース
 * 
...
/**
 * TtPltzKanbanExtra のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface TtPltzKanbanExtraService {
     ...
     * データを登録します。
     * 
     * @param domains ttPltzKanbanExtraのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttPltzKanbanExtraのDomainクラスのList
     * @param criteria ttPltzKanbanExtraのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtPltzKanbanExtraDomain> domains, List<TtPltzKanbanExtraCriteriaDomain> criteria) throws ApplicationException;
