 ...
 * PROJECT：eca0027
 * 
 * TwTransferItemPltz の検索条件Domainクラス
...
/**
 * TwTransferItemPltz の検索条件Domainクラスです。<BR>
 ...
 * @version $Revision$
 */
public class TwTransferItemPltzCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TwTransferItemPltzCriteriaDomain() {
    }
