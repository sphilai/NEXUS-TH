 ...
 * PROJECT：eca0027
 * 
 * TtMixtagOdr の検索条件Domainクラス
 * テーブル概要：TT_MIXTAG_ODR
 * 
...
/**
 * TtMixtagOdr の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_MIXTAG_ODR<BR>
 * 
 * <BR>
 ...
 */
public class TtMixtagOdrCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtMixtagOdrCriteriaDomain() {
    }
