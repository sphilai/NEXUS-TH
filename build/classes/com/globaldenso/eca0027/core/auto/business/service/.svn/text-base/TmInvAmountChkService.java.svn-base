 ...
 * PROJECT：eca0027
 * 
 * TmInvAmountChk のServiceインターフェース
 * 
...
/**
 * TmInvAmountChk のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmInvAmountChkService {
     ...
     * データを登録します。
     * 
     * @param domains tmInvAmountChkのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmInvAmountChkのDomainクラスのList
     * @param criteria tmInvAmountChkのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmInvAmountChkDomain> domains, List<TmInvAmountChkCriteriaDomain> criteria) throws ApplicationException;
