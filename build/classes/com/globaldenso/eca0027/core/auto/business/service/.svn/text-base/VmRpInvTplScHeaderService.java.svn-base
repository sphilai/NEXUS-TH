 ...
 * PROJECT：eca0027
 * 
 * VmRpInvTplScHeader のServiceインターフェース
 * 
...
/**
 * VmRpInvTplScHeader のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VmRpInvTplScHeaderService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vmRpInvTplScHeaderの CriteriaDomain クラス
     * @return vmRpInvTplScHeaderのDomainクラスのList
