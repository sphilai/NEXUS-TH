...
/**
 * TtExpRequest のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtExpRequestService {
     ...
     * データを登録します。
     * 
     * @param domains ttExpRequestのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain ttExpRequestのDomainクラス
     * @param criteria ttExpRequestのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttExpRequestのDomainクラスのList
     * @param criteria ttExpRequestのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtExpRequestDomain> domains, List<TtExpRequestCriteriaDomain> criteria) throws ApplicationException;
