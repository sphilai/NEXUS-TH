 ...
 * PROJECT：eca0027
 * 
 * VtRpPackHdrForMain の検索条件Domainクラス
 * テーブル概要：VT_RP_PACK_HDR_FOR_MAIN
 * 
...
/**
 * VtRpPackHdrForMain の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_PACK_HDR_FOR_MAIN<BR>
 * 
 * <BR>
 ...
 */
public class VtRpPackHdrForMainCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpPackHdrForMainCriteriaDomain() {
    }
