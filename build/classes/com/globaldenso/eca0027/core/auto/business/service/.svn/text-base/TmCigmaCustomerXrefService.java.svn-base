 ...
 * PROJECT：eca0027
 * 
 * TmCigmaCustomerXref のServiceインターフェース
 * 
...
/**
 * TmCigmaCustomerXref のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmCigmaCustomerXrefService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmCigmaCustomerXrefの CriteriaDomain クラス
     * @return tmCigmaCustomerXrefのDomainクラス
     ...
     * 
     * @param criteria tmCigmaCustomerXrefの CriteriaDomain クラス
     * @return tmCigmaCustomerXrefのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain tmCigmaCustomerXrefのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmCigmaCustomerXrefのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmCigmaCustomerXrefのDomainクラス
     * @param criteria tmCigmaCustomerXrefのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmCigmaCustomerXrefのDomainクラスのList
     * @param criteria tmCigmaCustomerXrefのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmCigmaCustomerXrefDomain> domains, List<TmCigmaCustomerXrefCriteriaDomain> criteria) throws ApplicationException;
