 ...
 * PROJECT：eca0027
 * 
 * VtRpInvHdrForNonCmrcl のServiceインターフェース
 * 
...
/**
 * VtRpInvHdrForNonCmrcl のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpInvHdrForNonCmrclService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpInvHdrForNonCmrclの CriteriaDomain クラス
     * @return vtRpInvHdrForNonCmrclのDomainクラスのList
