...
/**
 * TtMixtagRt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtMixtagRtService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria ttMixtagRtの CriteriaDomain クラス
     * @return ttMixtagRtのDomainクラス
     ...
     * 
     * @param criteria ttMixtagRtの CriteriaDomain クラス
     * @return ttMixtagRtのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain ttMixtagRtのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains ttMixtagRtのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain ttMixtagRtのDomainクラス
     * @param criteria ttMixtagRtのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttMixtagRtのDomainクラスのList
     * @param criteria ttMixtagRtのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtMixtagRtDomain> domains, List<TtMixtagRtCriteriaDomain> criteria) throws ApplicationException;
