...
/**
 * L6014ReportServiceImplの単体テストクラスです。
 *
 * @author $Author: 10088DS01586 $
 * @version $Revision: 5759 $
 */
public class L6014ReportServiceTest extends AbstractEca0027Test {

    /**
     * Type in the role of the field.
     */
    private L6014ReportService l6014ReportService;
    ...
    public void setUp() throws Exception {
        l6014ReportService = (L6014ReportService) getContext().getBean("l6014ReportService");
...
//        File file = l6014ReportService.searchSalesCntrctAtchedForMain(shipper, invoiceNo, invoiceIssueDt, invoiceTemplateNo, "UTF-8", "yyyy/MM/dd");
//        assertNotNull(file);
//    }
//    
//    /**
...
//        try {
//            l6014ReportService.searchSalesCntrctAtchedForMain(shipper, invoiceNo, invoiceIssueDt, invoiceTemplateNo, "UTF-8", "yyyy/MM/dd");
//            fail("この行は、実行されないはず");
...
//        String invoiceTemplateNo = "1";
//        try {
//            l6014ReportService.searchSalesCntrctAtchedForMain(shipper, invoiceNo, invoiceIssueDt, invoiceTemplateNo, "aaaa", "yyyy/MM/dd");
//            fail("この行は、実行されないはず");
...
//        MockObjectManager.setReturnValueAtAllTimes(L6014ReportServiceImpl.class, "getFileDomain", new IOException());
//        Date invoiceIssueDt = DateUtil.parseDate("2014/02/07 1:00:00", "yyyy/MM/dd HH:mm:ss");
//        try {
//            l6014ReportService.searchSalesCntrctAtchedForMain("1", "1", invoiceIssueDt, "1", "UTF-8", "yyyy/MM/dd");
//            fail("この行は、実行されないはず");
//        } catch (SystemException e) {
//            assertEquals(NXS_91_0001, e.getMessage());
//        } 
...
//        MockObjectManager.setReturnValueAtAllTimes(L6014ReportServiceImpl.class, "getOutputStream", new ByteArrayOutputStream());
//        Date invoiceIssueDt = DateUtil.parseDate("2014/02/07 1:00:00", "yyyy/MM/dd HH:mm:ss");
//        try {
//            l6014ReportService.searchSalesCntrctAtchedForMain("1", "1", invoiceIssueDt, "1", "UTF-8", "yyyy/MM/dd");
//            fail("この行は、実行されないはず");
...
//            e.printStackTrace();
//        }
//        MockObjectManager.setReturnValueAtAllTimes(L6014ReportServiceImpl.class, "getFileDomain", fileDomain );
        // テスト用データ
        String shipper = "1";
        String invoiceNo = "1";
        Date invoiceIssueDt = DateUtil.parseDate("2014/02/07 1:00:00", "yyyy/MM/dd HH:mm:ss");
        String invoiceTemplateNo = "1";
        File report = l6014ReportService.searchSalesCntrctAtchedForMain(shipper, invoiceNo, invoiceIssueDt, invoiceTemplateNo, "UTF-8", "yyyy/MM/dd");
