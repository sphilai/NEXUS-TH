 ...
 */
public class L6008ReportAsiaServiceTest extends AbstractEca0027Test {

    /**
     * Type in the role of the field.
     */
    private L6008ReportAsiaService l6008ReportAsiaService;
     ...
     * デフォルトコンストラクタ。
     */
    public L6008ReportAsiaServiceTest() {
    }
    ...
    public void setUp() throws Exception {
        l6008ReportAsiaService = (L6008ReportAsiaService) getContext().getBean("l6008ReportAsiaService");
...
//        MockObjectManager.setReturnValueAtAllTimes(L6008ReportServiceImpl.class, "getFileDomain", fileDomain );
        // テスト用データ
        String shipper = "TG0";
        String invoiceNo = "692712";
        Date invoiceIssueDt = null;
        String invoiceTemplateNo = "1";
        System.out.println("==============+==================");
        File report = l6008ReportAsiaService.searchPackAtchedForMain(shipper, invoiceNo, invoiceIssueDt, invoiceTemplateNo, "yyyy/MM/dd", "UTF-8");
        System.out.println("==============*==================");
