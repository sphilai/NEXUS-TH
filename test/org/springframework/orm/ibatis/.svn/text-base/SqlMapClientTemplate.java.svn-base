...
/*
 * iBatisに対して、djUnitのMockObjectManagerを利用可能にするために追加したソースコードです。
 * ソースコードについては下記URLより取得しました。
 * 
 * http://grepcode.com/snapshot/repository.springsource.com/org.apache.ibatis/com.springsource.com.ibatis/2.3.4.726
 */
