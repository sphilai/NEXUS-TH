...
<b>Unexpected error occurred.</b><br />
<ul type="square">
<li>System name : NEXUS</li>
<li>ID : ${ID}</li>
<li>Occurred date : <fmt:formatDate value="${DATE}" pattern="yyyy-MM-dd HH:mm:ss.SSS"/></li>
</ul>
<br />
We have contacted to system administrator already.<br />
<br />
You may be able to reuse system by following processing.<br />
<ul>
<li>Please close all browser, and connect to system by new browser for connect to system properly.</li>
</ul>
