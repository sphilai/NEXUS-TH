 ...
 * W2006.js
 *
 * Mixtag-Header画面で用いるJavaScriptです。
 *
...
function setUp() {
        ...
        if (value == "Y") {
            ...
            $("#shipper_cd").removeClass("gscm_required");
            $("#customer_cd").val("");
            $("#customer_cd").prop('disabled', true);
            $("#customer_cd").removeClass("gscm_required");
            $("#lgcy_ship_to").val("");
            $("#lgcy_ship_to").prop('disabled', true);
            $("#lgcy_ship_to").removeClass("gscm_required");
            $("select#trns_cd").prop('disabled', true);
            $("select#trns_cd").val("");
            $("select#trns_cd").removeClass("gscm_required");
            $("select#plnt_and_wh_declaration").val("");
            $("select#plnt_and_wh_declaration").prop('disabled', true);
            $("select#plnt_and_wh_declaration").removeClass("gscm_required");
            $("#plnt_cd").val("");
            ...
            $("#wh_comp_cd").val("");
            $("#wh_comp_cd").prop('disabled', true);
            $("#wh_comp_cd").removeClass("gscm_required");
            $("#wh_cd").val("");
            $("#wh_cd").prop('disabled', true);
            $("#wh_cd").removeClass("gscm_required");
        } else if (value == "N") {
            // "N"の場合に、各項目について、活性・非活性にする
            $("#pltz_instr_no").val("");
            $("#pltz_instr_no").prop('disabled', true);
            $("#pltz_instr_no").removeClass("gscm_required");
            $("#shipper_cd").val("");
...
function setUpForPlntAndWhDeclaration() {
        ...
        if (value == "1") {
            ...
            $("#lgcy_wh_cd").removeClass("gscm_required");
            $("#wh_comp_cd").val("");
            $("#wh_comp_cd").prop('disabled', false);
            $("#wh_comp_cd").addClass("gscm_required");
            $("#wh_cd").val("");
            $("#wh_cd").prop('disabled', false);
            $("#wh_cd").addClass("gscm_required");
        } else {
            // 未入力の場合に、各項目について、非活性にする
            $("#plnt_cd").val("");
            $("#plnt_cd").prop('disabled', true);
