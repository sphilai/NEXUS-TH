@echo off
REM ****************************************************************************
REM ** [JP]  ファイル名 : aijbResidentJobLauncher_with_wily.bat
REM ** [JP]  処理概要   : 常駐ジョブを起動する共通のバッチです。(wily起動オプションつき)
REM ** [JP]
REM ** [JP]    AijbMainControllerから起動する全ての常駐ジョブは
REM ** [JP]    このバッチから起動させます。
REM ** [JP]
REM ** [JP]   【引数】
REM ** [JP]      %1 : ジョブで使用する Spring 設定ファイル(フルパス)
REM ** [JP]          例) /com/globaldenso/ai/aijb/job/queuecreate/jobcontrol/applicationContext-queuecreate.xml
REM ** [JP]
REM ** [JP]      %2 : 実行するジョブID
REM ** [JP]
REM ** [JP]      %3 : 実行するキューID
REM **
REM ** [EN]  File name             : aijbResidentJobLauncher_with_wily.bat
REM ** [EN]  Outline of processing : It is common batch resident job to start. (with startup options wily)
REM ** [EN]
REM ** [EN]    All resident job to boot from AijbMainController is to boot from this batch.
REM ** [EN]
REM ** [EN]   【Argument】
REM ** [EN]      %1 : Spring configuration file for the job (Full path)
REM ** [EN]          Example) /com/globaldenso/ai/aijb/job/queuecreate/jobcontrol/applicationContext-queuecreate.xml
REM ** [EN]
...
REM **
REM **  $ aijbResidentJobLauncher_with_wily.bat 7360 2014-03-17 01:09:00Z HIDETOSHI_NAKATANI@denso.co.jp $
REM **
REM ****************************************************************************
...
set EXECUTE_CLASS=com.globaldenso.ai.aijb.core.job.control.ResidentProcMain
...
javaw -Xrs -Xmx%JAVA_XMX%m -Xms%JAVA_XMS%m -XX:PermSize=%JAVA_PERMSIZE%m -Dlog4j.configuration=%LOG_XML% -Dcom.wily.introscope.agentProfile=D:\WilyAgent9.1\wily\core\config\IntroscopeAgent.profile -javaagent:D:\WilyAgent9.1\wily\Agent.jar %EXECUTE_CLASS% %1 %3 >> %BATCH_LOG_DIR%\%2\%3.log
exit
