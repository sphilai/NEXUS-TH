#!/bin/bash
# ****************************************************************************
# ** [JP]  ファイル名 : aijbResidentJobLauncher.sh
# ** [JP]  処理概要   : 常駐ジョブを起動する共通のバッチです。
# ** [JP]
...
# ** [JP]      $3 : 実行するキューID
# **
# ** [EN]  File name             : aijbResidentJobLauncher.sh
# ** [EN]  Outline of processing : It is common batch resident job to start.
# ** [EN]
...
# **
# **  $ aijbResidentJobLauncher.sh 4409 2013-05-23 01:46:18Z hiroko_nagata@dnitsol.com $
# **
# ****************************************************************************
