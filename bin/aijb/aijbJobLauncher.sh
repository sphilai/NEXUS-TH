#!/bin/bash
# ****************************************************************************
# ** [JP]  ファイル名 : aijbJobLauncher.sh
# ** [JP]  処理概要   : スケジュール/リクエストジョブを起動する共通のバッチです。
# ** [JP]
# ** [JP]    AijbMainControllerから起動する全てのスケジュール/リクエストジョブは
# ** [JP]    このバッチから起動させます。
# ** [JP]
# ** [JP]   【引数】
...
# ** [JP]      $3 : 実行するキューID
# **
# ** [EN]  File name : aijbJobLauncher.sh
# ** [EN]  Outline of processing   : It is common to start the batch schedule job / request job.
# ** [EN]
# ** [EN]    All schedule jobs / request jobs from AijbMainController start, launch from this batch.
# ** [EN]
# ** [EN]   【Argument】
...
# **
# **  $ aijbJobLauncher.sh 4409 2013-05-23 01:46:18Z hiroko_nagata@dnitsol.com $
# **
# ****************************************************************************
...
EXECUTE_CLASS=com.globaldenso.ai.aijb.core.job.control.JobLauncher
...
# [EN] ==== Starting job ========================================
export CLASSPATH
${JAVA_HOME}/bin/java -Xrs -Xmx${JAVA_XMX}m -Xms${JAVA_XMS}m -XX:PermSize=${JAVA_PERMSIZE}m -Dlog4j.configuration=${LOG_XML} ${EXECUTE_CLASS} $1 $3 >> ${BATCH_LOG_DIR}/$2/$3.log
exit
