@echo off
REM ****************************************************************************
REM ** [JP]  ファイル名 : aijbResidentJobLauncher.bat
REM ** [JP]  処理概要   : 常駐ジョブを起動する共通のバッチです。
REM ** [JP]
...
REM ** [JP]      %3 : 実行するキューID
REM **
REM ** [EN]  File name               : aijbResidentJobLauncher.bat
REM ** [EN]  Outline of processing   : It is common batch resident job to start.
REM ** [EN]
...
REM **
REM **  $ aijbResidentJobLauncher.bat 4409 2013-05-23 01:46:18Z hiroko_nagata@dnitsol.com $
REM **
REM ****************************************************************************
...
javaw -Xrs -Xmx%JAVA_XMX%m -Xms%JAVA_XMS%m -XX:PermSize=%JAVA_PERMSIZE%m -Dlog4j.configuration=%LOG_XML% %EXECUTE_CLASS% %1 %3 >> %BATCH_LOG_DIR%\%2\%3.log
exit
