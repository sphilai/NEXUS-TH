...
/**
 * TmCurrency のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmCurrencyService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmCurrencyの CriteriaDomain クラス
     * @return tmCurrencyのDomainクラス
     ...
     * 
     * @param criteria tmCurrencyの CriteriaDomain クラス
     * @return tmCurrencyのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain tmCurrencyのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmCurrencyのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmCurrencyのDomainクラス
     * @param criteria tmCurrencyのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmCurrencyのDomainクラスのList
     * @param criteria tmCurrencyのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmCurrencyDomain> domains, List<TmCurrencyCriteriaDomain> criteria) throws ApplicationException;
