 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctAtchedRt のServiceインターフェース
 * 
...
/**
 * VtRpSlsCntrctAtchedRt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpSlsCntrctAtchedRtService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpSlsCntrctAtchedRtの CriteriaDomain クラス
     * @return vtRpSlsCntrctAtchedRtのDomainクラスのList
