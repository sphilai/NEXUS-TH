 ...
 * PROJECT：eca0027
 * 
 * VtShippingFirm のServiceインターフェース
 * 
...
/**
 * VtShippingFirm のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtShippingFirmService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtShippingFirmの CriteriaDomain クラス
     * @return vtShippingFirmのDomainクラスのList
