 ...
 * PROJECT：eca0027
 * 
 * TmExpItemNoSpInfo のServiceインターフェース
 * 
...
/**
 * TmExpItemNoSpInfo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmExpItemNoSpInfoService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmExpItemNoSpInfoの CriteriaDomain クラス
     * @return tmExpItemNoSpInfoのDomainクラス
     ...
     * 
     * @param criteria tmExpItemNoSpInfoの CriteriaDomain クラス
     * @return tmExpItemNoSpInfoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain tmExpItemNoSpInfoのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmExpItemNoSpInfoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmExpItemNoSpInfoのDomainクラス
     * @param criteria tmExpItemNoSpInfoのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmExpItemNoSpInfoのDomainクラスのList
     * @param criteria tmExpItemNoSpInfoのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmExpItemNoSpInfoDomain> domains, List<TmExpItemNoSpInfoCriteriaDomain> criteria) throws ApplicationException;
