 ...
 * PROJECT：eca0027
 * 
 * TmFncUseAuthCnf のServiceインターフェース
 * 
...
/**
 * TmFncUseAuthCnf のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmFncUseAuthCnfService {
     ...
     * データを登録します。
     * 
     * @param domains tmFncUseAuthCnfのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmFncUseAuthCnfのDomainクラスのList
     * @param criteria tmFncUseAuthCnfのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmFncUseAuthCnfDomain> domains, List<TmFncUseAuthCnfCriteriaDomain> criteria) throws ApplicationException;
