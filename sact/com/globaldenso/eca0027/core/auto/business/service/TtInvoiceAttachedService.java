 ...
 * PROJECT：eca0027
 * 
 * TtInvoiceAttached のServiceインターフェース
 * 
...
/**
 * TtInvoiceAttached のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtInvoiceAttachedService {
     ...
     * データを登録します。
     * 
     * @param domains ttInvoiceAttachedのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttInvoiceAttachedのDomainクラスのList
     * @param criteria ttInvoiceAttachedのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtInvoiceAttachedDomain> domains, List<TtInvoiceAttachedCriteriaDomain> criteria) throws ApplicationException;
