 ...
 * PROJECT：eca0027
 * 
 * VtRpPackHdrForFrt のServiceインターフェース
 * 
...
/**
 * VtRpPackHdrForFrt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpPackHdrForFrtService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpPackHdrForFrtの CriteriaDomain クラス
     * @return vtRpPackHdrForFrtのDomainクラスのList
