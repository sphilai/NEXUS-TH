...
/**
 * TtPltzItem のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtPltzItemService {
     ...
     * データを登録します。
     * 
     * @param domains ttPltzItemのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttPltzItemのDomainクラスのList
     * @param criteria ttPltzItemのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtPltzItemDomain> domains, List<TtPltzItemCriteriaDomain> criteria) throws ApplicationException;
