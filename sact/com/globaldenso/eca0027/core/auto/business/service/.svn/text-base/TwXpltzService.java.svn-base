 ...
 */
public interface TwXpltzService {
     ...
     * データを登録します。
     * 
     * @param domains twXpltzのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twXpltzのDomainクラスのList
     * @param criteria twXpltzのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwXpltzDomain> domains, List<TwXpltzCriteriaDomain> criteria) throws ApplicationException;
