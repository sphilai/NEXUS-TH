 ...
 * PROJECT：eca0027
 * 
 * VtRpPackAtchedForFrt のServiceインターフェース
 * 
...
/**
 * VtRpPackAtchedForFrt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpPackAtchedForFrtService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpPackAtchedForFrtの CriteriaDomain クラス
     * @return vtRpPackAtchedForFrtのDomainクラスのList
