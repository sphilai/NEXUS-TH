 ...
 * PROJECT：eca0027
 * 
 * VmRpInvTplPkgHeader のServiceインターフェース
 * 
...
/**
 * VmRpInvTplPkgHeader のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VmRpInvTplPkgHeaderService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vmRpInvTplPkgHeaderの CriteriaDomain クラス
     * @return vmRpInvTplPkgHeaderのDomainクラスのList
