 ...
 * PROJECT：eca0027
 * 
 * VtRpTransferItemNo のServiceインターフェース
 * 
...
/**
 * VtRpTransferItemNo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public interface VtRpTransferItemNoService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpTransferItemNoの CriteriaDomain クラス
     * @return vtRpTransferItemNoのDomainクラスのList
