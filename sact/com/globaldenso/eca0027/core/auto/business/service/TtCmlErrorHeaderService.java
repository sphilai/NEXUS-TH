 ...
 * PROJECT：eca0027
 * 
 * TtCmlErrorHeader のServiceインターフェース
 * 
...
/**
 * TtCmlErrorHeader のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtCmlErrorHeaderService {
     ...
     * データを登録します。
     * 
     * @param domains ttCmlErrorHeaderのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttCmlErrorHeaderのDomainクラスのList
     * @param criteria ttCmlErrorHeaderのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtCmlErrorHeaderDomain> domains, List<TtCmlErrorHeaderCriteriaDomain> criteria) throws ApplicationException;
