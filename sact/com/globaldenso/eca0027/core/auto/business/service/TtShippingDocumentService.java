 ...
 * PROJECT：eca0027
 * 
 * TtShippingDocument のServiceインターフェース
 * 
...
/**
 * TtShippingDocument のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtShippingDocumentService {
     ...
     * データを登録します。
     * 
     * @param domains ttShippingDocumentのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttShippingDocumentのDomainクラスのList
     * @param criteria ttShippingDocumentのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtShippingDocumentDomain> domains, List<TtShippingDocumentCriteriaDomain> criteria) throws ApplicationException;
