 ...
 * PROJECT：eca0027
 * 
 * TwTransferItemItemNo のServiceインターフェース
 * 
...
/**
 * TwTransferItemItemNo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwTransferItemItemNoService {
     ...
     * データを登録します。
     * 
     * @param domains twTransferItemItemNoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twTransferItemItemNoのDomainクラスのList
     * @param criteria twTransferItemItemNoのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwTransferItemItemNoDomain> domains, List<TwTransferItemItemNoCriteriaDomain> criteria) throws ApplicationException;
