 ...
 * PROJECT：eca0027
 * 
 * TmExpFormalitiItemNo のServiceインターフェース
 * 
...
/**
 * TmExpFormalitiItemNo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmExpFormalitiItemNoService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmExpFormalitiItemNoの CriteriaDomain クラス
     * @return tmExpFormalitiItemNoのDomainクラス
     ...
     * 
     * @param criteria tmExpFormalitiItemNoの CriteriaDomain クラス
     * @return tmExpFormalitiItemNoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain tmExpFormalitiItemNoのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmExpFormalitiItemNoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmExpFormalitiItemNoのDomainクラス
     * @param criteria tmExpFormalitiItemNoのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmExpFormalitiItemNoのDomainクラスのList
     * @param criteria tmExpFormalitiItemNoのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmExpFormalitiItemNoDomain> domains, List<TmExpFormalitiItemNoCriteriaDomain> criteria) throws ApplicationException;
