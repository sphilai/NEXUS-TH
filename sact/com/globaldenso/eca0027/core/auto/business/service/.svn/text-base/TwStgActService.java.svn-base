...
/**
 * TwStgAct のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwStgActService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria twStgActの CriteriaDomain クラス
     * @return twStgActのDomainクラス
     ...
     * 
     * @param criteria twStgActの CriteriaDomain クラス
     * @return twStgActのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain twStgActのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains twStgActのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain twStgActのDomainクラス
     * @param criteria twStgActのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twStgActのDomainクラスのList
     * @param criteria twStgActのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwStgActDomain> domains, List<TwStgActCriteriaDomain> criteria) throws ApplicationException;
