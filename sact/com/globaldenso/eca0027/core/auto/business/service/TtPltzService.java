 ...
 */
public interface TtPltzService {
     ...
     * データを登録します。
     * 
     * @param domains ttPltzのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttPltzのDomainクラスのList
     * @param criteria ttPltzのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtPltzDomain> domains, List<TtPltzCriteriaDomain> criteria) throws ApplicationException;
