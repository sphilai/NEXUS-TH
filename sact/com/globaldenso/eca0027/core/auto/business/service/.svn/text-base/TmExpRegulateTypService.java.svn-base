 ...
 * PROJECT：eca0027
 * 
 * TmExpRegulateTyp のServiceインターフェース
 * 
...
/**
 * TmExpRegulateTyp のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmExpRegulateTypService {
     ...
     * データを登録します。
     * 
     * @param domains tmExpRegulateTypのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmExpRegulateTypのDomainクラスのList
     * @param criteria tmExpRegulateTypのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmExpRegulateTypDomain> domains, List<TmExpRegulateTypCriteriaDomain> criteria) throws ApplicationException;
