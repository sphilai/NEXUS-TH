...
/**
 * TwStgInstr のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwStgInstrService {
     ...
     * データを登録します。
     * 
     * @param domains twStgInstrのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twStgInstrのDomainクラスのList
     * @param criteria twStgInstrのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwStgInstrDomain> domains, List<TwStgInstrCriteriaDomain> criteria) throws ApplicationException;
