...
/**
 * TtPltzKanban のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtPltzKanbanService {
     ...
     * データを登録します。
     * 
     * @param domains ttPltzKanbanのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttPltzKanbanのDomainクラスのList
     * @param criteria ttPltzKanbanのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtPltzKanbanDomain> domains, List<TtPltzKanbanCriteriaDomain> criteria) throws ApplicationException;
