...
/**
 * TtExpRcvOdr のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtExpRcvOdrService {
     ...
     * データを登録します。
     * 
     * @param domains ttExpRcvOdrのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttExpRcvOdrのDomainクラスのList
     * @param criteria ttExpRcvOdrのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtExpRcvOdrDomain> domains, List<TtExpRcvOdrCriteriaDomain> criteria) throws ApplicationException;
