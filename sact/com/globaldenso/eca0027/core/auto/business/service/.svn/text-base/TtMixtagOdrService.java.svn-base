...
/**
 * TtMixtagOdr のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtMixtagOdrService {
     ...
     * データを登録します。
     * 
     * @param domains ttMixtagOdrのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttMixtagOdrのDomainクラスのList
     * @param criteria ttMixtagOdrのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtMixtagOdrDomain> domains, List<TtMixtagOdrCriteriaDomain> criteria) throws ApplicationException;
