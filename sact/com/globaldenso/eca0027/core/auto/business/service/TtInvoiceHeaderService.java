 ...
 * PROJECT：eca0027
 * 
 * TtInvoiceHeader のServiceインターフェース
 * 
...
/**
 * TtInvoiceHeader のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtInvoiceHeaderService {
     ...
     * データを登録します。
     * 
     * @param domains ttInvoiceHeaderのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttInvoiceHeaderのDomainクラスのList
     * @param criteria ttInvoiceHeaderのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtInvoiceHeaderDomain> domains, List<TtInvoiceHeaderCriteriaDomain> criteria) throws ApplicationException;
