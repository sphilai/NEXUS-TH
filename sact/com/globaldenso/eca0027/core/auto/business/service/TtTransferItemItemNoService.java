 ...
 * PROJECT：eca0027
 * 
 * TtTransferItemItemNo のServiceインターフェース
 * 
...
/**
 * TtTransferItemItemNo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtTransferItemItemNoService {
     ...
     * データを登録します。
     * 
     * @param domains ttTransferItemItemNoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttTransferItemItemNoのDomainクラスのList
     * @param criteria ttTransferItemItemNoのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtTransferItemItemNoDomain> domains, List<TtTransferItemItemNoCriteriaDomain> criteria) throws ApplicationException;
