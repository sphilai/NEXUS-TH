...
/**
 * TwMixtagRt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwMixtagRtService {
     ...
     * データを登録します。
     * 
     * @param domains twMixtagRtのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twMixtagRtのDomainクラスのList
     * @param criteria twMixtagRtのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwMixtagRtDomain> domains, List<TwMixtagRtCriteriaDomain> criteria) throws ApplicationException;
