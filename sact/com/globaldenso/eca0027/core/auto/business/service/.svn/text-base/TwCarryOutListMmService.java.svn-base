 ...
 * PROJECT：eca0027
 * 
 * TwCarryOutListMm のServiceインターフェース
 * 
...
/**
 * TwCarryOutListMm のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwCarryOutListMmService {
     ...
     * データを登録します。
     * 
     * @param domains twCarryOutListMmのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twCarryOutListMmのDomainクラスのList
     * @param criteria twCarryOutListMmのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwCarryOutListMmDomain> domains, List<TwCarryOutListMmCriteriaDomain> criteria) throws ApplicationException;
