 ...
 * PROJECT：eca0027
 * 
 * TwCaseMarkUnship のServiceインターフェース
 * 
...
/**
 * TwCaseMarkUnship のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwCaseMarkUnshipService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria twCaseMarkUnshipの CriteriaDomain クラス
     * @return twCaseMarkUnshipのDomainクラス
     ...
     * 
     * @param criteria twCaseMarkUnshipの CriteriaDomain クラス
     * @return twCaseMarkUnshipのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain twCaseMarkUnshipのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains twCaseMarkUnshipのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain twCaseMarkUnshipのDomainクラス
     * @param criteria twCaseMarkUnshipのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twCaseMarkUnshipのDomainクラスのList
     * @param criteria twCaseMarkUnshipのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwCaseMarkUnshipDomain> domains, List<TwCaseMarkUnshipCriteriaDomain> criteria) throws ApplicationException;
