 ...
 * PROJECT：eca0027
 * 
 * TtMixtagItemNo のServiceインターフェース
 * 
...
/**
 * TtMixtagItemNo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtMixtagItemNoService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria ttMixtagItemNoの CriteriaDomain クラス
     * @return ttMixtagItemNoのDomainクラス
     ...
     * 
     * @param criteria ttMixtagItemNoの CriteriaDomain クラス
     * @return ttMixtagItemNoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain ttMixtagItemNoのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains ttMixtagItemNoのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain ttMixtagItemNoのDomainクラス
     * @param criteria ttMixtagItemNoのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttMixtagItemNoのDomainクラスのList
     * @param criteria ttMixtagItemNoのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtMixtagItemNoDomain> domains, List<TtMixtagItemNoCriteriaDomain> criteria) throws ApplicationException;
