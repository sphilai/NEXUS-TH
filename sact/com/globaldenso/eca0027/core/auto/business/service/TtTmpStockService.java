...
/**
 * TtTmpStock のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtTmpStockService {
     ...
     * データを登録します。
     * 
     * @param domains ttTmpStockのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttTmpStockのDomainクラスのList
     * @param criteria ttTmpStockのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtTmpStockDomain> domains, List<TtTmpStockCriteriaDomain> criteria) throws ApplicationException;
