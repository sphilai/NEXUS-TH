 ...
 * PROJECT：eca0027
 * 
 * TmInvTplShipTo のServiceインターフェース
 * 
...
/**
 * TmInvTplShipTo のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmInvTplShipToService {
     ...
     * データを登録します。
     * 
     * @param domains tmInvTplShipToのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmInvTplShipToのDomainクラスのList
     * @param criteria tmInvTplShipToのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmInvTplShipToDomain> domains, List<TmInvTplShipToCriteriaDomain> criteria) throws ApplicationException;
