 ...
 * PROJECT：eca0027
 * 
 * VtRpInvHdrForFrt のServiceインターフェース
 * 
...
/**
 * VtRpInvHdrForFrt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpInvHdrForFrtService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpInvHdrForFrtの CriteriaDomain クラス
     * @return vtRpInvHdrForFrtのDomainクラスのList
