 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctHdrNonCmrcl のServiceインターフェース
 * 
...
/**
 * VtRpSlsCntrctHdrNonCmrcl のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpSlsCntrctHdrNonCmrclService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpSlsCntrctHdrNonCmrclの CriteriaDomain クラス
     * @return vtRpSlsCntrctHdrNonCmrclのDomainクラスのList
