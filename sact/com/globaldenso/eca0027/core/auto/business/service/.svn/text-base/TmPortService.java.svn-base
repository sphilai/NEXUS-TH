 ...
 */
public interface TmPortService {
     ...
     * データを登録します。
     * 
     * @param domains tmPortのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmPortのDomainクラスのList
     * @param criteria tmPortのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmPortDomain> domains, List<TmPortCriteriaDomain> criteria) throws ApplicationException;
