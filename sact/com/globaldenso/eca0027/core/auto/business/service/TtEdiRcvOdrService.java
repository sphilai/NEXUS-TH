...
/**
 * TtEdiRcvOdr のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtEdiRcvOdrService {
     ...
     * データを登録します。
     * 
     * @param domains ttEdiRcvOdrのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttEdiRcvOdrのDomainクラスのList
     * @param criteria ttEdiRcvOdrのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtEdiRcvOdrDomain> domains, List<TtEdiRcvOdrCriteriaDomain> criteria) throws ApplicationException;
