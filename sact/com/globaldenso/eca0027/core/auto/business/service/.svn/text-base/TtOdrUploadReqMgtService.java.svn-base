 ...
 * PROJECT：eca0027
 * 
 * TtOdrUploadReqMgt のServiceインターフェース
 * 
...
/**
 * TtOdrUploadReqMgt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtOdrUploadReqMgtService {
     ...
     * データを登録します。
     * 
     * @param domains ttOdrUploadReqMgtのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttOdrUploadReqMgtのDomainクラスのList
     * @param criteria ttOdrUploadReqMgtのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtOdrUploadReqMgtDomain> domains, List<TtOdrUploadReqMgtCriteriaDomain> criteria) throws ApplicationException;
