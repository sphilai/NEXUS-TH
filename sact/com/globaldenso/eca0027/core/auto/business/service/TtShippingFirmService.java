 ...
 * PROJECT：eca0027
 * 
 * TtShippingFirm のServiceインターフェース
 * 
...
/**
 * TtShippingFirm のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtShippingFirmService {
     ...
     * データを登録します。
     * 
     * @param domains ttShippingFirmのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttShippingFirmのDomainクラスのList
     * @param criteria ttShippingFirmのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtShippingFirmDomain> domains, List<TtShippingFirmCriteriaDomain> criteria) throws ApplicationException;
