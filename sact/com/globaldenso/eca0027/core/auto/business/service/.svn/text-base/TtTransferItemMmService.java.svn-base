 ...
 * PROJECT：eca0027
 * 
 * TtTransferItemMm のServiceインターフェース
 * 
...
/**
 * TtTransferItemMm のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtTransferItemMmService {
     ...
     * データを登録します。
     * 
     * @param domains ttTransferItemMmのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttTransferItemMmのDomainクラスのList
     * @param criteria ttTransferItemMmのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtTransferItemMmDomain> domains, List<TtTransferItemMmCriteriaDomain> criteria) throws ApplicationException;
