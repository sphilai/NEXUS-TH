 ...
 * PROJECT：eca0027
 * 
 * VtRpPackAtchedForErt のServiceインターフェース
 * 
...
/**
 * VtRpPackAtchedForErt のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpPackAtchedForErtService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpPackAtchedForErtの CriteriaDomain クラス
     * @return vtRpPackAtchedForErtのDomainクラスのList
