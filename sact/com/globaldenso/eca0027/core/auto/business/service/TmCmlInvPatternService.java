 ...
 * PROJECT：eca0027
 * 
 * TmCmlInvPattern のServiceインターフェース
 * 
...
/**
 * TmCmlInvPattern のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmCmlInvPatternService {
     ...
     * データを登録します。
     * 
     * @param domains tmCmlInvPatternのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmCmlInvPatternのDomainクラスのList
     * @param criteria tmCmlInvPatternのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmCmlInvPatternDomain> domains, List<TmCmlInvPatternCriteriaDomain> criteria) throws ApplicationException;
