...
/**
 * TmTrnsTyp のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmTrnsTypService {
     ...
     * データを登録します。
     * 
     * @param domains tmTrnsTypのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmTrnsTypのDomainクラスのList
     * @param criteria tmTrnsTypのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmTrnsTypDomain> domains, List<TmTrnsTypCriteriaDomain> criteria) throws ApplicationException;
