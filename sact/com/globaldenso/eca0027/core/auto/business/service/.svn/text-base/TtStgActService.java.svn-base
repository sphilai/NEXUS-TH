...
/**
 * TtStgAct のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtStgActService {
     ...
     * データを登録します。
     * 
     * @param domains ttStgActのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttStgActのDomainクラスのList
     * @param criteria ttStgActのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtStgActDomain> domains, List<TtStgActCriteriaDomain> criteria) throws ApplicationException;
