 ...
 */
public interface TtXpltzService {
     ...
     * データを登録します。
     * 
     * @param domains ttXpltzのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttXpltzのDomainクラスのList
     * @param criteria ttXpltzのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtXpltzDomain> domains, List<TtXpltzCriteriaDomain> criteria) throws ApplicationException;
