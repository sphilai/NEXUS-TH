 ...
 * PROJECT：NEXUS
 * 
 * VtRpShippingFirm のServiceインターフェース
 * 
...
/**
 * VtRpShippingFirm のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpShippingFirmService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpShippingFirmの CriteriaDomain クラス
     * @return vtRpShippingFirmのDomainクラスのList
