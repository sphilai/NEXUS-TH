...
/**
 * TmPkgSpecRev のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmPkgSpecRevService {
     ...
     * データを登録します。
     * 
     * @param domains tmPkgSpecRevのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmPkgSpecRevのDomainクラスのList
     * @param criteria tmPkgSpecRevのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmPkgSpecRevDomain> domains, List<TmPkgSpecRevCriteriaDomain> criteria) throws ApplicationException;
