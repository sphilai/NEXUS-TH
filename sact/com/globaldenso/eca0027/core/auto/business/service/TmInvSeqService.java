...
/**
 * TmInvSeq のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TmInvSeqService {
     ...
     * データを登録します。
     * 
     * @param domains tmInvSeqのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmInvSeqのDomainクラスのList
     * @param criteria tmInvSeqのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmInvSeqDomain> domains, List<TmInvSeqCriteriaDomain> criteria) throws ApplicationException;
