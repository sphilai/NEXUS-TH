 ...
 * PROJECT：eca0027
 * 
 * VtCompMeasureUnit のServiceインターフェース
 * 
...
/**
 * VtCompMeasureUnit のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtCompMeasureUnitService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtCompMeasureUnitの CriteriaDomain クラス
     * @return vtCompMeasureUnitのDomainクラスのList
