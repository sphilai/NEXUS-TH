 ...
 * PROJECT：eca0027
 * 
 * TtSearchCriteria のServiceインターフェース
 * 
...
/**
 * TtSearchCriteria のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TtSearchCriteriaService {
     ...
     * データを登録します。
     * 
     * @param domains ttSearchCriteriaのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains ttSearchCriteriaのDomainクラスのList
     * @param criteria ttSearchCriteriaのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TtSearchCriteriaDomain> domains, List<TtSearchCriteriaCriteriaDomain> criteria) throws ApplicationException;
