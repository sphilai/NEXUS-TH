 ...
 * PROJECT：eca0027
 * 
 * TwPltzItemPkg のServiceインターフェース
 * 
...
/**
 * TwPltzItemPkg のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface TwPltzItemPkgService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria twPltzItemPkgの CriteriaDomain クラス
     * @return twPltzItemPkgのDomainクラス
     ...
     * 
     * @param criteria twPltzItemPkgの CriteriaDomain クラス
     * @return twPltzItemPkgのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domain twPltzItemPkgのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains twPltzItemPkgのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain twPltzItemPkgのDomainクラス
     * @param criteria twPltzItemPkgのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains twPltzItemPkgのDomainクラスのList
     * @param criteria twPltzItemPkgのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TwPltzItemPkgDomain> domains, List<TwPltzItemPkgCriteriaDomain> criteria) throws ApplicationException;
