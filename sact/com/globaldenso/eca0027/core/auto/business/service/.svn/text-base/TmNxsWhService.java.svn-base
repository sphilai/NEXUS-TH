 ...
 */
public interface TmNxsWhService {

    /**
     * 主キーを条件にデータを検索し、検索結果を返却します。
     * 
     * @param criteria tmNxsWhの CriteriaDomain クラス
     * @return tmNxsWhのDomainクラス
     ...
     * データを登録します。
     * 
     * @param domain tmNxsWhのDomainクラス
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * データを登録します。
     * 
     * @param domains tmNxsWhのDomainクラスのList
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domain tmNxsWhのDomainクラス
     * @param criteria tmNxsWhのCriteriaDomainクラス
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
     ...
     * 
     * @param domains tmNxsWhのDomainクラスのList
     * @param criteria tmNxsWhのCriteriaDomainクラスのList
     * @return 更新件数
     * @throws ApplicationException アプリ基盤のアプリケーション例外です。
     */
    public int updateByCondition(List<TmNxsWhDomain> domains, List<TmNxsWhCriteriaDomain> criteria) throws ApplicationException;
