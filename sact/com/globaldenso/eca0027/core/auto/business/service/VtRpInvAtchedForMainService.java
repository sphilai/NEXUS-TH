 ...
 * PROJECT：eca0027
 * 
 * VtRpInvAtchedForMain のServiceインターフェース
 * 
...
/**
 * VtRpInvAtchedForMain のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpInvAtchedForMainService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpInvAtchedForMainの CriteriaDomain クラス
     * @return vtRpInvAtchedForMainのDomainクラスのList
