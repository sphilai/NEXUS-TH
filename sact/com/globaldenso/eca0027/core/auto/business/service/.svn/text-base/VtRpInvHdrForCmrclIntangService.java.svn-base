 ...
 * PROJECT：eca0027
 * 
 * VtRpInvHdrForCmrclIntang のServiceインターフェース
 * 
...
/**
 * VtRpInvHdrForCmrclIntang のServiceインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpInvHdrForCmrclIntangService {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpInvHdrForCmrclIntangの CriteriaDomain クラス
     * @return vtRpInvHdrForCmrclIntangのDomainクラスのList
