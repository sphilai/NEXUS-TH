 ...
 * PROJECT：eca0027
 * 
 * VtRpInvHdrForCmrclIntang の検索条件Domainクラス
 * テーブル概要：VT_RP_INV_HDR_FOR_CMRCL_INTANG
 * 
 * Version.   更新日      更新者        更新内容
 * 1.0.0      2016/06/28  DNITS  新規作成
 * 
...
/**
 * VtRpInvHdrForCmrclIntang の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_INV_HDR_FOR_CMRCL_INTANG<BR>
 * 
 * <BR>
 * SACT Version： 1.0.1<BR>
 * 生成日      ： 2016/06/28 14:18:48<BR>
 * 
 * テーブル定義から2016/06/28に自動生成したモジュールです。
 * 
 * @author $Author: 400616000304 $
 * @version $Revision: 10993 $
 */
public class VtRpInvHdrForCmrclIntangCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * MANUAL_INVOICE_ISSUE_DT（大なりイコール）
     */
    private Date manualInvoiceIssueDtGreaterThanEqual;

    /**
     * MANUAL_INVOICE_ISSUE_DT（小なりイコール）
     */
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpInvHdrForCmrclIntangCriteriaDomain() {
    }
