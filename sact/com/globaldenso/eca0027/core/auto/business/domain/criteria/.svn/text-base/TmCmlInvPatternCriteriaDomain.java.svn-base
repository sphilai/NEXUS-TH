 ...
 * PROJECT：eca0027
 * 
 * TmCmlInvPattern の検索条件Domainクラス
 * テーブル概要：TM_CML_INV_PATTERN
 * 
...
/**
 * TmCmlInvPattern の検索条件Domainクラスです。<BR>
 * テーブル概要：TM_CML_INV_PATTERN<BR>
 * 
 * <BR>
 ...
 */
public class TmCmlInvPatternCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TmCmlInvPatternCriteriaDomain() {
    }
