...
/**
 * TtMixtagRt の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_MIXTAG_RT<BR>
 * 
 * <BR>
 ...
 */
public class TtMixtagRtCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * BOX_FLG（大なり）
     */
    private String boxFlgGreaterThan;

    /**
     * BOX_FLG（大なりイコール）
     */
    private String boxFlgGreaterThanEqual;

    /**
     * BOX_FLG（小なり）
     */
    private String boxFlgLessThan;

    /**
     * BOX_FLG（小なりイコール）
     */
    private String boxFlgLessThanEqual;

    /**
     * BOX_FLG（前方一致）
     */
    private String boxFlgLikeFront;
     ...
     * PKG_NM（大なり）
     */
    private String pkgNmGreaterThan;

    /**
     * PKG_NM（大なりイコール）
     */
    private String pkgNmGreaterThanEqual;

    /**
     * PKG_NM（小なり）
     */
    private String pkgNmLessThan;

    /**
     * PKG_NM（小なりイコール）
     */
    private String pkgNmLessThanEqual;

    /**
     * PKG_NM（前方一致）
     */
    private String pkgNmLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TtMixtagRtCriteriaDomain() {
    }
    ...
    /**
     * boxFlgGreaterThan のゲッターメソッドです。
     * 
     * @return the boxFlgGreaterThan
     */
    public String getBoxFlgGreaterThan() {
        return boxFlgGreaterThan;
    }

    /**
     * boxFlgGreaterThan のセッターメソッドです。
     * 
     * @param boxFlgGreaterThan boxFlgGreaterThan に設定する
     */
    public void setBoxFlgGreaterThan(String boxFlgGreaterThan) {
        this.boxFlgGreaterThan = boxFlgGreaterThan;
    }

    /**
     * boxFlgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the boxFlgGreaterThanEqual
     */
    public String getBoxFlgGreaterThanEqual() {
        return boxFlgGreaterThanEqual;
    }

    /**
     * boxFlgGreaterThanEqual のセッターメソッドです。
     * 
     * @param boxFlgGreaterThanEqual boxFlgGreaterThanEqual に設定する
     */
    public void setBoxFlgGreaterThanEqual(String boxFlgGreaterThanEqual) {
        this.boxFlgGreaterThanEqual = boxFlgGreaterThanEqual;
    }

    /**
     * boxFlgLessThan のゲッターメソッドです。
     * 
     * @return the boxFlgLessThan
     */
    public String getBoxFlgLessThan() {
        return boxFlgLessThan;
    }

    /**
     * boxFlgLessThan のセッターメソッドです。
     * 
     * @param boxFlgLessThan boxFlgLessThan に設定する
     */
    public void setBoxFlgLessThan(String boxFlgLessThan) {
        this.boxFlgLessThan = boxFlgLessThan;
    }

    /**
     * boxFlgLessThanEqual のゲッターメソッドです。
     * 
     * @return the boxFlgLessThanEqual
     */
    public String getBoxFlgLessThanEqual() {
        return boxFlgLessThanEqual;
    }

    /**
     * boxFlgLessThanEqual のセッターメソッドです。
     * 
     * @param boxFlgLessThanEqual boxFlgLessThanEqual に設定する
     */
    public void setBoxFlgLessThanEqual(String boxFlgLessThanEqual) {
        this.boxFlgLessThanEqual = boxFlgLessThanEqual;
    }

    /**
     * boxFlgLikeFront のゲッターメソッドです。
     * 
     * @return the boxFlgLikeFront
     */
    public String getBoxFlgLikeFront() {
        return boxFlgLikeFront;
    }

    /**
     * boxFlgLikeFront のセッターメソッドです。
     * 
     * @param boxFlgLikeFront boxFlgLikeFront に設定する
     */
    public void setBoxFlgLikeFront(String boxFlgLikeFront) {
        this.boxFlgLikeFront = boxFlgLikeFront;
    }
    ...
    /**
     * pkgNmGreaterThan のゲッターメソッドです。
     * 
     * @return the pkgNmGreaterThan
     */
    public String getPkgNmGreaterThan() {
        return pkgNmGreaterThan;
    }

    /**
     * pkgNmGreaterThan のセッターメソッドです。
     * 
     * @param pkgNmGreaterThan pkgNmGreaterThan に設定する
     */
    public void setPkgNmGreaterThan(String pkgNmGreaterThan) {
        this.pkgNmGreaterThan = pkgNmGreaterThan;
    }

    /**
     * pkgNmGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the pkgNmGreaterThanEqual
     */
    public String getPkgNmGreaterThanEqual() {
        return pkgNmGreaterThanEqual;
    }

    /**
     * pkgNmGreaterThanEqual のセッターメソッドです。
     * 
     * @param pkgNmGreaterThanEqual pkgNmGreaterThanEqual に設定する
     */
    public void setPkgNmGreaterThanEqual(String pkgNmGreaterThanEqual) {
        this.pkgNmGreaterThanEqual = pkgNmGreaterThanEqual;
    }

    /**
     * pkgNmLessThan のゲッターメソッドです。
     * 
     * @return the pkgNmLessThan
     */
    public String getPkgNmLessThan() {
        return pkgNmLessThan;
    }

    /**
     * pkgNmLessThan のセッターメソッドです。
     * 
     * @param pkgNmLessThan pkgNmLessThan に設定する
     */
    public void setPkgNmLessThan(String pkgNmLessThan) {
        this.pkgNmLessThan = pkgNmLessThan;
    }

    /**
     * pkgNmLessThanEqual のゲッターメソッドです。
     * 
     * @return the pkgNmLessThanEqual
     */
    public String getPkgNmLessThanEqual() {
        return pkgNmLessThanEqual;
    }

    /**
     * pkgNmLessThanEqual のセッターメソッドです。
     * 
     * @param pkgNmLessThanEqual pkgNmLessThanEqual に設定する
     */
    public void setPkgNmLessThanEqual(String pkgNmLessThanEqual) {
        this.pkgNmLessThanEqual = pkgNmLessThanEqual;
    }

    /**
     * pkgNmLikeFront のゲッターメソッドです。
     * 
     * @return the pkgNmLikeFront
     */
    public String getPkgNmLikeFront() {
        return pkgNmLikeFront;
    }

    /**
     * pkgNmLikeFront のセッターメソッドです。
     * 
     * @param pkgNmLikeFront pkgNmLikeFront に設定する
     */
    public void setPkgNmLikeFront(String pkgNmLikeFront) {
        this.pkgNmLikeFront = pkgNmLikeFront;
    }
