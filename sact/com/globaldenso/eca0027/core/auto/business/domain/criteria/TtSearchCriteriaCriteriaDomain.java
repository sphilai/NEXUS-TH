 ...
 * PROJECT：eca0027
 * 
 * TtSearchCriteria の検索条件Domainクラス
 * テーブル概要：TT_SEARCH_CRITERIA
 * 
...
/**
 * TtSearchCriteria の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_SEARCH_CRITERIA<BR>
 * 
 * <BR>
 ...
 */
public class TtSearchCriteriaCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * FIELD_NAME（大なり）
     */
    private String fieldNameGreaterThan;

    /**
     * FIELD_NAME（大なりイコール）
     */
    private String fieldNameGreaterThanEqual;

    /**
     * FIELD_NAME（小なり）
     */
    private String fieldNameLessThan;

    /**
     * FIELD_NAME（小なりイコール）
     */
    private String fieldNameLessThanEqual;
     ...
     * FIELD_VALUE（大なり）
     */
    private String fieldValueGreaterThan;

    /**
     * FIELD_VALUE（大なりイコール）
     */
    private String fieldValueGreaterThanEqual;

    /**
     * FIELD_VALUE（小なり）
     */
    private String fieldValueLessThan;

    /**
     * FIELD_VALUE（小なりイコール）
     */
    private String fieldValueLessThanEqual;

    /**
     * FIELD_VALUE（前方一致）
     */
    private String fieldValueLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TtSearchCriteriaCriteriaDomain() {
    }
    ...
    /**
     * fieldName のセッターメソッドです。
     * 
     * @param fieldName fieldName に設定する
     */
    ...
    /**
     * fieldValue のセッターメソッドです。
     * 
     * @param fieldValue fieldValue に設定する
     */
    ...
    /**
     * fieldNameGreaterThan のゲッターメソッドです。
     * 
     * @return the fieldNameGreaterThan
     */
    public String getFieldNameGreaterThan() {
        return fieldNameGreaterThan;
    }

    /**
     * fieldNameGreaterThan のセッターメソッドです。
     * 
     * @param fieldNameGreaterThan fieldNameGreaterThan に設定する
     */
    public void setFieldNameGreaterThan(String fieldNameGreaterThan) {
        this.fieldNameGreaterThan = fieldNameGreaterThan;
    }

    /**
     * fieldNameGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the fieldNameGreaterThanEqual
     */
    public String getFieldNameGreaterThanEqual() {
        return fieldNameGreaterThanEqual;
    }

    /**
     * fieldNameGreaterThanEqual のセッターメソッドです。
     * 
     * @param fieldNameGreaterThanEqual fieldNameGreaterThanEqual に設定する
     */
    public void setFieldNameGreaterThanEqual(String fieldNameGreaterThanEqual) {
        this.fieldNameGreaterThanEqual = fieldNameGreaterThanEqual;
    }

    /**
     * fieldNameLessThan のゲッターメソッドです。
     * 
     * @return the fieldNameLessThan
     */
    public String getFieldNameLessThan() {
        return fieldNameLessThan;
    }

    /**
     * fieldNameLessThan のセッターメソッドです。
     * 
     * @param fieldNameLessThan fieldNameLessThan に設定する
     */
    public void setFieldNameLessThan(String fieldNameLessThan) {
        this.fieldNameLessThan = fieldNameLessThan;
    }

    /**
     * fieldNameLessThanEqual のゲッターメソッドです。
     * 
     * @return the fieldNameLessThanEqual
     */
    public String getFieldNameLessThanEqual() {
        return fieldNameLessThanEqual;
    }

    /**
     * fieldNameLessThanEqual のセッターメソッドです。
     * 
     * @param fieldNameLessThanEqual fieldNameLessThanEqual に設定する
     */
    public void setFieldNameLessThanEqual(String fieldNameLessThanEqual) {
        this.fieldNameLessThanEqual = fieldNameLessThanEqual;
    }

    /**
     * fieldNameLikeFront のゲッターメソッドです。
     * 
    ...
    /**
     * fieldNameLikeFront のセッターメソッドです。
     * 
     * @param fieldNameLikeFront fieldNameLikeFront に設定する
     */
    ...
    /**
     * fieldValueGreaterThan のゲッターメソッドです。
     * 
     * @return the fieldValueGreaterThan
     */
    public String getFieldValueGreaterThan() {
        return fieldValueGreaterThan;
    }

    /**
     * fieldValueGreaterThan のセッターメソッドです。
     * 
     * @param fieldValueGreaterThan fieldValueGreaterThan に設定する
     */
    public void setFieldValueGreaterThan(String fieldValueGreaterThan) {
        this.fieldValueGreaterThan = fieldValueGreaterThan;
    }

    /**
     * fieldValueGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the fieldValueGreaterThanEqual
     */
    public String getFieldValueGreaterThanEqual() {
        return fieldValueGreaterThanEqual;
    }

    /**
     * fieldValueGreaterThanEqual のセッターメソッドです。
     * 
     * @param fieldValueGreaterThanEqual fieldValueGreaterThanEqual に設定する
     */
    public void setFieldValueGreaterThanEqual(String fieldValueGreaterThanEqual) {
        this.fieldValueGreaterThanEqual = fieldValueGreaterThanEqual;
    }

    /**
     * fieldValueLessThan のゲッターメソッドです。
     * 
     * @return the fieldValueLessThan
     */
    public String getFieldValueLessThan() {
        return fieldValueLessThan;
    }

    /**
     * fieldValueLessThan のセッターメソッドです。
     * 
     * @param fieldValueLessThan fieldValueLessThan に設定する
     */
    public void setFieldValueLessThan(String fieldValueLessThan) {
        this.fieldValueLessThan = fieldValueLessThan;
    }

    /**
     * fieldValueLessThanEqual のゲッターメソッドです。
     * 
     * @return the fieldValueLessThanEqual
     */
    public String getFieldValueLessThanEqual() {
        return fieldValueLessThanEqual;
    }

    /**
     * fieldValueLessThanEqual のセッターメソッドです。
     * 
     * @param fieldValueLessThanEqual fieldValueLessThanEqual に設定する
     */
    public void setFieldValueLessThanEqual(String fieldValueLessThanEqual) {
        this.fieldValueLessThanEqual = fieldValueLessThanEqual;
    }

    /**
     * fieldValueLikeFront のゲッターメソッドです。
     * 
     * @return the fieldValueLikeFront
     */
    public String getFieldValueLikeFront() {
        return fieldValueLikeFront;
    }

    /**
     * fieldValueLikeFront のセッターメソッドです。
     * 
     * @param fieldValueLikeFront fieldValueLikeFront に設定する
     */
    public void setFieldValueLikeFront(String fieldValueLikeFront) {
        this.fieldValueLikeFront = fieldValueLikeFront;
    }
