 ...
 * PROJECT：eca0027
 * 
 * TwTransferItemItemNo の検索条件Domainクラス
...
/**
 * TwTransferItemItemNo の検索条件Domainクラスです。<BR>
 ...
 */
public class TwTransferItemItemNoCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TwTransferItemItemNoCriteriaDomain() {
    }
