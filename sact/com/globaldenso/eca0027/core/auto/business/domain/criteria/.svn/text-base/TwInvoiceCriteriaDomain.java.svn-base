 ...
 */
public class TwInvoiceCriteriaDomain extends AbstractDomain implements Serializable {
...
(Registerd by Shipping Actuality function)
    ...
    /**
     * TEMP INVOICE NO/仮インボイスNO  連番（大なり）
     */
    private String tempInvoiceNoGreaterThan;

    /**
     * TEMP INVOICE NO/仮インボイスNO  連番（大なりイコール）
     */
    private String tempInvoiceNoGreaterThanEqual;

    /**
     * TEMP INVOICE NO/仮インボイスNO  連番（小なり）
     */
    private String tempInvoiceNoLessThan;

    /**
     * TEMP INVOICE NO/仮インボイスNO  連番（小なりイコール）
     */
    private String tempInvoiceNoLessThanEqual;

    /**
     * TEMP INVOICE NO/仮インボイスNO  連番（前方一致）
     */
...
3:DN-G Invoice(It is set only if manual flag "Y")（前方一致）
    ...
    /**
     * PARENT TEMP INVOICE NO/親_仮インボイスNO  インボイス種類（M:Main,F:Full-RT,E:E-RT）に応じて、M,EならそのままインボイスNOをセットする。FならMのインボイスNOをセットする。（大なり）
     */
    private String parTempInvoiceNoGreaterThan;

    /**
     * PARENT TEMP INVOICE NO/親_仮インボイスNO  インボイス種類（M:Main,F:Full-RT,E:E-RT）に応じて、M,EならそのままインボイスNOをセットする。FならMのインボイスNOをセットする。（大なりイコール）
     */
    private String parTempInvoiceNoGreaterThanEqual;

    /**
     * PARENT TEMP INVOICE NO/親_仮インボイスNO  インボイス種類（M:Main,F:Full-RT,E:E-RT）に応じて、M,EならそのままインボイスNOをセットする。FならMのインボイスNOをセットする。（小なり）
     */
    private String parTempInvoiceNoLessThan;

    /**
     * PARENT TEMP INVOICE NO/親_仮インボイスNO  インボイス種類（M:Main,F:Full-RT,E:E-RT）に応じて、M,EならそのままインボイスNOをセットする。FならMのインボイスNOをセットする。（小なりイコール）
     */
    private String parTempInvoiceNoLessThanEqual;

    /**
     * PARENT TEMP INVOICE NO/親_仮インボイスNO  インボイス種類（M:Main,F:Full-RT,E:E-RT）に応じて、M,EならそのままインボイスNOをセットする。FならMのインボイスNOをセットする。（前方一致）
     */
    private String parTempInvoiceNoLikeFront;
    ...
    /**
     * RELATION TEMP INVOICE NO/関連_仮インボイスNO  通常インボイスの場合、リインボイスNo.が入る。リインボイスの場合、通常インボイスNo.が入る。（大なり）
     */
    private String relateTempInvoiceNoGreaterThan;

    /**
     * RELATION TEMP INVOICE NO/関連_仮インボイスNO  通常インボイスの場合、リインボイスNo.が入る。リインボイスの場合、通常インボイスNo.が入る。（大なりイコール）
     */
    private String relateTempInvoiceNoGreaterThanEqual;

    /**
     * RELATION TEMP INVOICE NO/関連_仮インボイスNO  通常インボイスの場合、リインボイスNo.が入る。リインボイスの場合、通常インボイスNo.が入る。（小なり）
     */
    private String relateTempInvoiceNoLessThan;

    /**
     * RELATION TEMP INVOICE NO/関連_仮インボイスNO  通常インボイスの場合、リインボイスNo.が入る。リインボイスの場合、通常インボイスNo.が入る。（小なりイコール）
     */
    private String relateTempInvoiceNoLessThanEqual;

    /**
     * RELATION TEMP INVOICE NO/関連_仮インボイスNO  通常インボイスの場合、リインボイスNo.が入る。リインボイスの場合、通常インボイスNo.が入る。（前方一致）
     */
    private String relateTempInvoiceNoLikeFront;
...
X:T/T Remittance（前方一致）
     ...
     * SHIPPING ACTUALITY STATUS/船積実績ステータス  10:Imcomplete Doc Attach,
20:Complete Doc attach
(Registerd by Shipping Actuality function)（大なり）
     */
     ...
     * SHIPPING ACTUALITY STATUS/船積実績ステータス  10:Imcomplete Doc Attach,
20:Complete Doc attach
(Registerd by Shipping Actuality function)（大なりイコール）
     */
     ...
     * SHIPPING ACTUALITY STATUS/船積実績ステータス  10:Imcomplete Doc Attach,
20:Complete Doc attach
(Registerd by Shipping Actuality function)（小なり）
     */
     ...
     * SHIPPING ACTUALITY STATUS/船積実績ステータス  10:Imcomplete Doc Attach,
20:Complete Doc attach
(Registerd by Shipping Actuality function)（小なりイコール）
     */
     ...
     * SHIPPING ACTUALITY STATUS/船積実績ステータス  10:Imcomplete Doc Attach,
20:Complete Doc attach
(Registerd by Shipping Actuality function)（前方一致）
     */
     ...
     * デフォルトコンストラクタ。
     */
    public TwInvoiceCriteriaDomain() {
    }
    ...
    /**
     * parTempInvoiceNoGreaterThan のゲッターメソッドです。
     * 
     * @return the parTempInvoiceNoGreaterThan
     */
    public String getParTempInvoiceNoGreaterThan() {
        return parTempInvoiceNoGreaterThan;
    }

    /**
     * parTempInvoiceNoGreaterThan のセッターメソッドです。
     * 
     * @param parTempInvoiceNoGreaterThan parTempInvoiceNoGreaterThan に設定する
     */
    public void setParTempInvoiceNoGreaterThan(String parTempInvoiceNoGreaterThan) {
        this.parTempInvoiceNoGreaterThan = parTempInvoiceNoGreaterThan;
    }

    /**
     * parTempInvoiceNoGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the parTempInvoiceNoGreaterThanEqual
     */
    public String getParTempInvoiceNoGreaterThanEqual() {
        return parTempInvoiceNoGreaterThanEqual;
    }

    /**
     * parTempInvoiceNoGreaterThanEqual のセッターメソッドです。
     * 
     * @param parTempInvoiceNoGreaterThanEqual parTempInvoiceNoGreaterThanEqual に設定する
     */
    public void setParTempInvoiceNoGreaterThanEqual(String parTempInvoiceNoGreaterThanEqual) {
        this.parTempInvoiceNoGreaterThanEqual = parTempInvoiceNoGreaterThanEqual;
    }

    /**
     * parTempInvoiceNoLessThan のゲッターメソッドです。
     * 
     * @return the parTempInvoiceNoLessThan
     */
    public String getParTempInvoiceNoLessThan() {
        return parTempInvoiceNoLessThan;
    }

    /**
     * parTempInvoiceNoLessThan のセッターメソッドです。
     * 
     * @param parTempInvoiceNoLessThan parTempInvoiceNoLessThan に設定する
     */
    public void setParTempInvoiceNoLessThan(String parTempInvoiceNoLessThan) {
        this.parTempInvoiceNoLessThan = parTempInvoiceNoLessThan;
    }

    /**
     * parTempInvoiceNoLessThanEqual のゲッターメソッドです。
     * 
     * @return the parTempInvoiceNoLessThanEqual
     */
    public String getParTempInvoiceNoLessThanEqual() {
        return parTempInvoiceNoLessThanEqual;
    }

    /**
     * parTempInvoiceNoLessThanEqual のセッターメソッドです。
     * 
     * @param parTempInvoiceNoLessThanEqual parTempInvoiceNoLessThanEqual に設定する
     */
    public void setParTempInvoiceNoLessThanEqual(String parTempInvoiceNoLessThanEqual) {
        this.parTempInvoiceNoLessThanEqual = parTempInvoiceNoLessThanEqual;
    }

    /**
     * parTempInvoiceNoLikeFront のゲッターメソッドです。
     * 
     * @return the parTempInvoiceNoLikeFront
     */
    public String getParTempInvoiceNoLikeFront() {
        return parTempInvoiceNoLikeFront;
    }

    /**
     * parTempInvoiceNoLikeFront のセッターメソッドです。
     * 
     * @param parTempInvoiceNoLikeFront parTempInvoiceNoLikeFront に設定する
     */
    public void setParTempInvoiceNoLikeFront(String parTempInvoiceNoLikeFront) {
        this.parTempInvoiceNoLikeFront = parTempInvoiceNoLikeFront;
    }
    ...
    /**
     * relateTempInvoiceNoGreaterThan のゲッターメソッドです。
     * 
     * @return the relateTempInvoiceNoGreaterThan
     */
    public String getRelateTempInvoiceNoGreaterThan() {
        return relateTempInvoiceNoGreaterThan;
    }

    /**
     * relateTempInvoiceNoGreaterThan のセッターメソッドです。
     * 
     * @param relateTempInvoiceNoGreaterThan relateTempInvoiceNoGreaterThan に設定する
     */
    public void setRelateTempInvoiceNoGreaterThan(String relateTempInvoiceNoGreaterThan) {
        this.relateTempInvoiceNoGreaterThan = relateTempInvoiceNoGreaterThan;
    }

    /**
     * relateTempInvoiceNoGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the relateTempInvoiceNoGreaterThanEqual
     */
    public String getRelateTempInvoiceNoGreaterThanEqual() {
        return relateTempInvoiceNoGreaterThanEqual;
    }

    /**
     * relateTempInvoiceNoGreaterThanEqual のセッターメソッドです。
     * 
     * @param relateTempInvoiceNoGreaterThanEqual relateTempInvoiceNoGreaterThanEqual に設定する
     */
    public void setRelateTempInvoiceNoGreaterThanEqual(String relateTempInvoiceNoGreaterThanEqual) {
        this.relateTempInvoiceNoGreaterThanEqual = relateTempInvoiceNoGreaterThanEqual;
    }

    /**
     * relateTempInvoiceNoLessThan のゲッターメソッドです。
     * 
     * @return the relateTempInvoiceNoLessThan
     */
    public String getRelateTempInvoiceNoLessThan() {
        return relateTempInvoiceNoLessThan;
    }

    /**
     * relateTempInvoiceNoLessThan のセッターメソッドです。
     * 
     * @param relateTempInvoiceNoLessThan relateTempInvoiceNoLessThan に設定する
     */
    public void setRelateTempInvoiceNoLessThan(String relateTempInvoiceNoLessThan) {
        this.relateTempInvoiceNoLessThan = relateTempInvoiceNoLessThan;
    }

    /**
     * relateTempInvoiceNoLessThanEqual のゲッターメソッドです。
     * 
     * @return the relateTempInvoiceNoLessThanEqual
     */
    public String getRelateTempInvoiceNoLessThanEqual() {
        return relateTempInvoiceNoLessThanEqual;
    }

    /**
     * relateTempInvoiceNoLessThanEqual のセッターメソッドです。
     * 
     * @param relateTempInvoiceNoLessThanEqual relateTempInvoiceNoLessThanEqual に設定する
     */
    public void setRelateTempInvoiceNoLessThanEqual(String relateTempInvoiceNoLessThanEqual) {
        this.relateTempInvoiceNoLessThanEqual = relateTempInvoiceNoLessThanEqual;
    }

    /**
     * relateTempInvoiceNoLikeFront のゲッターメソッドです。
     * 
     * @return the relateTempInvoiceNoLikeFront
     */
    public String getRelateTempInvoiceNoLikeFront() {
        return relateTempInvoiceNoLikeFront;
    }

    /**
     * relateTempInvoiceNoLikeFront のセッターメソッドです。
     * 
     * @param relateTempInvoiceNoLikeFront relateTempInvoiceNoLikeFront に設定する
     */
    public void setRelateTempInvoiceNoLikeFront(String relateTempInvoiceNoLikeFront) {
        this.relateTempInvoiceNoLikeFront = relateTempInvoiceNoLikeFront;
    }
