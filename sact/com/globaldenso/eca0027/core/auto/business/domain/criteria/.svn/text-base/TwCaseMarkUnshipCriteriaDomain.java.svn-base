 ...
 * PROJECT：eca0027
 * 
 * TwCaseMarkUnship の検索条件Domainクラス
 * テーブル概要：TW_CASE_MARK_UNSHIP
 * 
...
/**
 * TwCaseMarkUnship の検索条件Domainクラスです。<BR>
 * テーブル概要：TW_CASE_MARK_UNSHIP<BR>
 * 
 * <BR>
 ...
 */
public class TwCaseMarkUnshipCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TwCaseMarkUnshipCriteriaDomain() {
    }
