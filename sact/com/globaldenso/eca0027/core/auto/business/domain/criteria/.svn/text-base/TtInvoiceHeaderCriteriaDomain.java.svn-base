 ...
 * PROJECT：eca0027
 * 
 * TtInvoiceHeader の検索条件Domainクラス
 * テーブル概要：TT_INVOICE_HEADER
 * 
...
/**
 * TtInvoiceHeader の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_INVOICE_HEADER<BR>
 * 
 * <BR>
 ...
 */
public class TtInvoiceHeaderCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * L_PORT_CNTRY_CD（小なりイコール）
     */
    private String lPortCntryCdLessThanEqual;

    /**
     * L_PORT_CNTRY_CD（前方一致）
     */
    ...
    /**
     * LOADING_PORT_CD（小なりイコール）
     */
    private String loadingPortCdLessThanEqual;

    /**
     * LOADING_PORT_CD（前方一致）
     */
    ...
    /**
     * LOADING_PORT_NM（小なりイコール）
     */
    private String loadingPortNmLessThanEqual;

    /**
     * LOADING_PORT_NM（前方一致）
     */
    ...
    /**
     * TOTAL_GROSS_WEIGHT_UNIT（大なり）
     */
    private String totalGrossWeightUnitGreaterThan;

    /**
     * TOTAL_GROSS_WEIGHT_UNIT（大なりイコール）
     */
    private String totalGrossWeightUnitGreaterThanEqual;

    /**
     * TOTAL_GROSS_WEIGHT_UNIT（小なり）
     */
    private String totalGrossWeightUnitLessThan;

    /**
     * TOTAL_GROSS_WEIGHT_UNIT（小なりイコール）
     */
    private String totalGrossWeightUnitLessThanEqual;

    /**
     * TOTAL_GROSS_WEIGHT_UNIT（前方一致）
     */
    private String totalGrossWeightUnitLikeFront;

    /**
     * TOTAL_VOLUME_UNIT（大なり）
     */
    private String totalVolumeUnitGreaterThan;

    /**
     * TOTAL_VOLUME_UNIT（大なりイコール）
     */
    private String totalVolumeUnitGreaterThanEqual;

    /**
     * TOTAL_VOLUME_UNIT（小なり）
     */
    private String totalVolumeUnitLessThan;

    /**
     * TOTAL_VOLUME_UNIT（小なりイコール）
     */
    private String totalVolumeUnitLessThanEqual;

    /**
     * TOTAL_VOLUME_UNIT（前方一致）
     */
    private String totalVolumeUnitLikeFront;
     ...
     * FREIGHT_CURR_CD（大なり）
     */
    private String freightCurrCdGreaterThan;

    /**
     * FREIGHT_CURR_CD（大なりイコール）
     */
    private String freightCurrCdGreaterThanEqual;

    /**
     * FREIGHT_CURR_CD（小なり）
     */
    private String freightCurrCdLessThan;

    /**
     * FREIGHT_CURR_CD（小なりイコール）
     */
    private String freightCurrCdLessThanEqual;

    /**
     * FREIGHT_CURR_CD（前方一致）
     */
    private String freightCurrCdLikeFront;

    /**
     * INSURANCE_CURR_CD（大なり）
     */
    private String insuranceCurrCdGreaterThan;

    /**
     * INSURANCE_CURR_CD（大なりイコール）
     */
    private String insuranceCurrCdGreaterThanEqual;

    /**
     * INSURANCE_CURR_CD（小なり）
     */
    private String insuranceCurrCdLessThan;

    /**
     * INSURANCE_CURR_CD（小なりイコール）
     */
    private String insuranceCurrCdLessThanEqual;

    /**
     * INSURANCE_CURR_CD（前方一致）
     */
    private String insuranceCurrCdLikeFront;

    /**
     * SUB_TOTAL_CURR_CD（大なり）
     */
    private String subTotalCurrCdGreaterThan;

    /**
     * SUB_TOTAL_CURR_CD（大なりイコール）
     */
    private String subTotalCurrCdGreaterThanEqual;

    /**
     * SUB_TOTAL_CURR_CD（小なり）
     */
    private String subTotalCurrCdLessThan;

    /**
     * SUB_TOTAL_CURR_CD（小なりイコール）
     */
    private String subTotalCurrCdLessThanEqual;

    /**
     * SUB_TOTAL_CURR_CD（前方一致）
     */
    private String subTotalCurrCdLikeFront;

    /**
     * VAT_CURR_CD（大なり）
     */
    private String vatCurrCdGreaterThan;

    /**
     * VAT_CURR_CD（大なりイコール）
     */
    private String vatCurrCdGreaterThanEqual;

    /**
     * VAT_CURR_CD（小なり）
     */
    private String vatCurrCdLessThan;

    /**
     * VAT_CURR_CD（小なりイコール）
     */
    private String vatCurrCdLessThanEqual;

    /**
     * VAT_CURR_CD（前方一致）
     */
    private String vatCurrCdLikeFront;

    /**
     * HANDLING_CHARGE_CURR_CD（大なり）
     */
    private String handlingChargeCurrCdGreaterThan;

    /**
     * HANDLING_CHARGE_CURR_CD（大なりイコール）
     */
    private String handlingChargeCurrCdGreaterThanEqual;

    /**
     * HANDLING_CHARGE_CURR_CD（小なり）
     */
    private String handlingChargeCurrCdLessThan;

    /**
     * HANDLING_CHARGE_CURR_CD（小なりイコール）
     */
    private String handlingChargeCurrCdLessThanEqual;

    /**
     * HANDLING_CHARGE_CURR_CD（前方一致）
     */
    private String handlingChargeCurrCdLikeFront;

    /**
     * ADDITIONAL_CHARGE_CD（大なり）
     */
    private String additionalChargeCdGreaterThan;

    /**
     * ADDITIONAL_CHARGE_CD（大なりイコール）
     */
    private String additionalChargeCdGreaterThanEqual;

    /**
     * ADDITIONAL_CHARGE_CD（小なり）
     */
    private String additionalChargeCdLessThan;

    /**
     * ADDITIONAL_CHARGE_CD（小なりイコール）
     */
    private String additionalChargeCdLessThanEqual;

    /**
     * ADDITIONAL_CHARGE_CD（前方一致）
     */
    private String additionalChargeCdLikeFront;

    /**
     * ADDITIONAL_CHARGE_NM（大なり）
     */
    private String additionalChargeNmGreaterThan;

    /**
     * ADDITIONAL_CHARGE_NM（大なりイコール）
     */
    private String additionalChargeNmGreaterThanEqual;

    /**
     * ADDITIONAL_CHARGE_NM（小なり）
     */
    private String additionalChargeNmLessThan;

    /**
     * ADDITIONAL_CHARGE_NM（小なりイコール）
     */
    private String additionalChargeNmLessThanEqual;

    /**
     * ADDITIONAL_CHARGE_NM（前方一致）
     */
    private String additionalChargeNmLikeFront;

    /**
     * ADDITIONAL_CHARGE_CURR_CD（大なり）
     */
    private String additionalChargeCurrCdGreaterThan;

    /**
     * ADDITIONAL_CHARGE_CURR_CD（大なりイコール）
     */
    private String additionalChargeCurrCdGreaterThanEqual;

    /**
     * ADDITIONAL_CHARGE_CURR_CD（小なり）
     */
    private String additionalChargeCurrCdLessThan;

    /**
     * ADDITIONAL_CHARGE_CURR_CD（小なりイコール）
     */
    private String additionalChargeCurrCdLessThanEqual;

    /**
     * ADDITIONAL_CHARGE_CURR_CD（前方一致）
     */
    private String additionalChargeCurrCdLikeFront;

    /**
     * TOTAL_INVOICE_AMOUNT_CURR_CD（大なり）
     */
    private String totalInvoiceAmountCurrCdGreaterThan;

    /**
     * TOTAL_INVOICE_AMOUNT_CURR_CD（大なりイコール）
     */
    private String totalInvoiceAmountCurrCdGreaterThanEqual;

    /**
     * TOTAL_INVOICE_AMOUNT_CURR_CD（小なり）
     */
    private String totalInvoiceAmountCurrCdLessThan;

    /**
     * TOTAL_INVOICE_AMOUNT_CURR_CD（小なりイコール）
     */
    private String totalInvoiceAmountCurrCdLessThanEqual;

    /**
     * TOTAL_INVOICE_AMOUNT_CURR_CD（前方一致）
     */
    private String totalInvoiceAmountCurrCdLikeFront;

    /**
     * NO_CHARGE_CURR_CD（大なり）
     */
    private String noChargeCurrCdGreaterThan;

    /**
     * NO_CHARGE_CURR_CD（大なりイコール）
     */
    private String noChargeCurrCdGreaterThanEqual;

    /**
     * NO_CHARGE_CURR_CD（小なり）
     */
    private String noChargeCurrCdLessThan;

    /**
     * NO_CHARGE_CURR_CD（小なりイコール）
     */
    private String noChargeCurrCdLessThanEqual;

    /**
     * NO_CHARGE_CURR_CD（前方一致）
     */
    private String noChargeCurrCdLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TtInvoiceHeaderCriteriaDomain() {
    }
    ...
    /**
     * freightCurrCd のセッターメソッドです。
     * 
     * @param freightCurrCd freightCurrCd に設定する
     */
    ...
    /**
     * insuranceCurrCd のセッターメソッドです。
     * 
     * @param insuranceCurrCd insuranceCurrCd に設定する
     */
    ...
    /**
     * subTotalCurrCd のセッターメソッドです。
     * 
     * @param subTotalCurrCd subTotalCurrCd に設定する
     */
    ...
    /**
     * vatCurrCd のセッターメソッドです。
     * 
     * @param vatCurrCd vatCurrCd に設定する
     */
    ...
    /**
     * handlingChargeCurrCd のゲッターメソッドです。
     * 
    ...
    /**
     * handlingChargeCurrCd のセッターメソッドです。
     * 
     * @param handlingChargeCurrCd handlingChargeCurrCd に設定する
     */
    ...
    /**
     * additionalChargeCurrCd のゲッターメソッドです。
     * 
    ...
    /**
     * additionalChargeCurrCd のセッターメソッドです。
     * 
     * @param additionalChargeCurrCd additionalChargeCurrCd に設定する
     */
    ...
    /**
     * totalInvoiceAmountCurrCd のゲッターメソッドです。
     * 
    ...
    /**
     * totalInvoiceAmountCurrCd のセッターメソッドです。
     * 
     * @param totalInvoiceAmountCurrCd totalInvoiceAmountCurrCd に設定する
     */
    ...
    /**
     * noChargeCurrCd のゲッターメソッドです。
     * 
     * @return the noChargeCurrCd
     */
    public String getNoChargeCurrCd() {
        return noChargeCurrCd;
    }

    /**
     * noChargeCurrCd のセッターメソッドです。
     * 
     * @param noChargeCurrCd noChargeCurrCd に設定する
     */
    public void setNoChargeCurrCd(String noChargeCurrCd) {
        this.noChargeCurrCd = noChargeCurrCd;
    }
    ...
    /**
     * totalGrossWeightUnitGreaterThan のゲッターメソッドです。
     * 
     * @return the totalGrossWeightUnitGreaterThan
     */
    public String getTotalGrossWeightUnitGreaterThan() {
        return totalGrossWeightUnitGreaterThan;
    }

    /**
     * totalGrossWeightUnitGreaterThan のセッターメソッドです。
     * 
     * @param totalGrossWeightUnitGreaterThan totalGrossWeightUnitGreaterThan に設定する
     */
    public void setTotalGrossWeightUnitGreaterThan(String totalGrossWeightUnitGreaterThan) {
        this.totalGrossWeightUnitGreaterThan = totalGrossWeightUnitGreaterThan;
    }

    /**
     * totalGrossWeightUnitGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the totalGrossWeightUnitGreaterThanEqual
     */
    public String getTotalGrossWeightUnitGreaterThanEqual() {
        return totalGrossWeightUnitGreaterThanEqual;
    }

    /**
     * totalGrossWeightUnitGreaterThanEqual のセッターメソッドです。
     * 
     * @param totalGrossWeightUnitGreaterThanEqual totalGrossWeightUnitGreaterThanEqual に設定する
     */
    public void setTotalGrossWeightUnitGreaterThanEqual(String totalGrossWeightUnitGreaterThanEqual) {
        this.totalGrossWeightUnitGreaterThanEqual = totalGrossWeightUnitGreaterThanEqual;
    }

    /**
     * totalGrossWeightUnitLessThan のゲッターメソッドです。
     * 
     * @return the totalGrossWeightUnitLessThan
     */
    public String getTotalGrossWeightUnitLessThan() {
        return totalGrossWeightUnitLessThan;
    }

    /**
     * totalGrossWeightUnitLessThan のセッターメソッドです。
     * 
     * @param totalGrossWeightUnitLessThan totalGrossWeightUnitLessThan に設定する
     */
    public void setTotalGrossWeightUnitLessThan(String totalGrossWeightUnitLessThan) {
        this.totalGrossWeightUnitLessThan = totalGrossWeightUnitLessThan;
    }

    /**
     * totalGrossWeightUnitLessThanEqual のゲッターメソッドです。
     * 
     * @return the totalGrossWeightUnitLessThanEqual
     */
    public String getTotalGrossWeightUnitLessThanEqual() {
        return totalGrossWeightUnitLessThanEqual;
    }

    /**
     * totalGrossWeightUnitLessThanEqual のセッターメソッドです。
     * 
     * @param totalGrossWeightUnitLessThanEqual totalGrossWeightUnitLessThanEqual に設定する
     */
    public void setTotalGrossWeightUnitLessThanEqual(String totalGrossWeightUnitLessThanEqual) {
        this.totalGrossWeightUnitLessThanEqual = totalGrossWeightUnitLessThanEqual;
    }

    /**
     * totalGrossWeightUnitLikeFront のゲッターメソッドです。
     * 
     * @return the totalGrossWeightUnitLikeFront
     */
    public String getTotalGrossWeightUnitLikeFront() {
        return totalGrossWeightUnitLikeFront;
    }

    /**
     * totalGrossWeightUnitLikeFront のセッターメソッドです。
     * 
     * @param totalGrossWeightUnitLikeFront totalGrossWeightUnitLikeFront に設定する
     */
    public void setTotalGrossWeightUnitLikeFront(String totalGrossWeightUnitLikeFront) {
        this.totalGrossWeightUnitLikeFront = totalGrossWeightUnitLikeFront;
    }

    /**
     * totalVolumeUnitGreaterThan のゲッターメソッドです。
     * 
     * @return the totalVolumeUnitGreaterThan
     */
    public String getTotalVolumeUnitGreaterThan() {
        return totalVolumeUnitGreaterThan;
    }

    /**
     * totalVolumeUnitGreaterThan のセッターメソッドです。
     * 
     * @param totalVolumeUnitGreaterThan totalVolumeUnitGreaterThan に設定する
     */
    public void setTotalVolumeUnitGreaterThan(String totalVolumeUnitGreaterThan) {
        this.totalVolumeUnitGreaterThan = totalVolumeUnitGreaterThan;
    }

    /**
     * totalVolumeUnitGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the totalVolumeUnitGreaterThanEqual
     */
    public String getTotalVolumeUnitGreaterThanEqual() {
        return totalVolumeUnitGreaterThanEqual;
    }

    /**
     * totalVolumeUnitGreaterThanEqual のセッターメソッドです。
     * 
     * @param totalVolumeUnitGreaterThanEqual totalVolumeUnitGreaterThanEqual に設定する
     */
    public void setTotalVolumeUnitGreaterThanEqual(String totalVolumeUnitGreaterThanEqual) {
        this.totalVolumeUnitGreaterThanEqual = totalVolumeUnitGreaterThanEqual;
    }

    /**
     * totalVolumeUnitLessThan のゲッターメソッドです。
     * 
     * @return the totalVolumeUnitLessThan
     */
    public String getTotalVolumeUnitLessThan() {
        return totalVolumeUnitLessThan;
    }

    /**
     * totalVolumeUnitLessThan のセッターメソッドです。
     * 
     * @param totalVolumeUnitLessThan totalVolumeUnitLessThan に設定する
     */
    public void setTotalVolumeUnitLessThan(String totalVolumeUnitLessThan) {
        this.totalVolumeUnitLessThan = totalVolumeUnitLessThan;
    }

    /**
     * totalVolumeUnitLessThanEqual のゲッターメソッドです。
     * 
     * @return the totalVolumeUnitLessThanEqual
     */
    public String getTotalVolumeUnitLessThanEqual() {
        return totalVolumeUnitLessThanEqual;
    }

    /**
     * totalVolumeUnitLessThanEqual のセッターメソッドです。
     * 
     * @param totalVolumeUnitLessThanEqual totalVolumeUnitLessThanEqual に設定する
     */
    public void setTotalVolumeUnitLessThanEqual(String totalVolumeUnitLessThanEqual) {
        this.totalVolumeUnitLessThanEqual = totalVolumeUnitLessThanEqual;
    }

    /**
     * totalVolumeUnitLikeFront のゲッターメソッドです。
     * 
     * @return the totalVolumeUnitLikeFront
     */
    public String getTotalVolumeUnitLikeFront() {
        return totalVolumeUnitLikeFront;
    }

    /**
     * totalVolumeUnitLikeFront のセッターメソッドです。
     * 
     * @param totalVolumeUnitLikeFront totalVolumeUnitLikeFront に設定する
     */
    public void setTotalVolumeUnitLikeFront(String totalVolumeUnitLikeFront) {
        this.totalVolumeUnitLikeFront = totalVolumeUnitLikeFront;
    }
    ...
    /**
     * freightCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the freightCurrCdGreaterThan
     */
    public String getFreightCurrCdGreaterThan() {
        return freightCurrCdGreaterThan;
    }

    /**
     * freightCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param freightCurrCdGreaterThan freightCurrCdGreaterThan に設定する
     */
    public void setFreightCurrCdGreaterThan(String freightCurrCdGreaterThan) {
        this.freightCurrCdGreaterThan = freightCurrCdGreaterThan;
    }

    /**
     * freightCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the freightCurrCdGreaterThanEqual
     */
    public String getFreightCurrCdGreaterThanEqual() {
        return freightCurrCdGreaterThanEqual;
    }

    /**
     * freightCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param freightCurrCdGreaterThanEqual freightCurrCdGreaterThanEqual に設定する
     */
    public void setFreightCurrCdGreaterThanEqual(String freightCurrCdGreaterThanEqual) {
        this.freightCurrCdGreaterThanEqual = freightCurrCdGreaterThanEqual;
    }

    /**
     * freightCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the freightCurrCdLessThan
     */
    public String getFreightCurrCdLessThan() {
        return freightCurrCdLessThan;
    }

    /**
     * freightCurrCdLessThan のセッターメソッドです。
     * 
     * @param freightCurrCdLessThan freightCurrCdLessThan に設定する
     */
    public void setFreightCurrCdLessThan(String freightCurrCdLessThan) {
        this.freightCurrCdLessThan = freightCurrCdLessThan;
    }

    /**
     * freightCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the freightCurrCdLessThanEqual
     */
    public String getFreightCurrCdLessThanEqual() {
        return freightCurrCdLessThanEqual;
    }

    /**
     * freightCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param freightCurrCdLessThanEqual freightCurrCdLessThanEqual に設定する
     */
    public void setFreightCurrCdLessThanEqual(String freightCurrCdLessThanEqual) {
        this.freightCurrCdLessThanEqual = freightCurrCdLessThanEqual;
    }

    /**
     * freightCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the freightCurrCdLikeFront
     */
    public String getFreightCurrCdLikeFront() {
        return freightCurrCdLikeFront;
    }

    /**
     * freightCurrCdLikeFront のセッターメソッドです。
     * 
     * @param freightCurrCdLikeFront freightCurrCdLikeFront に設定する
     */
    public void setFreightCurrCdLikeFront(String freightCurrCdLikeFront) {
        this.freightCurrCdLikeFront = freightCurrCdLikeFront;
    }

    /**
     * insuranceCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the insuranceCurrCdGreaterThan
     */
    public String getInsuranceCurrCdGreaterThan() {
        return insuranceCurrCdGreaterThan;
    }

    /**
     * insuranceCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param insuranceCurrCdGreaterThan insuranceCurrCdGreaterThan に設定する
     */
    public void setInsuranceCurrCdGreaterThan(String insuranceCurrCdGreaterThan) {
        this.insuranceCurrCdGreaterThan = insuranceCurrCdGreaterThan;
    }

    /**
     * insuranceCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the insuranceCurrCdGreaterThanEqual
     */
    public String getInsuranceCurrCdGreaterThanEqual() {
        return insuranceCurrCdGreaterThanEqual;
    }

    /**
     * insuranceCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param insuranceCurrCdGreaterThanEqual insuranceCurrCdGreaterThanEqual に設定する
     */
    public void setInsuranceCurrCdGreaterThanEqual(String insuranceCurrCdGreaterThanEqual) {
        this.insuranceCurrCdGreaterThanEqual = insuranceCurrCdGreaterThanEqual;
    }

    /**
     * insuranceCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the insuranceCurrCdLessThan
     */
    public String getInsuranceCurrCdLessThan() {
        return insuranceCurrCdLessThan;
    }

    /**
     * insuranceCurrCdLessThan のセッターメソッドです。
     * 
     * @param insuranceCurrCdLessThan insuranceCurrCdLessThan に設定する
     */
    public void setInsuranceCurrCdLessThan(String insuranceCurrCdLessThan) {
        this.insuranceCurrCdLessThan = insuranceCurrCdLessThan;
    }

    /**
     * insuranceCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the insuranceCurrCdLessThanEqual
     */
    public String getInsuranceCurrCdLessThanEqual() {
        return insuranceCurrCdLessThanEqual;
    }

    /**
     * insuranceCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param insuranceCurrCdLessThanEqual insuranceCurrCdLessThanEqual に設定する
     */
    public void setInsuranceCurrCdLessThanEqual(String insuranceCurrCdLessThanEqual) {
        this.insuranceCurrCdLessThanEqual = insuranceCurrCdLessThanEqual;
    }

    /**
     * insuranceCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the insuranceCurrCdLikeFront
     */
    public String getInsuranceCurrCdLikeFront() {
        return insuranceCurrCdLikeFront;
    }

    /**
     * insuranceCurrCdLikeFront のセッターメソッドです。
     * 
     * @param insuranceCurrCdLikeFront insuranceCurrCdLikeFront に設定する
     */
    public void setInsuranceCurrCdLikeFront(String insuranceCurrCdLikeFront) {
        this.insuranceCurrCdLikeFront = insuranceCurrCdLikeFront;
    }

    /**
     * subTotalCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the subTotalCurrCdGreaterThan
     */
    public String getSubTotalCurrCdGreaterThan() {
        return subTotalCurrCdGreaterThan;
    }

    /**
     * subTotalCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param subTotalCurrCdGreaterThan subTotalCurrCdGreaterThan に設定する
     */
    public void setSubTotalCurrCdGreaterThan(String subTotalCurrCdGreaterThan) {
        this.subTotalCurrCdGreaterThan = subTotalCurrCdGreaterThan;
    }

    /**
     * subTotalCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the subTotalCurrCdGreaterThanEqual
     */
    public String getSubTotalCurrCdGreaterThanEqual() {
        return subTotalCurrCdGreaterThanEqual;
    }

    /**
     * subTotalCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param subTotalCurrCdGreaterThanEqual subTotalCurrCdGreaterThanEqual に設定する
     */
    public void setSubTotalCurrCdGreaterThanEqual(String subTotalCurrCdGreaterThanEqual) {
        this.subTotalCurrCdGreaterThanEqual = subTotalCurrCdGreaterThanEqual;
    }

    /**
     * subTotalCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the subTotalCurrCdLessThan
     */
    public String getSubTotalCurrCdLessThan() {
        return subTotalCurrCdLessThan;
    }

    /**
     * subTotalCurrCdLessThan のセッターメソッドです。
     * 
     * @param subTotalCurrCdLessThan subTotalCurrCdLessThan に設定する
     */
    public void setSubTotalCurrCdLessThan(String subTotalCurrCdLessThan) {
        this.subTotalCurrCdLessThan = subTotalCurrCdLessThan;
    }

    /**
     * subTotalCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the subTotalCurrCdLessThanEqual
     */
    public String getSubTotalCurrCdLessThanEqual() {
        return subTotalCurrCdLessThanEqual;
    }

    /**
     * subTotalCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param subTotalCurrCdLessThanEqual subTotalCurrCdLessThanEqual に設定する
     */
    public void setSubTotalCurrCdLessThanEqual(String subTotalCurrCdLessThanEqual) {
        this.subTotalCurrCdLessThanEqual = subTotalCurrCdLessThanEqual;
    }

    /**
     * subTotalCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the subTotalCurrCdLikeFront
     */
    public String getSubTotalCurrCdLikeFront() {
        return subTotalCurrCdLikeFront;
    }

    /**
     * subTotalCurrCdLikeFront のセッターメソッドです。
     * 
     * @param subTotalCurrCdLikeFront subTotalCurrCdLikeFront に設定する
     */
    public void setSubTotalCurrCdLikeFront(String subTotalCurrCdLikeFront) {
        this.subTotalCurrCdLikeFront = subTotalCurrCdLikeFront;
    }

    /**
     * vatCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the vatCurrCdGreaterThan
     */
    public String getVatCurrCdGreaterThan() {
        return vatCurrCdGreaterThan;
    }

    /**
     * vatCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param vatCurrCdGreaterThan vatCurrCdGreaterThan に設定する
     */
    public void setVatCurrCdGreaterThan(String vatCurrCdGreaterThan) {
        this.vatCurrCdGreaterThan = vatCurrCdGreaterThan;
    }

    /**
     * vatCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the vatCurrCdGreaterThanEqual
     */
    public String getVatCurrCdGreaterThanEqual() {
        return vatCurrCdGreaterThanEqual;
    }

    /**
     * vatCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param vatCurrCdGreaterThanEqual vatCurrCdGreaterThanEqual に設定する
     */
    public void setVatCurrCdGreaterThanEqual(String vatCurrCdGreaterThanEqual) {
        this.vatCurrCdGreaterThanEqual = vatCurrCdGreaterThanEqual;
    }

    /**
     * vatCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the vatCurrCdLessThan
     */
    public String getVatCurrCdLessThan() {
        return vatCurrCdLessThan;
    }

    /**
     * vatCurrCdLessThan のセッターメソッドです。
     * 
     * @param vatCurrCdLessThan vatCurrCdLessThan に設定する
     */
    public void setVatCurrCdLessThan(String vatCurrCdLessThan) {
        this.vatCurrCdLessThan = vatCurrCdLessThan;
    }

    /**
     * vatCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the vatCurrCdLessThanEqual
     */
    public String getVatCurrCdLessThanEqual() {
        return vatCurrCdLessThanEqual;
    }

    /**
     * vatCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param vatCurrCdLessThanEqual vatCurrCdLessThanEqual に設定する
     */
    public void setVatCurrCdLessThanEqual(String vatCurrCdLessThanEqual) {
        this.vatCurrCdLessThanEqual = vatCurrCdLessThanEqual;
    }

    /**
     * vatCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the vatCurrCdLikeFront
     */
    public String getVatCurrCdLikeFront() {
        return vatCurrCdLikeFront;
    }

    /**
     * vatCurrCdLikeFront のセッターメソッドです。
     * 
     * @param vatCurrCdLikeFront vatCurrCdLikeFront に設定する
     */
    public void setVatCurrCdLikeFront(String vatCurrCdLikeFront) {
        this.vatCurrCdLikeFront = vatCurrCdLikeFront;
    }

    /**
     * handlingChargeCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the handlingChargeCurrCdGreaterThan
     */
    public String getHandlingChargeCurrCdGreaterThan() {
        return handlingChargeCurrCdGreaterThan;
    }

    /**
     * handlingChargeCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param handlingChargeCurrCdGreaterThan handlingChargeCurrCdGreaterThan に設定する
     */
    public void setHandlingChargeCurrCdGreaterThan(String handlingChargeCurrCdGreaterThan) {
        this.handlingChargeCurrCdGreaterThan = handlingChargeCurrCdGreaterThan;
    }

    /**
     * handlingChargeCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the handlingChargeCurrCdGreaterThanEqual
     */
    public String getHandlingChargeCurrCdGreaterThanEqual() {
        return handlingChargeCurrCdGreaterThanEqual;
    }

    /**
     * handlingChargeCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param handlingChargeCurrCdGreaterThanEqual handlingChargeCurrCdGreaterThanEqual に設定する
     */
    public void setHandlingChargeCurrCdGreaterThanEqual(String handlingChargeCurrCdGreaterThanEqual) {
        this.handlingChargeCurrCdGreaterThanEqual = handlingChargeCurrCdGreaterThanEqual;
    }

    /**
     * handlingChargeCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the handlingChargeCurrCdLessThan
     */
    public String getHandlingChargeCurrCdLessThan() {
        return handlingChargeCurrCdLessThan;
    }

    /**
     * handlingChargeCurrCdLessThan のセッターメソッドです。
     * 
     * @param handlingChargeCurrCdLessThan handlingChargeCurrCdLessThan に設定する
     */
    public void setHandlingChargeCurrCdLessThan(String handlingChargeCurrCdLessThan) {
        this.handlingChargeCurrCdLessThan = handlingChargeCurrCdLessThan;
    }

    /**
     * handlingChargeCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the handlingChargeCurrCdLessThanEqual
     */
    public String getHandlingChargeCurrCdLessThanEqual() {
        return handlingChargeCurrCdLessThanEqual;
    }

    /**
     * handlingChargeCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param handlingChargeCurrCdLessThanEqual handlingChargeCurrCdLessThanEqual に設定する
     */
    public void setHandlingChargeCurrCdLessThanEqual(String handlingChargeCurrCdLessThanEqual) {
        this.handlingChargeCurrCdLessThanEqual = handlingChargeCurrCdLessThanEqual;
    }

    /**
     * handlingChargeCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the handlingChargeCurrCdLikeFront
     */
    public String getHandlingChargeCurrCdLikeFront() {
        return handlingChargeCurrCdLikeFront;
    }

    /**
     * handlingChargeCurrCdLikeFront のセッターメソッドです。
     * 
     * @param handlingChargeCurrCdLikeFront handlingChargeCurrCdLikeFront に設定する
     */
    public void setHandlingChargeCurrCdLikeFront(String handlingChargeCurrCdLikeFront) {
        this.handlingChargeCurrCdLikeFront = handlingChargeCurrCdLikeFront;
    }
    ...
    /**
     * additionalChargeCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the additionalChargeCurrCdGreaterThan
     */
    public String getAdditionalChargeCurrCdGreaterThan() {
        return additionalChargeCurrCdGreaterThan;
    }

    /**
     * additionalChargeCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param additionalChargeCurrCdGreaterThan additionalChargeCurrCdGreaterThan に設定する
     */
    public void setAdditionalChargeCurrCdGreaterThan(String additionalChargeCurrCdGreaterThan) {
        this.additionalChargeCurrCdGreaterThan = additionalChargeCurrCdGreaterThan;
    }

    /**
     * additionalChargeCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the additionalChargeCurrCdGreaterThanEqual
     */
    public String getAdditionalChargeCurrCdGreaterThanEqual() {
        return additionalChargeCurrCdGreaterThanEqual;
    }

    /**
     * additionalChargeCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param additionalChargeCurrCdGreaterThanEqual additionalChargeCurrCdGreaterThanEqual に設定する
     */
    public void setAdditionalChargeCurrCdGreaterThanEqual(String additionalChargeCurrCdGreaterThanEqual) {
        this.additionalChargeCurrCdGreaterThanEqual = additionalChargeCurrCdGreaterThanEqual;
    }

    /**
     * additionalChargeCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the additionalChargeCurrCdLessThan
     */
    public String getAdditionalChargeCurrCdLessThan() {
        return additionalChargeCurrCdLessThan;
    }

    /**
     * additionalChargeCurrCdLessThan のセッターメソッドです。
     * 
     * @param additionalChargeCurrCdLessThan additionalChargeCurrCdLessThan に設定する
     */
    public void setAdditionalChargeCurrCdLessThan(String additionalChargeCurrCdLessThan) {
        this.additionalChargeCurrCdLessThan = additionalChargeCurrCdLessThan;
    }

    /**
     * additionalChargeCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the additionalChargeCurrCdLessThanEqual
     */
    public String getAdditionalChargeCurrCdLessThanEqual() {
        return additionalChargeCurrCdLessThanEqual;
    }

    /**
     * additionalChargeCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param additionalChargeCurrCdLessThanEqual additionalChargeCurrCdLessThanEqual に設定する
     */
    public void setAdditionalChargeCurrCdLessThanEqual(String additionalChargeCurrCdLessThanEqual) {
        this.additionalChargeCurrCdLessThanEqual = additionalChargeCurrCdLessThanEqual;
    }

    /**
     * additionalChargeCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the additionalChargeCurrCdLikeFront
     */
    public String getAdditionalChargeCurrCdLikeFront() {
        return additionalChargeCurrCdLikeFront;
    }

    /**
     * additionalChargeCurrCdLikeFront のセッターメソッドです。
     * 
     * @param additionalChargeCurrCdLikeFront additionalChargeCurrCdLikeFront に設定する
     */
    public void setAdditionalChargeCurrCdLikeFront(String additionalChargeCurrCdLikeFront) {
        this.additionalChargeCurrCdLikeFront = additionalChargeCurrCdLikeFront;
    }

    /**
     * totalInvoiceAmountCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the totalInvoiceAmountCurrCdGreaterThan
     */
    public String getTotalInvoiceAmountCurrCdGreaterThan() {
        return totalInvoiceAmountCurrCdGreaterThan;
    }

    /**
     * totalInvoiceAmountCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param totalInvoiceAmountCurrCdGreaterThan totalInvoiceAmountCurrCdGreaterThan に設定する
     */
    public void setTotalInvoiceAmountCurrCdGreaterThan(String totalInvoiceAmountCurrCdGreaterThan) {
        this.totalInvoiceAmountCurrCdGreaterThan = totalInvoiceAmountCurrCdGreaterThan;
    }

    /**
     * totalInvoiceAmountCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the totalInvoiceAmountCurrCdGreaterThanEqual
     */
    public String getTotalInvoiceAmountCurrCdGreaterThanEqual() {
        return totalInvoiceAmountCurrCdGreaterThanEqual;
    }

    /**
     * totalInvoiceAmountCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param totalInvoiceAmountCurrCdGreaterThanEqual totalInvoiceAmountCurrCdGreaterThanEqual に設定する
     */
    public void setTotalInvoiceAmountCurrCdGreaterThanEqual(String totalInvoiceAmountCurrCdGreaterThanEqual) {
        this.totalInvoiceAmountCurrCdGreaterThanEqual = totalInvoiceAmountCurrCdGreaterThanEqual;
    }

    /**
     * totalInvoiceAmountCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the totalInvoiceAmountCurrCdLessThan
     */
    public String getTotalInvoiceAmountCurrCdLessThan() {
        return totalInvoiceAmountCurrCdLessThan;
    }

    /**
     * totalInvoiceAmountCurrCdLessThan のセッターメソッドです。
     * 
     * @param totalInvoiceAmountCurrCdLessThan totalInvoiceAmountCurrCdLessThan に設定する
     */
    public void setTotalInvoiceAmountCurrCdLessThan(String totalInvoiceAmountCurrCdLessThan) {
        this.totalInvoiceAmountCurrCdLessThan = totalInvoiceAmountCurrCdLessThan;
    }

    /**
     * totalInvoiceAmountCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the totalInvoiceAmountCurrCdLessThanEqual
     */
    public String getTotalInvoiceAmountCurrCdLessThanEqual() {
        return totalInvoiceAmountCurrCdLessThanEqual;
    }

    /**
     * totalInvoiceAmountCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param totalInvoiceAmountCurrCdLessThanEqual totalInvoiceAmountCurrCdLessThanEqual に設定する
     */
    public void setTotalInvoiceAmountCurrCdLessThanEqual(String totalInvoiceAmountCurrCdLessThanEqual) {
        this.totalInvoiceAmountCurrCdLessThanEqual = totalInvoiceAmountCurrCdLessThanEqual;
    }

    /**
     * totalInvoiceAmountCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the totalInvoiceAmountCurrCdLikeFront
     */
    public String getTotalInvoiceAmountCurrCdLikeFront() {
        return totalInvoiceAmountCurrCdLikeFront;
    }

    /**
     * totalInvoiceAmountCurrCdLikeFront のセッターメソッドです。
     * 
     * @param totalInvoiceAmountCurrCdLikeFront totalInvoiceAmountCurrCdLikeFront に設定する
     */
    public void setTotalInvoiceAmountCurrCdLikeFront(String totalInvoiceAmountCurrCdLikeFront) {
        this.totalInvoiceAmountCurrCdLikeFront = totalInvoiceAmountCurrCdLikeFront;
    }

    /**
     * noChargeCurrCdGreaterThan のゲッターメソッドです。
     * 
     * @return the noChargeCurrCdGreaterThan
     */
    public String getNoChargeCurrCdGreaterThan() {
        return noChargeCurrCdGreaterThan;
    }

    /**
     * noChargeCurrCdGreaterThan のセッターメソッドです。
     * 
     * @param noChargeCurrCdGreaterThan noChargeCurrCdGreaterThan に設定する
     */
    public void setNoChargeCurrCdGreaterThan(String noChargeCurrCdGreaterThan) {
        this.noChargeCurrCdGreaterThan = noChargeCurrCdGreaterThan;
    }

    /**
     * noChargeCurrCdGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the noChargeCurrCdGreaterThanEqual
     */
    public String getNoChargeCurrCdGreaterThanEqual() {
        return noChargeCurrCdGreaterThanEqual;
    }

    /**
     * noChargeCurrCdGreaterThanEqual のセッターメソッドです。
     * 
     * @param noChargeCurrCdGreaterThanEqual noChargeCurrCdGreaterThanEqual に設定する
     */
    public void setNoChargeCurrCdGreaterThanEqual(String noChargeCurrCdGreaterThanEqual) {
        this.noChargeCurrCdGreaterThanEqual = noChargeCurrCdGreaterThanEqual;
    }

    /**
     * noChargeCurrCdLessThan のゲッターメソッドです。
     * 
     * @return the noChargeCurrCdLessThan
     */
    public String getNoChargeCurrCdLessThan() {
        return noChargeCurrCdLessThan;
    }

    /**
     * noChargeCurrCdLessThan のセッターメソッドです。
     * 
     * @param noChargeCurrCdLessThan noChargeCurrCdLessThan に設定する
     */
    public void setNoChargeCurrCdLessThan(String noChargeCurrCdLessThan) {
        this.noChargeCurrCdLessThan = noChargeCurrCdLessThan;
    }

    /**
     * noChargeCurrCdLessThanEqual のゲッターメソッドです。
     * 
     * @return the noChargeCurrCdLessThanEqual
     */
    public String getNoChargeCurrCdLessThanEqual() {
        return noChargeCurrCdLessThanEqual;
    }

    /**
     * noChargeCurrCdLessThanEqual のセッターメソッドです。
     * 
     * @param noChargeCurrCdLessThanEqual noChargeCurrCdLessThanEqual に設定する
     */
    public void setNoChargeCurrCdLessThanEqual(String noChargeCurrCdLessThanEqual) {
        this.noChargeCurrCdLessThanEqual = noChargeCurrCdLessThanEqual;
    }

    /**
     * noChargeCurrCdLikeFront のゲッターメソッドです。
     * 
     * @return the noChargeCurrCdLikeFront
     */
    public String getNoChargeCurrCdLikeFront() {
        return noChargeCurrCdLikeFront;
    }

    /**
     * noChargeCurrCdLikeFront のセッターメソッドです。
     * 
     * @param noChargeCurrCdLikeFront noChargeCurrCdLikeFront に設定する
     */
    public void setNoChargeCurrCdLikeFront(String noChargeCurrCdLikeFront) {
        this.noChargeCurrCdLikeFront = noChargeCurrCdLikeFront;
    }
