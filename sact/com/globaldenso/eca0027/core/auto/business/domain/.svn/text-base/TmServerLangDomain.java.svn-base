 ...
 * PROJECT：eca0027
 * 
 * TmServerLang のDomainクラス
 * テーブル概要：TM_SERVER_LANG
 * 
...
/**
 * TmServerLang のDomainクラスです。<BR>
 * テーブル概要：TM_SERVER_LANG<BR>
 * 
 * <BR>
 ...
 */
public class TmServerLangDomain extends AbstractDomain implements Serializable {
