 ...
 * PROJECT：eca0027
 * 
 * VtRpInvAtchedForMain の検索条件Domainクラス
 * テーブル概要：VT_RP_INV_ATCHED_FOR_MAIN
 * 
...
/**
 * VtRpInvAtchedForMain の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_INV_ATCHED_FOR_MAIN<BR>
 * 
 * <BR>
 ...
 */
public class VtRpInvAtchedForMainCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpInvAtchedForMainCriteriaDomain() {
    }
