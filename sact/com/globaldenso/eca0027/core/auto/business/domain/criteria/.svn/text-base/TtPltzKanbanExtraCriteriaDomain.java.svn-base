 ...
 * PROJECT：eca0027
 * 
 * TtPltzKanbanExtra の検索条件Domainクラス
 * テーブル概要：TT_PLTZ_KANBAN_EXTRA
 * 
...
/**
 * TtPltzKanbanExtra の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_PLTZ_KANBAN_EXTRA<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public class TtPltzKanbanExtraCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * IMP_CUSTOMER_REGULATE_NO（大なり）
     */
    private String impCustomerRegulateNoGreaterThan;

    /**
     * IMP_CUSTOMER_REGULATE_NO（大なりイコール）
     */
    private String impCustomerRegulateNoGreaterThanEqual;

    /**
     * IMP_CUSTOMER_REGULATE_NO（小なり）
     */
    private String impCustomerRegulateNoLessThan;

    /**
     * IMP_CUSTOMER_REGULATE_NO（小なりイコール）
     */
    private String impCustomerRegulateNoLessThanEqual;

    /**
     * IMP_CUSTOMER_REGULATE_NO（前方一致）
     */
    private String impCustomerRegulateNoLikeFront;

    /**
     * PRODUCT_DATE（大なりイコール）
     */
    private Date productDateGreaterThanEqual;

    /**
     * PRODUCT_DATE（小なりイコール）
     */
    private Date productDateLessThanEqual;

    /**
     * ORDER_NO（大なり）
     */
    private String orderNoGreaterThan;

    /**
     * ORDER_NO（大なりイコール）
     */
    private String orderNoGreaterThanEqual;

    /**
     * ORDER_NO（小なり）
     */
    private String orderNoLessThan;

    /**
     * ORDER_NO（小なりイコール）
     */
    private String orderNoLessThanEqual;

    /**
     * ORDER_NO（前方一致）
     */
    private String orderNoLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TtPltzKanbanExtraCriteriaDomain() {
    }
    ...
    /**
     * productDate のセッターメソッドです。
     * 
     * @param productDate productDate に設定する
     */
    ...
    /**
     * productDateGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the productDateGreaterThanEqual
     */
    public Date getProductDateGreaterThanEqual() {
        return productDateGreaterThanEqual;
    }

    /**
     * productDateGreaterThanEqual のセッターメソッドです。
     * 
     * @param productDateGreaterThanEqual productDateGreaterThanEqual に設定する
     */
    public void setProductDateGreaterThanEqual(Date productDateGreaterThanEqual) {
        this.productDateGreaterThanEqual = productDateGreaterThanEqual;
    }

    /**
     * productDateLessThanEqual のゲッターメソッドです。
     * 
     * @return the productDateLessThanEqual
     */
    public Date getProductDateLessThanEqual() {
        return productDateLessThanEqual;
    }

    /**
     * productDateLessThanEqual のセッターメソッドです。
     * 
     * @param productDateLessThanEqual productDateLessThanEqual に設定する
     */
    public void setProductDateLessThanEqual(Date productDateLessThanEqual) {
        this.productDateLessThanEqual = productDateLessThanEqual;
    }

    /**
     * orderNoGreaterThan のゲッターメソッドです。
     * 
     * @return the orderNoGreaterThan
     */
    public String getOrderNoGreaterThan() {
        return orderNoGreaterThan;
    }

    /**
     * orderNoGreaterThan のセッターメソッドです。
     * 
     * @param orderNoGreaterThan orderNoGreaterThan に設定する
     */
    public void setOrderNoGreaterThan(String orderNoGreaterThan) {
        this.orderNoGreaterThan = orderNoGreaterThan;
    }

    /**
     * orderNoGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the orderNoGreaterThanEqual
     */
    public String getOrderNoGreaterThanEqual() {
        return orderNoGreaterThanEqual;
    }

    /**
     * orderNoGreaterThanEqual のセッターメソッドです。
     * 
     * @param orderNoGreaterThanEqual orderNoGreaterThanEqual に設定する
     */
    public void setOrderNoGreaterThanEqual(String orderNoGreaterThanEqual) {
        this.orderNoGreaterThanEqual = orderNoGreaterThanEqual;
    }

    /**
     * orderNoLessThan のゲッターメソッドです。
     * 
     * @return the orderNoLessThan
     */
    public String getOrderNoLessThan() {
        return orderNoLessThan;
    }

    /**
     * orderNoLessThan のセッターメソッドです。
     * 
     * @param orderNoLessThan orderNoLessThan に設定する
     */
    public void setOrderNoLessThan(String orderNoLessThan) {
        this.orderNoLessThan = orderNoLessThan;
    }

    /**
     * orderNoLessThanEqual のゲッターメソッドです。
     * 
     * @return the orderNoLessThanEqual
     */
    public String getOrderNoLessThanEqual() {
        return orderNoLessThanEqual;
    }

    /**
     * orderNoLessThanEqual のセッターメソッドです。
     * 
     * @param orderNoLessThanEqual orderNoLessThanEqual に設定する
     */
    public void setOrderNoLessThanEqual(String orderNoLessThanEqual) {
        this.orderNoLessThanEqual = orderNoLessThanEqual;
    }

    /**
     * orderNoLikeFront のゲッターメソッドです。
     * 
     * @return the orderNoLikeFront
     */
    public String getOrderNoLikeFront() {
        return orderNoLikeFront;
    }

    /**
     * orderNoLikeFront のセッターメソッドです。
     * 
     * @param orderNoLikeFront orderNoLikeFront に設定する
     */
    public void setOrderNoLikeFront(String orderNoLikeFront) {
        this.orderNoLikeFront = orderNoLikeFront;
    }
