 ...
 */
public class TtExpRequestCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * REQUEST_ISSUER_COMP_CD
     */
    private String requestIssuerCompCd;

    /**
     * REQUEST_ISSUER_DEPT_NM
     */
    ...
    /**
     * PACKING_COMP_DEPT_NM
     */
    private String packingCompDeptNm;

    /**
     * REQUEST_TO_PACKING_SEC
     */
    ...
    /**
     * SHIP_TO_ATTN_NM（小なりイコール）
     */
    private String shipToAttnNmLessThanEqual;

    /**
     * SHIP_TO_ATTN_NM（前方一致）
     */
    ...
    /**
     * REQUIRED_SHIP_DT（大なりイコール）
     */
    private Date requiredShipDtGreaterThanEqual;

    /**
     * REQUIRED_SHIP_DT（小なりイコール）
     */
    ...
    /**
     * REQUEST_LAST_UPDATE_DT（大なりイコール）
     */
    private Date requestLastUpdateDtGreaterThanEqual;

    /**
     * REQUEST_LAST_UPDATE_DT（小なりイコール）
     */
     ...
     * デフォルトコンストラクタ。
     */
    public TtExpRequestCriteriaDomain() {
    }
