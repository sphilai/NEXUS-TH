 ...
 * PROJECT：eca0027
 * 
 * TmPkgSpecRev の検索条件Domainクラス
 * テーブル概要：Package Specification Revision Master/包装仕様有効リビジョン原単位  During packaging specifications Master reference , Master to hold the revision as an active/包装仕様Master参照の際、有効とするリビジョンを保持するMaster
 * 
...
/**
 * TmPkgSpecRev の検索条件Domainクラスです。<BR>
 * テーブル概要：Package Specification Revision Master/包装仕様有効リビジョン原単位  During packaging specifications Master reference , Master to hold the revision as an active/包装仕様Master参照の際、有効とするリビジョンを保持するMaster<BR>
 * 
 * <BR>
 ...
 */
public class TmPkgSpecRevCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TmPkgSpecRevCriteriaDomain() {
    }
