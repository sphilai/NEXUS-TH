 ...
 * PROJECT：eca0027
 * 
 * TtPltzInstrItemNo の検索条件Domainクラス
 * テーブル概要：TT_PLTZ_INSTR_ITEM_NO
 * 
...
/**
 * TtPltzInstrItemNo の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_PLTZ_INSTR_ITEM_NO<BR>
 * 
 * <BR>
 ...
 */
public class TtPltzInstrItemNoCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * WH_STK_LOCATION（大なり）
     */
    private String whStkLocationGreaterThan;

    /**
     * WH_STK_LOCATION（大なりイコール）
     */
    private String whStkLocationGreaterThanEqual;

    /**
     * WH_STK_LOCATION（小なり）
     */
    private String whStkLocationLessThan;

    /**
     * WH_STK_LOCATION（小なりイコール）
     */
    private String whStkLocationLessThanEqual;

    /**
     * WH_STK_LOCATION（前方一致）
     */
    private String whStkLocationLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TtPltzInstrItemNoCriteriaDomain() {
    }
    ...
    /**
     * boxLotQty のセッターメソッドです。
     * 
     * @param boxLotQty boxLotQty に設定する
     */
    ...
    /**
     * whStkLocation のセッターメソッドです。
     * 
     * @param whStkLocation whStkLocation に設定する
     */
    ...
    /**
     * whStkLocationGreaterThan のゲッターメソッドです。
     * 
     * @return the whStkLocationGreaterThan
     */
    public String getWhStkLocationGreaterThan() {
        return whStkLocationGreaterThan;
    }

    /**
     * whStkLocationGreaterThan のセッターメソッドです。
     * 
     * @param whStkLocationGreaterThan whStkLocationGreaterThan に設定する
     */
    public void setWhStkLocationGreaterThan(String whStkLocationGreaterThan) {
        this.whStkLocationGreaterThan = whStkLocationGreaterThan;
    }

    /**
     * whStkLocationGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the whStkLocationGreaterThanEqual
     */
    public String getWhStkLocationGreaterThanEqual() {
        return whStkLocationGreaterThanEqual;
    }

    /**
     * whStkLocationGreaterThanEqual のセッターメソッドです。
     * 
     * @param whStkLocationGreaterThanEqual whStkLocationGreaterThanEqual に設定する
     */
    public void setWhStkLocationGreaterThanEqual(String whStkLocationGreaterThanEqual) {
        this.whStkLocationGreaterThanEqual = whStkLocationGreaterThanEqual;
    }

    /**
     * whStkLocationLessThan のゲッターメソッドです。
     * 
     * @return the whStkLocationLessThan
     */
    public String getWhStkLocationLessThan() {
        return whStkLocationLessThan;
    }

    /**
     * whStkLocationLessThan のセッターメソッドです。
     * 
     * @param whStkLocationLessThan whStkLocationLessThan に設定する
     */
    public void setWhStkLocationLessThan(String whStkLocationLessThan) {
        this.whStkLocationLessThan = whStkLocationLessThan;
    }

    /**
     * whStkLocationLessThanEqual のゲッターメソッドです。
     * 
     * @return the whStkLocationLessThanEqual
     */
    public String getWhStkLocationLessThanEqual() {
        return whStkLocationLessThanEqual;
    }

    /**
     * whStkLocationLessThanEqual のセッターメソッドです。
     * 
     * @param whStkLocationLessThanEqual whStkLocationLessThanEqual に設定する
     */
    public void setWhStkLocationLessThanEqual(String whStkLocationLessThanEqual) {
        this.whStkLocationLessThanEqual = whStkLocationLessThanEqual;
    }

    /**
     * whStkLocationLikeFront のゲッターメソッドです。
     * 
     * @return the whStkLocationLikeFront
     */
    public String getWhStkLocationLikeFront() {
        return whStkLocationLikeFront;
    }

    /**
     * whStkLocationLikeFront のセッターメソッドです。
     * 
     * @param whStkLocationLikeFront whStkLocationLikeFront に設定する
     */
    public void setWhStkLocationLikeFront(String whStkLocationLikeFront) {
        this.whStkLocationLikeFront = whStkLocationLikeFront;
    }
