 ...
 * PROJECT：eca0027
 * 
 * TtTransferItemMm の検索条件Domainクラス
 * テーブル概要：TT_TRANSFER_ITEM_MM
 * 
...
/**
 * TtTransferItemMm の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_TRANSFER_ITEM_MM<BR>
 * 
 * <BR>
 ...
 */
public class TtTransferItemMmCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtTransferItemMmCriteriaDomain() {
    }
