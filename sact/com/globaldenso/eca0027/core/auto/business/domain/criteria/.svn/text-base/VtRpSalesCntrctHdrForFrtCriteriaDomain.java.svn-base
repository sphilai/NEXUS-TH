 ...
 * PROJECT：eca0027
 * 
 * VtRpSalesCntrctHdrForFrt の検索条件Domainクラス
 * テーブル概要：VT_RP_SALES_CNTRCT_HDR_FOR_FRT
 * 
...
/**
 * VtRpSalesCntrctHdrForFrt の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_SALES_CNTRCT_HDR_FOR_FRT<BR>
 * 
 * <BR>
 ...
 */
public class VtRpSalesCntrctHdrForFrtCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpSalesCntrctHdrForFrtCriteriaDomain() {
    }
