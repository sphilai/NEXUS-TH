 ...
 * PROJECT：eca0027
 * 
 * TmSailingSchedule の検索条件Domainクラス
 * テーブル概要：TM_SAILING_SCHEDULE
 * 
...
/**
 * TmSailingSchedule の検索条件Domainクラスです。<BR>
 * テーブル概要：TM_SAILING_SCHEDULE<BR>
 * 
 * <BR>
 ...
 */
public class TmSailingScheduleCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * POL（大なり）
     */
    private String polGreaterThan;

    /**
     * POL（大なりイコール）
     */
    private String polGreaterThanEqual;

    /**
     * POL（小なり）
     */
    private String polLessThan;

    /**
     * POL（小なりイコール）
     */
    private String polLessThanEqual;

    /**
     * POL（前方一致）
     */
    private String polLikeFront;

    /**
     * POD（大なり）
     */
    private String podGreaterThan;

    /**
     * POD（大なりイコール）
     */
    private String podGreaterThanEqual;

    /**
     * POD（小なり）
     */
    private String podLessThan;

    /**
     * POD（小なりイコール）
     */
    private String podLessThanEqual;

    /**
     * POD（前方一致）
     */
    private String podLikeFront;
     ...
     * ETD_OF_WEEK（大なり）
     */
    private String etdOfWeekGreaterThan;

    /**
     * ETD_OF_WEEK（大なりイコール）
     */
    private String etdOfWeekGreaterThanEqual;

    /**
     * ETD_OF_WEEK（小なり）
     */
    private String etdOfWeekLessThan;

    /**
     * ETD_OF_WEEK（小なりイコール）
     */
    private String etdOfWeekLessThanEqual;

    /**
     * ETD_OF_WEEK（前方一致）
     */
    private String etdOfWeekLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TmSailingScheduleCriteriaDomain() {
    }
    ...
    /**
     * etdOfWeek のゲッターメソッドです。
     * 
     * @return the etdOfWeek
     */
    public String getEtdOfWeek() {
        return etdOfWeek;
    }

    /**
     * etdOfWeek のセッターメソッドです。
     * 
     * @param etdOfWeek etdOfWeek に設定する
     */
    public void setEtdOfWeek(String etdOfWeek) {
        this.etdOfWeek = etdOfWeek;
    }

    /**
     * duration のゲッターメソッドです。
     * 
     * @return the duration
     */
    ...
    /**
     * duration のセッターメソッドです。
     * 
     * @param duration duration に設定する
     */
    ...
    /**
     * cyCutOff のゲッターメソッドです。
     * 
     * @return the cyCutOff
     */
    public BigDecimal getCyCutOff() {
        return cyCutOff;
    }

    /**
     * cyCutOff のセッターメソッドです。
     * 
     * @param cyCutOff cyCutOff に設定する
     */
    public void setCyCutOff(BigDecimal cyCutOff) {
    ...
    /**
     * polGreaterThan のゲッターメソッドです。
     * 
     * @return the polGreaterThan
     */
    public String getPolGreaterThan() {
        return polGreaterThan;
    }

    /**
     * polGreaterThan のセッターメソッドです。
     * 
     * @param polGreaterThan polGreaterThan に設定する
     */
    public void setPolGreaterThan(String polGreaterThan) {
        this.polGreaterThan = polGreaterThan;
    }

    /**
     * polGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the polGreaterThanEqual
     */
    public String getPolGreaterThanEqual() {
        return polGreaterThanEqual;
    }

    /**
     * polGreaterThanEqual のセッターメソッドです。
     * 
     * @param polGreaterThanEqual polGreaterThanEqual に設定する
     */
    public void setPolGreaterThanEqual(String polGreaterThanEqual) {
        this.polGreaterThanEqual = polGreaterThanEqual;
    }

    /**
     * polLessThan のゲッターメソッドです。
     * 
     * @return the polLessThan
     */
    public String getPolLessThan() {
        return polLessThan;
    }

    /**
     * polLessThan のセッターメソッドです。
     * 
     * @param polLessThan polLessThan に設定する
     */
    public void setPolLessThan(String polLessThan) {
        this.polLessThan = polLessThan;
    }

    /**
     * polLessThanEqual のゲッターメソッドです。
     * 
     * @return the polLessThanEqual
     */
    public String getPolLessThanEqual() {
        return polLessThanEqual;
    }

    /**
     * polLessThanEqual のセッターメソッドです。
     * 
     * @param polLessThanEqual polLessThanEqual に設定する
     */
    public void setPolLessThanEqual(String polLessThanEqual) {
        this.polLessThanEqual = polLessThanEqual;
    }

    /**
     * polLikeFront のゲッターメソッドです。
     * 
     * @return the polLikeFront
     */
    public String getPolLikeFront() {
        return polLikeFront;
    }

    /**
     * polLikeFront のセッターメソッドです。
     * 
     * @param polLikeFront polLikeFront に設定する
     */
    public void setPolLikeFront(String polLikeFront) {
        this.polLikeFront = polLikeFront;
    }

    /**
     * podGreaterThan のゲッターメソッドです。
     * 
     * @return the podGreaterThan
     */
    public String getPodGreaterThan() {
        return podGreaterThan;
    }

    /**
     * podGreaterThan のセッターメソッドです。
     * 
     * @param podGreaterThan podGreaterThan に設定する
     */
    public void setPodGreaterThan(String podGreaterThan) {
        this.podGreaterThan = podGreaterThan;
    }

    /**
     * podGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the podGreaterThanEqual
     */
    public String getPodGreaterThanEqual() {
        return podGreaterThanEqual;
    }

    /**
     * podGreaterThanEqual のセッターメソッドです。
     * 
     * @param podGreaterThanEqual podGreaterThanEqual に設定する
     */
    public void setPodGreaterThanEqual(String podGreaterThanEqual) {
        this.podGreaterThanEqual = podGreaterThanEqual;
    }

    /**
     * podLessThan のゲッターメソッドです。
     * 
     * @return the podLessThan
     */
    public String getPodLessThan() {
        return podLessThan;
    }

    /**
     * podLessThan のセッターメソッドです。
     * 
     * @param podLessThan podLessThan に設定する
     */
    public void setPodLessThan(String podLessThan) {
        this.podLessThan = podLessThan;
    }

    /**
     * podLessThanEqual のゲッターメソッドです。
     * 
     * @return the podLessThanEqual
     */
    public String getPodLessThanEqual() {
        return podLessThanEqual;
    }

    /**
     * podLessThanEqual のセッターメソッドです。
     * 
     * @param podLessThanEqual podLessThanEqual に設定する
     */
    public void setPodLessThanEqual(String podLessThanEqual) {
        this.podLessThanEqual = podLessThanEqual;
    }

    /**
     * podLikeFront のゲッターメソッドです。
     * 
     * @return the podLikeFront
     */
    public String getPodLikeFront() {
        return podLikeFront;
    }

    /**
     * podLikeFront のセッターメソッドです。
     * 
     * @param podLikeFront podLikeFront に設定する
     */
    public void setPodLikeFront(String podLikeFront) {
        this.podLikeFront = podLikeFront;
    }
    ...
    /**
     * etdOfWeekGreaterThan のゲッターメソッドです。
     * 
     * @return the etdOfWeekGreaterThan
     */
    public String getEtdOfWeekGreaterThan() {
        return etdOfWeekGreaterThan;
    }

    /**
     * etdOfWeekGreaterThan のセッターメソッドです。
     * 
     * @param etdOfWeekGreaterThan etdOfWeekGreaterThan に設定する
     */
    public void setEtdOfWeekGreaterThan(String etdOfWeekGreaterThan) {
        this.etdOfWeekGreaterThan = etdOfWeekGreaterThan;
    }

    /**
     * etdOfWeekGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the etdOfWeekGreaterThanEqual
     */
    public String getEtdOfWeekGreaterThanEqual() {
        return etdOfWeekGreaterThanEqual;
    }

    /**
     * etdOfWeekGreaterThanEqual のセッターメソッドです。
     * 
     * @param etdOfWeekGreaterThanEqual etdOfWeekGreaterThanEqual に設定する
     */
    public void setEtdOfWeekGreaterThanEqual(String etdOfWeekGreaterThanEqual) {
        this.etdOfWeekGreaterThanEqual = etdOfWeekGreaterThanEqual;
    }

    /**
     * etdOfWeekLessThan のゲッターメソッドです。
     * 
     * @return the etdOfWeekLessThan
     */
    public String getEtdOfWeekLessThan() {
        return etdOfWeekLessThan;
    }

    /**
     * etdOfWeekLessThan のセッターメソッドです。
     * 
     * @param etdOfWeekLessThan etdOfWeekLessThan に設定する
     */
    public void setEtdOfWeekLessThan(String etdOfWeekLessThan) {
        this.etdOfWeekLessThan = etdOfWeekLessThan;
    }

    /**
     * etdOfWeekLessThanEqual のゲッターメソッドです。
     * 
     * @return the etdOfWeekLessThanEqual
     */
    public String getEtdOfWeekLessThanEqual() {
        return etdOfWeekLessThanEqual;
    }

    /**
     * etdOfWeekLessThanEqual のセッターメソッドです。
     * 
     * @param etdOfWeekLessThanEqual etdOfWeekLessThanEqual に設定する
     */
    public void setEtdOfWeekLessThanEqual(String etdOfWeekLessThanEqual) {
        this.etdOfWeekLessThanEqual = etdOfWeekLessThanEqual;
    }

    /**
     * etdOfWeekLikeFront のゲッターメソッドです。
     * 
     * @return the etdOfWeekLikeFront
     */
    public String getEtdOfWeekLikeFront() {
        return etdOfWeekLikeFront;
    }

    /**
     * etdOfWeekLikeFront のセッターメソッドです。
     * 
     * @param etdOfWeekLikeFront etdOfWeekLikeFront に設定する
     */
    public void setEtdOfWeekLikeFront(String etdOfWeekLikeFront) {
        this.etdOfWeekLikeFront = etdOfWeekLikeFront;
    }
