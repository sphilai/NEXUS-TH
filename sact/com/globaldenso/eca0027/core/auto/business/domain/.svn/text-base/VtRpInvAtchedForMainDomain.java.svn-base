 ...
 * PROJECT：eca0027
 * 
 * VtRpInvAtchedForMain のDomainクラス
...
/**
 * VtRpInvAtchedForMain のDomainクラスです。<BR>
 ...
 */
public class VtRpInvAtchedForMainDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpInvAtchedForMainDomain() {
    }
