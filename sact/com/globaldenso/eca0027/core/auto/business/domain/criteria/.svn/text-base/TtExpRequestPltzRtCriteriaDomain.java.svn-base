 ...
 * PROJECT：eca0027
 * 
 * TtExpRequestPltzRt の検索条件Domainクラス
 * テーブル概要：TT_EXP_REQUEST_PLTZ_RT
 * 
...
/**
 * TtExpRequestPltzRt の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_EXP_REQUEST_PLTZ_RT<BR>
 * 
 * <BR>
 ...
 */
public class TtExpRequestPltzRtCriteriaDomain extends AbstractDomain implements Serializable {
    ...
    /**
     * SELECT_PKG__FLG（小なりイコール）
     */
    private String selectPkgFlgLessThanEqual;

    /**
     * SELECT_PKG__FLG（前方一致）
     */
     ...
     * デフォルトコンストラクタ。
     */
    public TtExpRequestPltzRtCriteriaDomain() {
    }
