 ...
 * PROJECT：eca0027
 * 
 * TtPltzInstrOdr の検索条件Domainクラス
 * テーブル概要：TT_PLTZ_INSTR_ODR
 * 
...
/**
 * TtPltzInstrOdr の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_PLTZ_INSTR_ODR<BR>
 * 
 * <BR>
 ...
 */
public class TtPltzInstrOdrCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * PACKED_FLG（大なり）
     */
    private String packedFlgGreaterThan;

    /**
     * PACKED_FLG（大なりイコール）
     */
    private String packedFlgGreaterThanEqual;

    /**
     * PACKED_FLG（小なり）
     */
    private String packedFlgLessThan;

    /**
     * PACKED_FLG（小なりイコール）
     */
    private String packedFlgLessThanEqual;

    /**
     * PACKED_FLG（前方一致）
     */
    private String packedFlgLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TtPltzInstrOdrCriteriaDomain() {
    }
    ...
    /**
     * allocQty のセッターメソッドです。
     * 
     * @param allocQty allocQty に設定する
     */
    ...
    /**
     * packedQty のセッターメソッドです。
     * 
     * @param packedQty packedQty に設定する
     */
    ...
    /**
     * packedFlg のゲッターメソッドです。
     * 
     * @return the packedFlg
     */
    ...
    /**
     * packedFlg のセッターメソッドです。
     * 
     * @param packedFlg packedFlg に設定する
     */
    public void setPackedFlg(String packedFlg) {
        this.packedFlg = packedFlg;
    }
    ...
    /**
     * packedFlgGreaterThan のゲッターメソッドです。
     * 
     * @return the packedFlgGreaterThan
     */
    public String getPackedFlgGreaterThan() {
        return packedFlgGreaterThan;
    }

    /**
     * packedFlgGreaterThan のセッターメソッドです。
     * 
     * @param packedFlgGreaterThan packedFlgGreaterThan に設定する
     */
    public void setPackedFlgGreaterThan(String packedFlgGreaterThan) {
        this.packedFlgGreaterThan = packedFlgGreaterThan;
    }

    /**
     * packedFlgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the packedFlgGreaterThanEqual
     */
    public String getPackedFlgGreaterThanEqual() {
        return packedFlgGreaterThanEqual;
    }

    /**
     * packedFlgGreaterThanEqual のセッターメソッドです。
     * 
     * @param packedFlgGreaterThanEqual packedFlgGreaterThanEqual に設定する
     */
    public void setPackedFlgGreaterThanEqual(String packedFlgGreaterThanEqual) {
        this.packedFlgGreaterThanEqual = packedFlgGreaterThanEqual;
    }

    /**
     * packedFlgLessThan のゲッターメソッドです。
     * 
     * @return the packedFlgLessThan
     */
    public String getPackedFlgLessThan() {
        return packedFlgLessThan;
    }

    /**
     * packedFlgLessThan のセッターメソッドです。
     * 
     * @param packedFlgLessThan packedFlgLessThan に設定する
     */
    public void setPackedFlgLessThan(String packedFlgLessThan) {
        this.packedFlgLessThan = packedFlgLessThan;
    }

    /**
     * packedFlgLessThanEqual のゲッターメソッドです。
     * 
     * @return the packedFlgLessThanEqual
     */
    public String getPackedFlgLessThanEqual() {
        return packedFlgLessThanEqual;
    }

    /**
     * packedFlgLessThanEqual のセッターメソッドです。
     * 
     * @param packedFlgLessThanEqual packedFlgLessThanEqual に設定する
     */
    public void setPackedFlgLessThanEqual(String packedFlgLessThanEqual) {
        this.packedFlgLessThanEqual = packedFlgLessThanEqual;
    }

    /**
     * packedFlgLikeFront のゲッターメソッドです。
     * 
     * @return the packedFlgLikeFront
     */
    public String getPackedFlgLikeFront() {
        return packedFlgLikeFront;
    }

    /**
     * packedFlgLikeFront のセッターメソッドです。
     * 
     * @param packedFlgLikeFront packedFlgLikeFront に設定する
     */
    public void setPackedFlgLikeFront(String packedFlgLikeFront) {
        this.packedFlgLikeFront = packedFlgLikeFront;
    }
