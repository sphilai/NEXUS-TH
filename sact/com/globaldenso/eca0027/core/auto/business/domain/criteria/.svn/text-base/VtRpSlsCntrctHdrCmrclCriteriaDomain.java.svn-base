 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctHdrCmrcl の検索条件Domainクラス
 * テーブル概要：VT_RP_SLS_CNTRCT_HDR_CMRCL
 * 
...
/**
 * VtRpSlsCntrctHdrCmrcl の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_SLS_CNTRCT_HDR_CMRCL<BR>
 * 
 * <BR>
 ...
 */
public class VtRpSlsCntrctHdrCmrclCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpSlsCntrctHdrCmrclCriteriaDomain() {
    }
