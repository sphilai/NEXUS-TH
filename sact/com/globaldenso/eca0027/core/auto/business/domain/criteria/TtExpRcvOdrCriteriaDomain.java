 ...
 * PROJECT：eca0027
 * 
 * TtExpRcvOdr の検索条件Domainクラス
 * テーブル概要：TT_EXP_RCV_ODR
 * 
...
/**
 * TtExpRcvOdr の検索条件Domainクラスです。<BR>
 * テーブル概要：TT_EXP_RCV_ODR<BR>
 * 
 * <BR>
 ...
 */
public class TtExpRcvOdrCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * ITEM_NO_ORG（大なり）
     */
    private String itemNoOrgGreaterThan;

    /**
     * ITEM_NO_ORG（大なりイコール）
     */
    private String itemNoOrgGreaterThanEqual;

    /**
     * ITEM_NO_ORG（小なり）
     */
    private String itemNoOrgLessThan;

    /**
     * ITEM_NO_ORG（小なりイコール）
     */
    private String itemNoOrgLessThanEqual;

    /**
     * ITEM_NO_ORG（前方一致）
     */
    private String itemNoOrgLikeFront;
    ...
    /**
     * SALES_COMP_PO_NO（大なり）
     */
    private String salesCompPoNoGreaterThan;

    /**
     * SALES_COMP_PO_NO（大なりイコール）
     */
    private String salesCompPoNoGreaterThanEqual;

    /**
     * SALES_COMP_PO_NO（小なり）
     */
    private String salesCompPoNoLessThan;

    /**
     * SALES_COMP_PO_NO（小なりイコール）
     */
    private String salesCompPoNoLessThanEqual;

    /**
     * SALES_COMP_PO_NO（前方一致）
     */
    private String salesCompPoNoLikeFront;

    /**
     * LAST_FIGURE_CHG_FLG（大なり）
     */
    private String lastFigureChgFlgGreaterThan;

    /**
     * LAST_FIGURE_CHG_FLG（大なりイコール）
     */
    private String lastFigureChgFlgGreaterThanEqual;

    /**
     * LAST_FIGURE_CHG_FLG（小なり）
     */
    private String lastFigureChgFlgLessThan;

    /**
     * LAST_FIGURE_CHG_FLG（小なりイコール）
     */
    private String lastFigureChgFlgLessThanEqual;

    /**
     * LAST_FIGURE_CHG_FLG（前方一致）
     */
    private String lastFigureChgFlgLikeFront;
     ...
     * SHIPPED_TYP（大なり）
     */
    private String shippedTypGreaterThan;

    /**
     * SHIPPED_TYP（大なりイコール）
     */
    private String shippedTypGreaterThanEqual;

    /**
     * SHIPPED_TYP（小なり）
     */
    private String shippedTypLessThan;

    /**
     * SHIPPED_TYP（小なりイコール）
     */
    private String shippedTypLessThanEqual;

    /**
     * SHIPPED_TYP（前方一致）
     */
    private String shippedTypLikeFront;
     ...
     * デフォルトコンストラクタ。
     */
    public TtExpRcvOdrCriteriaDomain() {
    }
    ...
    /**
     * itemNoOrg のセッターメソッドです。
     * 
     * @param itemNoOrg itemNoOrg に設定する
     */
    ...
    /**
     * lastFigureChgFlg のセッターメソッドです。
     * 
     * @param lastFigureChgFlg lastFigureChgFlg に設定する
     */
    ...
    /**
     * shippedTyp のセッターメソッドです。
     * 
     * @param shippedTyp shippedTyp に設定する
     */
    ...
    /**
     * itemNoOrgGreaterThan のゲッターメソッドです。
     * 
     * @return the itemNoOrgGreaterThan
     */
    public String getItemNoOrgGreaterThan() {
        return itemNoOrgGreaterThan;
    }

    /**
     * itemNoOrgGreaterThan のセッターメソッドです。
     * 
     * @param itemNoOrgGreaterThan itemNoOrgGreaterThan に設定する
     */
    public void setItemNoOrgGreaterThan(String itemNoOrgGreaterThan) {
        this.itemNoOrgGreaterThan = itemNoOrgGreaterThan;
    }

    /**
     * itemNoOrgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the itemNoOrgGreaterThanEqual
     */
    public String getItemNoOrgGreaterThanEqual() {
        return itemNoOrgGreaterThanEqual;
    }

    /**
     * itemNoOrgGreaterThanEqual のセッターメソッドです。
     * 
     * @param itemNoOrgGreaterThanEqual itemNoOrgGreaterThanEqual に設定する
     */
    public void setItemNoOrgGreaterThanEqual(String itemNoOrgGreaterThanEqual) {
        this.itemNoOrgGreaterThanEqual = itemNoOrgGreaterThanEqual;
    }

    /**
     * itemNoOrgLessThan のゲッターメソッドです。
     * 
     * @return the itemNoOrgLessThan
     */
    public String getItemNoOrgLessThan() {
        return itemNoOrgLessThan;
    }

    /**
     * itemNoOrgLessThan のセッターメソッドです。
     * 
     * @param itemNoOrgLessThan itemNoOrgLessThan に設定する
     */
    public void setItemNoOrgLessThan(String itemNoOrgLessThan) {
        this.itemNoOrgLessThan = itemNoOrgLessThan;
    }

    /**
     * itemNoOrgLessThanEqual のゲッターメソッドです。
     * 
     * @return the itemNoOrgLessThanEqual
     */
    public String getItemNoOrgLessThanEqual() {
        return itemNoOrgLessThanEqual;
    }

    /**
     * itemNoOrgLessThanEqual のセッターメソッドです。
     * 
     * @param itemNoOrgLessThanEqual itemNoOrgLessThanEqual に設定する
     */
    public void setItemNoOrgLessThanEqual(String itemNoOrgLessThanEqual) {
        this.itemNoOrgLessThanEqual = itemNoOrgLessThanEqual;
    }

    /**
     * itemNoOrgLikeFront のゲッターメソッドです。
     * 
     * @return the itemNoOrgLikeFront
     */
    public String getItemNoOrgLikeFront() {
        return itemNoOrgLikeFront;
    }

    /**
     * itemNoOrgLikeFront のセッターメソッドです。
     * 
     * @param itemNoOrgLikeFront itemNoOrgLikeFront に設定する
     */
    public void setItemNoOrgLikeFront(String itemNoOrgLikeFront) {
        this.itemNoOrgLikeFront = itemNoOrgLikeFront;
    }
    ...
    /**
     * salesCompPoNoGreaterThan のゲッターメソッドです。
     * 
     * @return the salesCompPoNoGreaterThan
     */
    public String getSalesCompPoNoGreaterThan() {
        return salesCompPoNoGreaterThan;
    }

    /**
     * salesCompPoNoGreaterThan のセッターメソッドです。
     * 
     * @param salesCompPoNoGreaterThan salesCompPoNoGreaterThan に設定する
     */
    public void setSalesCompPoNoGreaterThan(String salesCompPoNoGreaterThan) {
        this.salesCompPoNoGreaterThan = salesCompPoNoGreaterThan;
    }

    /**
     * salesCompPoNoGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the salesCompPoNoGreaterThanEqual
     */
    public String getSalesCompPoNoGreaterThanEqual() {
        return salesCompPoNoGreaterThanEqual;
    }

    /**
     * salesCompPoNoGreaterThanEqual のセッターメソッドです。
     * 
     * @param salesCompPoNoGreaterThanEqual salesCompPoNoGreaterThanEqual に設定する
     */
    public void setSalesCompPoNoGreaterThanEqual(String salesCompPoNoGreaterThanEqual) {
        this.salesCompPoNoGreaterThanEqual = salesCompPoNoGreaterThanEqual;
    }

    /**
     * salesCompPoNoLessThan のゲッターメソッドです。
     * 
     * @return the salesCompPoNoLessThan
     */
    public String getSalesCompPoNoLessThan() {
        return salesCompPoNoLessThan;
    }

    /**
     * salesCompPoNoLessThan のセッターメソッドです。
     * 
     * @param salesCompPoNoLessThan salesCompPoNoLessThan に設定する
     */
    public void setSalesCompPoNoLessThan(String salesCompPoNoLessThan) {
        this.salesCompPoNoLessThan = salesCompPoNoLessThan;
    }

    /**
     * salesCompPoNoLessThanEqual のゲッターメソッドです。
     * 
     * @return the salesCompPoNoLessThanEqual
     */
    public String getSalesCompPoNoLessThanEqual() {
        return salesCompPoNoLessThanEqual;
    }

    /**
     * salesCompPoNoLessThanEqual のセッターメソッドです。
     * 
     * @param salesCompPoNoLessThanEqual salesCompPoNoLessThanEqual に設定する
     */
    public void setSalesCompPoNoLessThanEqual(String salesCompPoNoLessThanEqual) {
        this.salesCompPoNoLessThanEqual = salesCompPoNoLessThanEqual;
    }

    /**
     * salesCompPoNoLikeFront のゲッターメソッドです。
     * 
     * @return the salesCompPoNoLikeFront
     */
    public String getSalesCompPoNoLikeFront() {
        return salesCompPoNoLikeFront;
    }

    /**
     * salesCompPoNoLikeFront のセッターメソッドです。
     * 
     * @param salesCompPoNoLikeFront salesCompPoNoLikeFront に設定する
     */
    public void setSalesCompPoNoLikeFront(String salesCompPoNoLikeFront) {
        this.salesCompPoNoLikeFront = salesCompPoNoLikeFront;
    }

    /**
     * lastFigureChgFlgGreaterThan のゲッターメソッドです。
     * 
     * @return the lastFigureChgFlgGreaterThan
     */
    public String getLastFigureChgFlgGreaterThan() {
        return lastFigureChgFlgGreaterThan;
    }

    /**
     * lastFigureChgFlgGreaterThan のセッターメソッドです。
     * 
     * @param lastFigureChgFlgGreaterThan lastFigureChgFlgGreaterThan に設定する
     */
    public void setLastFigureChgFlgGreaterThan(String lastFigureChgFlgGreaterThan) {
        this.lastFigureChgFlgGreaterThan = lastFigureChgFlgGreaterThan;
    }

    /**
     * lastFigureChgFlgGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the lastFigureChgFlgGreaterThanEqual
     */
    public String getLastFigureChgFlgGreaterThanEqual() {
        return lastFigureChgFlgGreaterThanEqual;
    }

    /**
     * lastFigureChgFlgGreaterThanEqual のセッターメソッドです。
     * 
     * @param lastFigureChgFlgGreaterThanEqual lastFigureChgFlgGreaterThanEqual に設定する
     */
    public void setLastFigureChgFlgGreaterThanEqual(String lastFigureChgFlgGreaterThanEqual) {
        this.lastFigureChgFlgGreaterThanEqual = lastFigureChgFlgGreaterThanEqual;
    }

    /**
     * lastFigureChgFlgLessThan のゲッターメソッドです。
     * 
     * @return the lastFigureChgFlgLessThan
     */
    public String getLastFigureChgFlgLessThan() {
        return lastFigureChgFlgLessThan;
    }

    /**
     * lastFigureChgFlgLessThan のセッターメソッドです。
     * 
     * @param lastFigureChgFlgLessThan lastFigureChgFlgLessThan に設定する
     */
    public void setLastFigureChgFlgLessThan(String lastFigureChgFlgLessThan) {
        this.lastFigureChgFlgLessThan = lastFigureChgFlgLessThan;
    }

    /**
     * lastFigureChgFlgLessThanEqual のゲッターメソッドです。
     * 
     * @return the lastFigureChgFlgLessThanEqual
     */
    public String getLastFigureChgFlgLessThanEqual() {
        return lastFigureChgFlgLessThanEqual;
    }

    /**
     * lastFigureChgFlgLessThanEqual のセッターメソッドです。
     * 
     * @param lastFigureChgFlgLessThanEqual lastFigureChgFlgLessThanEqual に設定する
     */
    public void setLastFigureChgFlgLessThanEqual(String lastFigureChgFlgLessThanEqual) {
        this.lastFigureChgFlgLessThanEqual = lastFigureChgFlgLessThanEqual;
    }

    /**
     * lastFigureChgFlgLikeFront のゲッターメソッドです。
     * 
     * @return the lastFigureChgFlgLikeFront
     */
    public String getLastFigureChgFlgLikeFront() {
        return lastFigureChgFlgLikeFront;
    }

    /**
     * lastFigureChgFlgLikeFront のセッターメソッドです。
     * 
     * @param lastFigureChgFlgLikeFront lastFigureChgFlgLikeFront に設定する
     */
    public void setLastFigureChgFlgLikeFront(String lastFigureChgFlgLikeFront) {
        this.lastFigureChgFlgLikeFront = lastFigureChgFlgLikeFront;
    }
    ...
    /**
     * shippedTypGreaterThan のゲッターメソッドです。
     * 
     * @return the shippedTypGreaterThan
     */
    public String getShippedTypGreaterThan() {
        return shippedTypGreaterThan;
    }

    /**
     * shippedTypGreaterThan のセッターメソッドです。
     * 
     * @param shippedTypGreaterThan shippedTypGreaterThan に設定する
     */
    public void setShippedTypGreaterThan(String shippedTypGreaterThan) {
        this.shippedTypGreaterThan = shippedTypGreaterThan;
    }

    /**
     * shippedTypGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the shippedTypGreaterThanEqual
     */
    public String getShippedTypGreaterThanEqual() {
        return shippedTypGreaterThanEqual;
    }

    /**
     * shippedTypGreaterThanEqual のセッターメソッドです。
     * 
     * @param shippedTypGreaterThanEqual shippedTypGreaterThanEqual に設定する
     */
    public void setShippedTypGreaterThanEqual(String shippedTypGreaterThanEqual) {
        this.shippedTypGreaterThanEqual = shippedTypGreaterThanEqual;
    }

    /**
     * shippedTypLessThan のゲッターメソッドです。
     * 
     * @return the shippedTypLessThan
     */
    public String getShippedTypLessThan() {
        return shippedTypLessThan;
    }

    /**
     * shippedTypLessThan のセッターメソッドです。
     * 
     * @param shippedTypLessThan shippedTypLessThan に設定する
     */
    public void setShippedTypLessThan(String shippedTypLessThan) {
        this.shippedTypLessThan = shippedTypLessThan;
    }

    /**
     * shippedTypLessThanEqual のゲッターメソッドです。
     * 
     * @return the shippedTypLessThanEqual
     */
    public String getShippedTypLessThanEqual() {
        return shippedTypLessThanEqual;
    }

    /**
     * shippedTypLessThanEqual のセッターメソッドです。
     * 
     * @param shippedTypLessThanEqual shippedTypLessThanEqual に設定する
     */
    public void setShippedTypLessThanEqual(String shippedTypLessThanEqual) {
        this.shippedTypLessThanEqual = shippedTypLessThanEqual;
    }

    /**
     * shippedTypLikeFront のゲッターメソッドです。
     * 
     * @return the shippedTypLikeFront
     */
    public String getShippedTypLikeFront() {
        return shippedTypLikeFront;
    }

    /**
     * shippedTypLikeFront のセッターメソッドです。
     * 
     * @param shippedTypLikeFront shippedTypLikeFront に設定する
     */
    public void setShippedTypLikeFront(String shippedTypLikeFront) {
        this.shippedTypLikeFront = shippedTypLikeFront;
    }
