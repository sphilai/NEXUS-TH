 ...
 * PROJECT：eca0027
 * 
 * VtRpSalesCntrctHdrForFrt のDomainクラス
...
/**
 * VtRpSalesCntrctHdrForFrt のDomainクラスです。<BR>
 ...
 */
public class VtRpSalesCntrctHdrForFrtDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpSalesCntrctHdrForFrtDomain() {
    }
