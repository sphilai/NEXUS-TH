 ...
 * PROJECT：eca0027
 * 
 * TmExpRequestItemNo の検索条件Domainクラス
 * テーブル概要：TM_EXP_REQUEST_ITEM_NO
 * 
...
/**
 * TmExpRequestItemNo の検索条件Domainクラスです。<BR>
 * テーブル概要：TM_EXP_REQUEST_ITEM_NO<BR>
 * 
 * <BR>
 ...
 */
public class TmExpRequestItemNoCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * APLY_END_DT（大なりイコール）
     */
    private Date aplyEndDtGreaterThanEqual;

    /**
     * APLY_END_DT（小なりイコール）
     */
    private Date aplyEndDtLessThanEqual;
     ...
     * デフォルトコンストラクタ。
     */
    public TmExpRequestItemNoCriteriaDomain() {
    }
    ...
    /**
     * aplyEndDt のゲッターメソッドです。
     * 
     * @return the aplyEndDt
     */
    public Date getAplyEndDt() {
        return aplyEndDt;
    }

    /**
     * aplyEndDt のセッターメソッドです。
     * 
     * @param aplyEndDt aplyEndDt に設定する
     */
    public void setAplyEndDt(Date aplyEndDt) {
    ...
    /**
     * aplyEndDtGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the aplyEndDtGreaterThanEqual
     */
    public Date getAplyEndDtGreaterThanEqual() {
        return aplyEndDtGreaterThanEqual;
    }

    /**
     * aplyEndDtGreaterThanEqual のセッターメソッドです。
     * 
     * @param aplyEndDtGreaterThanEqual aplyEndDtGreaterThanEqual に設定する
     */
    public void setAplyEndDtGreaterThanEqual(Date aplyEndDtGreaterThanEqual) {
        this.aplyEndDtGreaterThanEqual = aplyEndDtGreaterThanEqual;
    }

    /**
     * aplyEndDtLessThanEqual のゲッターメソッドです。
     * 
     * @return the aplyEndDtLessThanEqual
     */
    public Date getAplyEndDtLessThanEqual() {
        return aplyEndDtLessThanEqual;
    }

    /**
     * aplyEndDtLessThanEqual のセッターメソッドです。
     * 
     * @param aplyEndDtLessThanEqual aplyEndDtLessThanEqual に設定する
     */
    public void setAplyEndDtLessThanEqual(Date aplyEndDtLessThanEqual) {
        this.aplyEndDtLessThanEqual = aplyEndDtLessThanEqual;
    }
