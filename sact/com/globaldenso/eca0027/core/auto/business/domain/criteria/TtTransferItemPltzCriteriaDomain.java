 ...
 * PROJECT：eca0027
 * 
 * TtTransferItemPltz の検索条件Domainクラス
 * テーブル概要：Warehouse Transfer Detail Palletize/倉庫移動明細（ケースマーク）  As detail information of warehouse movements , table that holds the information of the case mark unit/倉庫移動の明細情報として、ケースマーク単位の情報を保持するテーブル
 * 
...
/**
 * TtTransferItemPltz の検索条件Domainクラスです。<BR>
 * テーブル概要：Warehouse Transfer Detail Palletize/倉庫移動明細（ケースマーク）  As detail information of warehouse movements , table that holds the information of the case mark unit/倉庫移動の明細情報として、ケースマーク単位の情報を保持するテーブル<BR>
 * 
 * <BR>
 ...
 * @version $Revision$
 */
public class TtTransferItemPltzCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtTransferItemPltzCriteriaDomain() {
    }
