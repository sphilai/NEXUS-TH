...
/**
 * TmStdQrPatternDtl のDomainクラスです。<BR>
 ...
 */
public class TmStdQrPatternDtlDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TmStdQrPatternDtlDomain() {
    }
