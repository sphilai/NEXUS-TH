...
/**
 * TtPackingHead の検索条件Domainクラスです。<BR>
 ...
 */
public class TtPackingHeadCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TtPackingHeadCriteriaDomain() {
    }
