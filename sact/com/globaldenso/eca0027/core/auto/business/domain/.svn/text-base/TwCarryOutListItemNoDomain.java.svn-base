 ...
 * PROJECT：eca0027
 * 
 * TwCarryOutListItemNo のDomainクラス
 * テーブル概要：TW_CARRY_OUT_LIST_ITEM_NO
 * 
...
/**
 * TwCarryOutListItemNo のDomainクラスです。<BR>
 * テーブル概要：TW_CARRY_OUT_LIST_ITEM_NO<BR>
 * 
 * <BR>
 ...
 */
public class TwCarryOutListItemNoDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TwCarryOutListItemNoDomain() {
    }
