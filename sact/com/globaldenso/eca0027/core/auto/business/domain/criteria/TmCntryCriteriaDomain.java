 ...
 */
public class TmCntryCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * CNTRY_NM（大なり）
     */
    private String cntryNmGreaterThan;

    /**
     * CNTRY_NM（大なりイコール）
     */
    private String cntryNmGreaterThanEqual;

    /**
     * CNTRY_NM（小なり）
     */
    private String cntryNmLessThan;

    /**
     * CNTRY_NM（小なりイコール）
     */
    private String cntryNmLessThanEqual;

    /**
     * CNTRY_NM（前方一致）
     */
    private String cntryNmLikeFront;
    ...
    /**
     * cntryNmGreaterThan のゲッターメソッドです。
     * 
     * @return the cntryNmGreaterThan
     */
    public String getCntryNmGreaterThan() {
        return cntryNmGreaterThan;
    }

    /**
     * cntryNmGreaterThan のセッターメソッドです。
     * 
     * @param cntryNmGreaterThan cntryNmGreaterThan に設定する
     */
    public void setCntryNmGreaterThan(String cntryNmGreaterThan) {
        this.cntryNmGreaterThan = cntryNmGreaterThan;
    }

    /**
     * cntryNmGreaterThanEqual のゲッターメソッドです。
     * 
     * @return the cntryNmGreaterThanEqual
     */
    public String getCntryNmGreaterThanEqual() {
        return cntryNmGreaterThanEqual;
    }

    /**
     * cntryNmGreaterThanEqual のセッターメソッドです。
     * 
     * @param cntryNmGreaterThanEqual cntryNmGreaterThanEqual に設定する
     */
    public void setCntryNmGreaterThanEqual(String cntryNmGreaterThanEqual) {
        this.cntryNmGreaterThanEqual = cntryNmGreaterThanEqual;
    }

    /**
     * cntryNmLessThan のゲッターメソッドです。
     * 
     * @return the cntryNmLessThan
     */
    public String getCntryNmLessThan() {
        return cntryNmLessThan;
    }

    /**
     * cntryNmLessThan のセッターメソッドです。
     * 
     * @param cntryNmLessThan cntryNmLessThan に設定する
     */
    public void setCntryNmLessThan(String cntryNmLessThan) {
        this.cntryNmLessThan = cntryNmLessThan;
    }

    /**
     * cntryNmLessThanEqual のゲッターメソッドです。
     * 
     * @return the cntryNmLessThanEqual
     */
    public String getCntryNmLessThanEqual() {
        return cntryNmLessThanEqual;
    }

    /**
     * cntryNmLessThanEqual のセッターメソッドです。
     * 
     * @param cntryNmLessThanEqual cntryNmLessThanEqual に設定する
     */
    public void setCntryNmLessThanEqual(String cntryNmLessThanEqual) {
        this.cntryNmLessThanEqual = cntryNmLessThanEqual;
    }

    /**
     * cntryNmLikeFront のゲッターメソッドです。
     * 
     * @return the cntryNmLikeFront
     */
    public String getCntryNmLikeFront() {
        return cntryNmLikeFront;
    }

    /**
     * cntryNmLikeFront のセッターメソッドです。
     * 
     * @param cntryNmLikeFront cntryNmLikeFront に設定する
     */
    public void setCntryNmLikeFront(String cntryNmLikeFront) {
        this.cntryNmLikeFront = cntryNmLikeFront;
    }
