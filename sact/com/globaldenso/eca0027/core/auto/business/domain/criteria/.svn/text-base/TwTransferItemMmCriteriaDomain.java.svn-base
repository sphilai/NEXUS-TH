 ...
 * PROJECT：eca0027
 * 
 * TwTransferItemMm の検索条件Domainクラス
 * テーブル概要：TW_TRANSFER_ITEM_MM
 * 
...
/**
 * TwTransferItemMm の検索条件Domainクラスです。<BR>
 * テーブル概要：TW_TRANSFER_ITEM_MM<BR>
 * 
 * <BR>
 ...
 */
public class TwTransferItemMmCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public TwTransferItemMmCriteriaDomain() {
    }
