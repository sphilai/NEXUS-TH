 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctHdrNonCmrcl の検索条件Domainクラス
 * テーブル概要：VT_RP_SLS_CNTRCT_HDR_NON_CMRCL
 * 
...
/**
 * VtRpSlsCntrctHdrNonCmrcl の検索条件Domainクラスです。<BR>
 * テーブル概要：VT_RP_SLS_CNTRCT_HDR_NON_CMRCL<BR>
 * 
 * <BR>
 ...
 */
public class VtRpSlsCntrctHdrNonCmrclCriteriaDomain extends AbstractDomain implements Serializable {
     ...
     * デフォルトコンストラクタ。
     */
    public VtRpSlsCntrctHdrNonCmrclCriteriaDomain() {
    }
