 ...
 * PROJECT：eca0027
 * 
 * VtRpSlsCntrctAtchedMain のDAOインターフェース
 * 
...
/**
 * VtRpSlsCntrctAtchedMain のDAOインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtRpSlsCntrctAtchedMainDao {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtRpSlsCntrctAtchedMainの CriteriaDomain クラス
     * @return vtRpSlsCntrctAtchedMainのDomainクラスのList
