...
/**
 * VtBhtLockuser のDAOインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtBhtLockuserDao {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtBhtLockuserの CriteriaDomain クラス
     * @return vtBhtLockuserのDomainクラスのList
