 ...
 * PROJECT：eca0027
 * 
 * TtTransferItemPltz のDAOインターフェース
 * 
 * Version.   更新日      更新者        更新内容
 * 1.0.0      2014/05/23  DNITS  新規作成
 * 
...
/**
 * TtTransferItemPltz のDAOインターフェースです。<BR>
 * 
 * <BR>
 * SACT Version： 1.0.0<BR>
 * 生成日      ： 2014/05/23 17:55:27<BR>
 * 
 * テーブル定義から2014/05/23に自動生成したモジュールです。
 * 
 * @author $Author$
 * @version $Revision$
 */
public interface TtTransferItemPltzDao {
