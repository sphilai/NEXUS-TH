...
/**
 * VtXpltzStgAct のDAOインターフェースです。<BR>
 * 
 * <BR>
 ...
 */
public interface VtXpltzStgActDao {

    /**
     * 任意の条件を元にテーブルのデータを検索し、検索結果をリスト形式で返却します。
     * 
     * @param criteria vtXpltzStgActの CriteriaDomain クラス
     * @return vtXpltzStgActのDomainクラスのList
